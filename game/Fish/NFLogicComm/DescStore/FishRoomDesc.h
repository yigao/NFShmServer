...
#define MAX_COM_INDEX_FISH_ROOM_GAMEID_NUM 2

#define ONE_KEY_MAX_COM_INDEX_FISH_ROOM_GAMEID_NUM 8

#define MAX_COM_INDEX_FISH_ROOM_ROOMID_NUM 8

#define ONE_KEY_MAX_COM_INDEX_FISH_ROOM_ROOMID_NUM 2
...
private:
	NFShmHashMap<int64_t, NFShmHashMap<int64_t, uint32_t, MAX_COM_INDEX_FISH_ROOM_ROOMID_NUM>, MAX_COM_INDEX_FISH_ROOM_GAMEID_NUM> m_GameidRoomidComIndexMap;
