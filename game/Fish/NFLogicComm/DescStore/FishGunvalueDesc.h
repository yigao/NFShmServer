...
#define UNIQUE_KEY_MAX_COM_INDEX_FISH_GUNVALUE_GAMEID_NUM 4
...
private:
	NFShmHashMap<int64_t, NFShmHashMap<int64_t, NFShmHashMap<int64_t, uint32_t, UNIQUE_KEY_MAX_COM_INDEX_FISH_GUNVALUE_GUNID_NUM>, UNIQUE_KEY_MAX_COM_INDEX_FISH_GUNVALUE_ROOMID_NUM>, UNIQUE_KEY_MAX_COM_INDEX_FISH_GUNVALUE_GAMEID_NUM> m_GameidRoomidGunidComIndexMap;
