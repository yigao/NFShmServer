...
private:
	NFShmHashMap<FishGunvalueGameidRoomid ,NFShmVector<uint64_t, MAX_COM_INDEX_FISH_GUNVALUE_ROOMID_NUM>, UNIQUE_KEY_MAX_COM_INDEX_FISH_GUNVALUE_GAMEID_NUM*UNIQUE_KEY_MAX_COM_INDEX_FISH_GUNVALUE_ROOMID_NUM> m_GameidRoomidComIndexMap;
	NFShmHashMap<FishGunvalueGameidRoomidGunid ,uint64_t, UNIQUE_KEY_MAX_COM_INDEX_FISH_GUNVALUE_GAMEID_NUM*UNIQUE_KEY_MAX_COM_INDEX_FISH_GUNVALUE_ROOMID_NUM*UNIQUE_KEY_MAX_COM_INDEX_FISH_GUNVALUE_GUNID_NUM> m_GameidRoomidGunidComIndexMap;
};
