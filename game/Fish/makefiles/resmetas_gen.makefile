...
${PROTOCGEN_FILE_PATH}/constant_proto_finish:${PROTOCOL_COMM_XML} ${FIELD_OPTIONS_XML} ${RESDB_META_PATH}/constant.proto
	...
	${FILE_COPY_EXE} --work="filecopy" --src="${PROTOCGEN_FILE_PATH}/constant.pb.h ${PROTOCGEN_FILE_PATH}/constant.pb.cc ${PROTOCGEN_FILE_PATH}/constant_s.h ${PROTOCGEN_FILE_PATH}/constant_s.cpp " --dst=${NEW_PROTOCGEN_FILE_PATH}/
...
${PROTOCGEN_FILE_PATH}/Fish_proto_finish:${PROTOCOL_COMM_XML} ${FIELD_OPTIONS_XML} ${RESDB_META_PATH}/Fish.proto
	...
	${FILE_COPY_EXE} --work="filecopy" --src="${PROTOCGEN_FILE_PATH}/Fish.pb.h ${PROTOCGEN_FILE_PATH}/Fish.pb.cc ${PROTOCGEN_FILE_PATH}/Fish_s.h ${PROTOCGEN_FILE_PATH}/Fish_s.cpp " --dst=${NEW_PROTOCGEN_FILE_PATH}/
