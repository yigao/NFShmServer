...
${PROTOCGEN_FILE_PATH}/constant_xlsx_finish:${RESDB_EXCELMMO_PATH}/constant.xlsx
	...
	${FILE_COPY_EXE} --work="filecopy" --src="${PROTOCGEN_FILE_PATH}/constant.proto ${PROTOCGEN_FILE_PATH}/constant_gen.makefile" --dst=${RESDB_META_PATH}/
...
${PROTOCGEN_FILE_PATH}/Fish_xlsx_finish:${RESDB_EXCELMMO_PATH}/Fish.xlsx
	...
	${NFEXCELPROCESS} --work="exceltoproto" --src=$^ --dst=${PROTOCGEN_FILE_PATH}/
	${FILE_COPY_EXE} --work="filecopy" --src="${PROTOCGEN_FILE_PATH}/Fish.proto ${PROTOCGEN_FILE_PATH}/Fish_gen.makefile" --dst=${RESDB_META_PATH}/
