// -------------------------------------------------------------------------
//    @FileName         :    ComTypeDefine.h
//    @Author           :    gaoyi
//    @Date             :    23-10-18
//    @Email			:    445267987@qq.com
//    @Module           :    ComTypeDefine
//
// -------------------------------------------------------------------------
...
typedef std::unordered_map<uint64_t, bool> MAP_UINT64_BOOL;
...
typedef std::unordered_map<int32_t, bool> MAP_INT32_BOOL;
...
typedef std::unordered_map<int8_t, SET_INT32 > MAP_INT8_SET_INT32;



typedef std::unordered_map<uint64_t, LIST_INT32 > MAP_UINT64_LIST_INT32;
...
typedef std::unordered_map<uint32_t, MAP_UINT64_UINT64 > MAP_UINT32_MAP_UINT64_UINT64;
...
typedef std::unordered_map<uint32_t, MAP_INT32_SET_UINT64 > MAP_UINT32_MAP_INT32_SET_UINT64;
typedef std::unordered_map<uint32_t, MAP_UINT32_MAP_INT32_SET_UINT64 > MAP_UINT32_MAP_UINT32_MAP_INT32_SET_UINT64;
...
typedef std::map<int64_t, LIST_UINT64 > ORDER_MAP_INT64_LIST_UINT64;
...
using MAP_UINT64_POINT3 = unordered_map<uint64_t, NFPoint3<float> >;
