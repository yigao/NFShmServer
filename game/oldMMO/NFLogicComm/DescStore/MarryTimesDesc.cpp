...
int MarryTimesDesc::Load(NFResDB *pDB)
{
	...
	{
		NFLogError(NF_LOG_SYSTEMLOG, 0, "Invalid TotalNum:{}", table.marrytimes_list_size());
		return -2;
	}
	...
	NFLogTrace(NF_LOG_SYSTEMLOG, 0, "load {}, num={}", iRet, table.marrytimes_list_size());
...
const proto_ff_s::marrytimes_s * MarryTimesDesc::GetDesc(int id) const
{
