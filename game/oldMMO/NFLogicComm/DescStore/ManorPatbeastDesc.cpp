...
int ManorPatbeastDesc::Load(NFResDB *pDB)
{
	...
	{
		NFLogError(NF_LOG_SYSTEMLOG, 0, "Invalid TotalNum:{}", table.manorpatbeast_list_size());
		return -2;
	}
	...
	NFLogTrace(NF_LOG_SYSTEMLOG, 0, "load {}, num={}", iRet, table.manorpatbeast_list_size());
...
const proto_ff_s::manorpatBeast_s * ManorPatbeastDesc::GetDesc(int id) const
{
