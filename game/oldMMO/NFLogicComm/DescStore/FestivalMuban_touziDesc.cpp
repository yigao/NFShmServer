...
int FestivalMuban_touziDesc::Load(NFResDB *pDB)
{
	...
	{
		NFLogError(NF_LOG_SYSTEMLOG, 0, "Invalid TotalNum:{}", table.festivalmuban_touzi_list_size());
		return -2;
	}
	...
	NFLogTrace(NF_LOG_SYSTEMLOG, 0, "load {}, num={}", iRet, table.festivalmuban_touzi_list_size());
...
const proto_ff_s::festivalmuban_touzi_s * FestivalMuban_touziDesc::GetDesc(int id) const
{
