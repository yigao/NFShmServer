...
int FestivalMuban_prerechargeDesc::Load(NFResDB *pDB)
{
	...
	{
		NFLogError(NF_LOG_SYSTEMLOG, 0, "Invalid TotalNum:{}", table.festivalmuban_prerecharge_list_size());
		return -2;
	}
	...
	NFLogTrace(NF_LOG_SYSTEMLOG, 0, "load {}, num={}", iRet, table.festivalmuban_prerecharge_list_size());
...
const proto_ff_s::festivalmuban_prerecharge_s * FestivalMuban_prerechargeDesc::GetDesc(int id) const
{
