...
int TeleportBornDesc::Load(NFResDB *pDB)
{
	...
	{
		NFLogError(NF_LOG_SYSTEMLOG, 0, "Invalid TotalNum:{}", table.teleportborn_list_size());
		return -2;
	}
	...
	NFLogTrace(NF_LOG_SYSTEMLOG, 0, "load {}, num={}", iRet, table.teleportborn_list_size());
...
const proto_ff_s::teleportborn_s * TeleportBornDesc::GetDesc(int id) const
{
