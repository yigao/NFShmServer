...
int LightandshadowRewardDesc::Load(NFResDB *pDB)
{
	...
	{
		NFLogError(NF_LOG_SYSTEMLOG, 0, "Invalid TotalNum:{}", table.lightandshadowreward_list_size());
		return -2;
	}
	...
	NFLogTrace(NF_LOG_SYSTEMLOG, 0, "load {}, num={}", iRet, table.lightandshadowreward_list_size());
...
const proto_ff_s::lightAndShadowreward_s * LightandshadowRewardDesc::GetDesc(int id) const
{
