...
all:${PROTOCGEN_FILE_PATH}/wingwing.bin ${PROTOCGEN_FILE_PATH}/WingWingDesc.h ${PROTOCGEN_FILE_PATH}/WingWingDesc.cpp ${PROTOCGEN_FILE_PATH}/wingchange.bin ${PROTOCGEN_FILE_PATH}/WingChangeDesc.h ${PROTOCGEN_FILE_PATH}/WingChangeDesc.cpp ${PROTOCGEN_FILE_PATH}/wingfragment.bin ${PROTOCGEN_FILE_PATH}/WingFragmentDesc.h ${PROTOCGEN_FILE_PATH}/WingFragmentDesc.cpp ${PROTOCGEN_FILE_PATH}/wingstarUp.bin ${PROTOCGEN_FILE_PATH}/WingStarupDesc.h ${PROTOCGEN_FILE_PATH}/WingStarupDesc.cpp 
