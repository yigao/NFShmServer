...
#ifndef PROTOBUF_ServerClientCmd_2eproto__INCLUDED
#define PROTOBUF_ServerClientCmd_2eproto__INCLUDED
...
enum ServerToClientCmd {
  ...
  SERVER_TO_CLIENT_CENTER_LOGIN_BEGIN = 21,
  CENTER_TO_CLIENT_LOGIN = 22,
  CENTER_TO_CLIENT_CREATE_CHARACTER = 23,
  CENTER_TO_CLIENT_DEL_CHARACTER = 24,
  CENTER_TO_CLIENT_LOGINOUT = 25,
  CENTER_TO_CLIENT_RECONNECT_RESUTL = 26,
  CENTER_TO_CLIENT_DEL_CHARACTER_CANCEL = 33
};
bool ServerToClientCmd_IsValid(int value);
const ServerToClientCmd ServerToClientCmd_MIN = SERVER_TO_CLIENT_LOGIN_BEGIN;
const ServerToClientCmd ServerToClientCmd_MAX = CENTER_TO_CLIENT_DEL_CHARACTER_CANCEL;
...
#endif  // PROTOBUF_ServerClientCmd_2eproto__INCLUDED
