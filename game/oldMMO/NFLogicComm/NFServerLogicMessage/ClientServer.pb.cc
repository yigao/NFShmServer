...
void protobuf_AddDesc_ClientServer_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "\030\t \001(\0132\036.proto_ff.ClientToLogInfoProto\"\025"
    "\n\023ClientQueueIndexReq", 661);
