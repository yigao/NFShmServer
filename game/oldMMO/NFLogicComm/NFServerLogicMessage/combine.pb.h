...
// optional int32 num = 1;
inline bool combinequalityUpneedMaterialDesc::has_num() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void combinequalityUpneedMaterialDesc::set_has_num() {
  _has_bits_[0] |= 0x00000001u;
}
inline void combinequalityUpneedMaterialDesc::clear_has_num() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void combinequalityUpneedMaterialDesc::clear_num() {
  num_ = 0;
  clear_has_num();
}
inline ::google::protobuf::int32 combinequalityUpneedMaterialDesc::num() const {
  return num_;
}
inline void combinequalityUpneedMaterialDesc::set_num(::google::protobuf::int32 value) {
  set_has_num();
  num_ = value;
}
