...
class NFBattlePartModule : public NFIDynamicModule
{
public:
    NFBattlePartModule(NFIPluginManager *p);

    virtual ~NFBattlePartModule();
public:
...
public:
    virtual int RetisterClientPartMsg(uint32_t nMsgID, uint32_t partType);
    virtual int RetisterServerPartMsg(uint32_t nMsgID, uint32_t partType);
private:
