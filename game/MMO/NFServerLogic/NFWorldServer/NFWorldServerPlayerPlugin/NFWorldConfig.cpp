...
IMPLEMENT_IDCREATE_WITHTYPE(NFWorldConfig, EOT_WORLD_CONFIG_ID, NFShmObj)

NFWorldConfig::NFWorldConfig():NFShmObj()
{
...
int NFWorldConfig::LoadConfig(NFILuaLoader luaMgr)
{
