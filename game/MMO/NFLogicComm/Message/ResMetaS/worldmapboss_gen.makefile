...
${PROTOCGEN_FILE_PATH}/WorldmapbossWorldbossDesc.h ${PROTOCGEN_FILE_PATH}/WorldmapbossWorldbossDesc.cpp:${PROTOCGEN_FILE_PATH}/worldmapboss.proto.ds ${RESDB_EXCELMMO_PATH}/worldmapboss.xlsx
	mkdir -p ${PROTOCGEN_FILE_PATH}
...
${PROTOCGEN_FILE_PATH}/WorldmapbossDroplistDesc.h ${PROTOCGEN_FILE_PATH}/WorldmapbossDroplistDesc.cpp:${PROTOCGEN_FILE_PATH}/worldmapboss.proto.ds ${RESDB_EXCELMMO_PATH}/worldmapboss.xlsx
	mkdir -p ${PROTOCGEN_FILE_PATH}
...
${PROTOCGEN_FILE_PATH}/WorldmapbossFestivalDesc.h ${PROTOCGEN_FILE_PATH}/WorldmapbossFestivalDesc.cpp:${PROTOCGEN_FILE_PATH}/worldmapboss.proto.ds ${RESDB_EXCELMMO_PATH}/worldmapboss.xlsx
	mkdir -p ${PROTOCGEN_FILE_PATH}
