...
all:${PROTOCGEN_FILE_PATH}/activitydaily.bin ${PROTOCGEN_FILE_PATH}/activityactivitynotice.bin ${PROTOCGEN_FILE_PATH}/activityscuffle.bin ${PROTOCGEN_FILE_PATH}/activitychaosDragons.bin ${PROTOCGEN_FILE_PATH}/activitycircus.bin ${PROTOCGEN_FILE_PATH}/activitycircusNum.bin ${PROTOCGEN_FILE_PATH}/activitycircusDan.bin ${PROTOCGEN_FILE_PATH}/activitymathrule.bin ${PROTOCGEN_FILE_PATH}/activitymathreward.bin ${PROTOCGEN_FILE_PATH}/activitygvgConst.bin ${PROTOCGEN_FILE_PATH}/activitygvgRankReward.bin ${PROTOCGEN_FILE_PATH}/activitygvgReward.bin ${PROTOCGEN_FILE_PATH}/activityworldTreasureConst.bin ${PROTOCGEN_FILE_PATH}/activityworldTreasureMap.bin ${PROTOCGEN_FILE_PATH}/activityworldTreasureMonster.bin ${PROTOCGEN_FILE_PATH}/activitylosttempleConstant.bin 
