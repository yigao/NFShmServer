...
${PROTOCGEN_FILE_PATH}/AchievementAchievementDesc.h ${PROTOCGEN_FILE_PATH}/AchievementAchievementDesc.cpp:${PROTOCGEN_FILE_PATH}/achievement.proto.ds ${RESDB_EXCELMMO_PATH}/achievement.xlsx
	mkdir -p ${PROTOCGEN_FILE_PATH}
...
${PROTOCGEN_FILE_PATH}/AchievementAchievementrewardDesc.h ${PROTOCGEN_FILE_PATH}/AchievementAchievementrewardDesc.cpp:${PROTOCGEN_FILE_PATH}/achievement.proto.ds ${RESDB_EXCELMMO_PATH}/achievement.xlsx
	mkdir -p ${PROTOCGEN_FILE_PATH}
