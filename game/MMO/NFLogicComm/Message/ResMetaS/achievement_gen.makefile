...
all:${GAME_DATA_PATH}/achievementachievement.bin ${GAME_DATA_PATH}/achievementachievementreward.bin ${GAME_DATA_PATH}/achievementachievenName.bin 
...
${GAME_DATA_PATH}/achievementachievenName.bin:${RESDB_META_DESCRIPTOR} ${RESDB_EXCELMMO_PATH}/achievement.xlsx
	${EXCEL2BIN_MMO} --excel=${RESDB_EXCELMMO_PATH}/achievement.xlsx  --proto_ds=${RESDB_META_DESCRIPTOR} --proto_package=proto_ff \
		--proto_sheet_msgname=Sheet_achievementachievenName  --excel_sheetname=achievenName  --proto_msgname=achievementachievenName  --start_row=4 --out_path=${GAME_DATA_PATH}/
