...
${GAME_DATA_PATH}/operateoperate.bin:${PROTOCGEN_FILE_PATH}/operate.proto.ds ${RESDB_EXCELMMO_PATH}/operate.xlsx
...
${GAME_DATA_PATH}/operatetutor.bin:${PROTOCGEN_FILE_PATH}/operate.proto.ds ${RESDB_EXCELMMO_PATH}/operate.xlsx
	${EXCEL2BIN_MMO} --excel=${RESDB_EXCELMMO_PATH}/operate.xlsx  --proto_ds=${PROTOCGEN_FILE_PATH}/operate.proto.ds --proto_package=proto_ff \
...
${GAME_DATA_PATH}/operatejiangli.bin:${PROTOCGEN_FILE_PATH}/operate.proto.ds ${RESDB_EXCELMMO_PATH}/operate.xlsx
	${EXCEL2BIN_MMO} --excel=${RESDB_EXCELMMO_PATH}/operate.xlsx  --proto_ds=${PROTOCGEN_FILE_PATH}/operate.proto.ds --proto_package=proto_ff \
...
${GAME_DATA_PATH}/operatehoroscope.bin:${PROTOCGEN_FILE_PATH}/operate.proto.ds ${RESDB_EXCELMMO_PATH}/operate.xlsx
	${EXCEL2BIN_MMO} --excel=${RESDB_EXCELMMO_PATH}/operate.xlsx  --proto_ds=${PROTOCGEN_FILE_PATH}/operate.proto.ds --proto_package=proto_ff \
...
${GAME_DATA_PATH}/operatehoroscopePool.bin:${PROTOCGEN_FILE_PATH}/operate.proto.ds ${RESDB_EXCELMMO_PATH}/operate.xlsx
	${EXCEL2BIN_MMO} --excel=${RESDB_EXCELMMO_PATH}/operate.xlsx  --proto_ds=${PROTOCGEN_FILE_PATH}/operate.proto.ds --proto_package=proto_ff \
...
${GAME_DATA_PATH}/operatehoroscopeExchange.bin:${PROTOCGEN_FILE_PATH}/operate.proto.ds ${RESDB_EXCELMMO_PATH}/operate.xlsx
	${EXCEL2BIN_MMO} --excel=${RESDB_EXCELMMO_PATH}/operate.xlsx  --proto_ds=${PROTOCGEN_FILE_PATH}/operate.proto.ds --proto_package=proto_ff \
...
${GAME_DATA_PATH}/operateconst.bin:${PROTOCGEN_FILE_PATH}/operate.proto.ds ${RESDB_EXCELMMO_PATH}/operate.xlsx
	${EXCEL2BIN_MMO} --excel=${RESDB_EXCELMMO_PATH}/operate.xlsx  --proto_ds=${PROTOCGEN_FILE_PATH}/operate.proto.ds --proto_package=proto_ff \
...
${GAME_DATA_PATH}/operateunlimited.bin:${PROTOCGEN_FILE_PATH}/operate.proto.ds ${RESDB_EXCELMMO_PATH}/operate.xlsx
	${EXCEL2BIN_MMO} --excel=${RESDB_EXCELMMO_PATH}/operate.xlsx  --proto_ds=${PROTOCGEN_FILE_PATH}/operate.proto.ds --proto_package=proto_ff \
...
${GAME_DATA_PATH}/operaterand.bin:${PROTOCGEN_FILE_PATH}/operate.proto.ds ${RESDB_EXCELMMO_PATH}/operate.xlsx
	${EXCEL2BIN_MMO} --excel=${RESDB_EXCELMMO_PATH}/operate.xlsx  --proto_ds=${PROTOCGEN_FILE_PATH}/operate.proto.ds --proto_package=proto_ff \
		--proto_sheet_msgname=Sheet_operaterand  --excel_sheetname=rand  --proto_msgname=operaterand  --start_row=4 --out_path=${GAME_DATA_PATH}/

${GAME_DATA_PATH}/operatemooncard.bin:${PROTOCGEN_FILE_PATH}/operate.proto.ds ${RESDB_EXCELMMO_PATH}/operate.xlsx
	${EXCEL2BIN_MMO} --excel=${RESDB_EXCELMMO_PATH}/operate.xlsx  --proto_ds=${PROTOCGEN_FILE_PATH}/operate.proto.ds --proto_package=proto_ff \
...
${GAME_DATA_PATH}/operatefund.bin:${PROTOCGEN_FILE_PATH}/operate.proto.ds ${RESDB_EXCELMMO_PATH}/operate.xlsx
	${EXCEL2BIN_MMO} --excel=${RESDB_EXCELMMO_PATH}/operate.xlsx  --proto_ds=${PROTOCGEN_FILE_PATH}/operate.proto.ds --proto_package=proto_ff \
		--proto_sheet_msgname=Sheet_operatefund  --excel_sheetname=fund  --proto_msgname=operatefund  --start_row=4 --out_path=${GAME_DATA_PATH}/

${GAME_DATA_PATH}/operatetask.bin:${PROTOCGEN_FILE_PATH}/operate.proto.ds ${RESDB_EXCELMMO_PATH}/operate.xlsx
	${EXCEL2BIN_MMO} --excel=${RESDB_EXCELMMO_PATH}/operate.xlsx  --proto_ds=${PROTOCGEN_FILE_PATH}/operate.proto.ds --proto_package=proto_ff \
		--proto_sheet_msgname=Sheet_operatetask  --excel_sheetname=task  --proto_msgname=operatetask  --start_row=4 --out_path=${GAME_DATA_PATH}/

${GAME_DATA_PATH}/operateshop.bin:${PROTOCGEN_FILE_PATH}/operate.proto.ds ${RESDB_EXCELMMO_PATH}/operate.xlsx
	${EXCEL2BIN_MMO} --excel=${RESDB_EXCELMMO_PATH}/operate.xlsx  --proto_ds=${PROTOCGEN_FILE_PATH}/operate.proto.ds --proto_package=proto_ff \
		--proto_sheet_msgname=Sheet_operateshop  --excel_sheetname=shop  --proto_msgname=operateshop  --start_row=4 --out_path=${GAME_DATA_PATH}/

${GAME_DATA_PATH}/operatewish.bin:${PROTOCGEN_FILE_PATH}/operate.proto.ds ${RESDB_EXCELMMO_PATH}/operate.xlsx
	${EXCEL2BIN_MMO} --excel=${RESDB_EXCELMMO_PATH}/operate.xlsx  --proto_ds=${PROTOCGEN_FILE_PATH}/operate.proto.ds --proto_package=proto_ff \
		--proto_sheet_msgname=Sheet_operatewish  --excel_sheetname=wish  --proto_msgname=operatewish  --start_row=4 --out_path=${GAME_DATA_PATH}/

${GAME_DATA_PATH}/operateturntable.bin:${PROTOCGEN_FILE_PATH}/operate.proto.ds ${RESDB_EXCELMMO_PATH}/operate.xlsx
	${EXCEL2BIN_MMO} --excel=${RESDB_EXCELMMO_PATH}/operate.xlsx  --proto_ds=${PROTOCGEN_FILE_PATH}/operate.proto.ds --proto_package=proto_ff \
...
${GAME_DATA_PATH}/operateturntableTask.bin:${PROTOCGEN_FILE_PATH}/operate.proto.ds ${RESDB_EXCELMMO_PATH}/operate.xlsx
	${EXCEL2BIN_MMO} --excel=${RESDB_EXCELMMO_PATH}/operate.xlsx  --proto_ds=${PROTOCGEN_FILE_PATH}/operate.proto.ds --proto_package=proto_ff \
