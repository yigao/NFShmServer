...
${PROTOCGEN_FILE_PATH}/ColpointsColpointsDesc.h ${PROTOCGEN_FILE_PATH}/ColpointsColpointsDesc.cpp:${PROTOCGEN_FILE_PATH}/colPoints.proto.ds ${RESDB_EXCELMMO_PATH}/colPoints.xlsx
	mkdir -p ${PROTOCGEN_FILE_PATH}
...
${PROTOCGEN_FILE_PATH}/ColpointsTaskDesc.h ${PROTOCGEN_FILE_PATH}/ColpointsTaskDesc.cpp:${PROTOCGEN_FILE_PATH}/colPoints.proto.ds ${RESDB_EXCELMMO_PATH}/colPoints.xlsx
	mkdir -p ${PROTOCGEN_FILE_PATH}
