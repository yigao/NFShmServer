...
${GAME_DATA_PATH}/colPointscolPoints.bin:${RESDB_META_DESCRIPTOR} ${RESDB_EXCELMMO_PATH}/colPoints.xlsx
	${EXCEL2BIN_MMO} --excel=${RESDB_EXCELMMO_PATH}/colPoints.xlsx  --proto_ds=${RESDB_META_DESCRIPTOR} --proto_package=proto_ff \
...
${GAME_DATA_PATH}/colPointstask.bin:${RESDB_META_DESCRIPTOR} ${RESDB_EXCELMMO_PATH}/colPoints.xlsx
	${EXCEL2BIN_MMO} --excel=${RESDB_EXCELMMO_PATH}/colPoints.xlsx  --proto_ds=${RESDB_META_DESCRIPTOR} --proto_package=proto_ff \
