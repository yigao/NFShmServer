...
${GAME_DATA_PATH}/manorconstants.bin:${PROTOCGEN_FILE_PATH}/manor.proto.ds ${RESDB_EXCELMMO_PATH}/manor.xlsx
...
${GAME_DATA_PATH}/manoritemCost.bin:${PROTOCGEN_FILE_PATH}/manor.proto.ds ${RESDB_EXCELMMO_PATH}/manor.xlsx
	${EXCEL2BIN_MMO} --excel=${RESDB_EXCELMMO_PATH}/manor.xlsx  --proto_ds=${PROTOCGEN_FILE_PATH}/manor.proto.ds --proto_package=proto_ff \
...
${GAME_DATA_PATH}/manormanorlist.bin:${PROTOCGEN_FILE_PATH}/manor.proto.ds ${RESDB_EXCELMMO_PATH}/manor.xlsx
	${EXCEL2BIN_MMO} --excel=${RESDB_EXCELMMO_PATH}/manor.xlsx  --proto_ds=${PROTOCGEN_FILE_PATH}/manor.proto.ds --proto_package=proto_ff \
...
${GAME_DATA_PATH}/manorproduct.bin:${PROTOCGEN_FILE_PATH}/manor.proto.ds ${RESDB_EXCELMMO_PATH}/manor.xlsx
	${EXCEL2BIN_MMO} --excel=${RESDB_EXCELMMO_PATH}/manor.xlsx  --proto_ds=${PROTOCGEN_FILE_PATH}/manor.proto.ds --proto_package=proto_ff \
...
${GAME_DATA_PATH}/manorbuild.bin:${PROTOCGEN_FILE_PATH}/manor.proto.ds ${RESDB_EXCELMMO_PATH}/manor.xlsx
	${EXCEL2BIN_MMO} --excel=${RESDB_EXCELMMO_PATH}/manor.xlsx  --proto_ds=${PROTOCGEN_FILE_PATH}/manor.proto.ds --proto_package=proto_ff \
		--proto_sheet_msgname=Sheet_manorbuild  --excel_sheetname=build  --proto_msgname=manorbuild  --start_row=4 --out_path=${GAME_DATA_PATH}/

${GAME_DATA_PATH}/manorbuildUp.bin:${PROTOCGEN_FILE_PATH}/manor.proto.ds ${RESDB_EXCELMMO_PATH}/manor.xlsx
	${EXCEL2BIN_MMO} --excel=${RESDB_EXCELMMO_PATH}/manor.xlsx  --proto_ds=${PROTOCGEN_FILE_PATH}/manor.proto.ds --proto_package=proto_ff \
...
${GAME_DATA_PATH}/manoregg.bin:${PROTOCGEN_FILE_PATH}/manor.proto.ds ${RESDB_EXCELMMO_PATH}/manor.xlsx
	${EXCEL2BIN_MMO} --excel=${RESDB_EXCELMMO_PATH}/manor.xlsx  --proto_ds=${PROTOCGEN_FILE_PATH}/manor.proto.ds --proto_package=proto_ff \
		--proto_sheet_msgname=Sheet_manoregg  --excel_sheetname=egg  --proto_msgname=manoregg  --start_row=4 --out_path=${GAME_DATA_PATH}/

${GAME_DATA_PATH}/manorpatBeast.bin:${PROTOCGEN_FILE_PATH}/manor.proto.ds ${RESDB_EXCELMMO_PATH}/manor.xlsx
	${EXCEL2BIN_MMO} --excel=${RESDB_EXCELMMO_PATH}/manor.xlsx  --proto_ds=${PROTOCGEN_FILE_PATH}/manor.proto.ds --proto_package=proto_ff \
...
${GAME_DATA_PATH}/manorpatBeastUP.bin:${PROTOCGEN_FILE_PATH}/manor.proto.ds ${RESDB_EXCELMMO_PATH}/manor.xlsx
	${EXCEL2BIN_MMO} --excel=${RESDB_EXCELMMO_PATH}/manor.xlsx  --proto_ds=${PROTOCGEN_FILE_PATH}/manor.proto.ds --proto_package=proto_ff \
...
${GAME_DATA_PATH}/manorbuildBuff.bin:${PROTOCGEN_FILE_PATH}/manor.proto.ds ${RESDB_EXCELMMO_PATH}/manor.xlsx
	${EXCEL2BIN_MMO} --excel=${RESDB_EXCELMMO_PATH}/manor.xlsx  --proto_ds=${PROTOCGEN_FILE_PATH}/manor.proto.ds --proto_package=proto_ff \
...
${GAME_DATA_PATH}/manorshop.bin:${PROTOCGEN_FILE_PATH}/manor.proto.ds ${RESDB_EXCELMMO_PATH}/manor.xlsx
	${EXCEL2BIN_MMO} --excel=${RESDB_EXCELMMO_PATH}/manor.xlsx  --proto_ds=${PROTOCGEN_FILE_PATH}/manor.proto.ds --proto_package=proto_ff \
		--proto_sheet_msgname=Sheet_manorshop  --excel_sheetname=shop  --proto_msgname=manorshop  --start_row=4 --out_path=${GAME_DATA_PATH}/

${GAME_DATA_PATH}/manorbuildAdd.bin:${PROTOCGEN_FILE_PATH}/manor.proto.ds ${RESDB_EXCELMMO_PATH}/manor.xlsx
	${EXCEL2BIN_MMO} --excel=${RESDB_EXCELMMO_PATH}/manor.xlsx  --proto_ds=${PROTOCGEN_FILE_PATH}/manor.proto.ds --proto_package=proto_ff \
...
${GAME_DATA_PATH}/manorlog.bin:${PROTOCGEN_FILE_PATH}/manor.proto.ds ${RESDB_EXCELMMO_PATH}/manor.xlsx
	${EXCEL2BIN_MMO} --excel=${RESDB_EXCELMMO_PATH}/manor.xlsx  --proto_ds=${PROTOCGEN_FILE_PATH}/manor.proto.ds --proto_package=proto_ff \
