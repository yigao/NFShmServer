...
${PROTOCGEN_FILE_PATH}/ClosetestActivityDesc.h ${PROTOCGEN_FILE_PATH}/ClosetestActivityDesc.cpp:${PROTOCGEN_FILE_PATH}/closetest.proto.ds ${RESDB_EXCELMMO_PATH}/closetest.xlsx
	mkdir -p ${PROTOCGEN_FILE_PATH}
...
${PROTOCGEN_FILE_PATH}/ClosetestRebateDesc.h ${PROTOCGEN_FILE_PATH}/ClosetestRebateDesc.cpp:${PROTOCGEN_FILE_PATH}/closetest.proto.ds ${RESDB_EXCELMMO_PATH}/closetest.xlsx
	mkdir -p ${PROTOCGEN_FILE_PATH}
