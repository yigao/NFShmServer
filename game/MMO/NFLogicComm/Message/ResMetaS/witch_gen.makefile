...
${PROTOCGEN_FILE_PATH}/WitchAwardDesc.h ${PROTOCGEN_FILE_PATH}/WitchAwardDesc.cpp:${PROTOCGEN_FILE_PATH}/witch.proto.ds ${RESDB_EXCELMMO_PATH}/witch.xlsx
	mkdir -p ${PROTOCGEN_FILE_PATH}
...
${PROTOCGEN_FILE_PATH}/WitchSummonDesc.h ${PROTOCGEN_FILE_PATH}/WitchSummonDesc.cpp:${PROTOCGEN_FILE_PATH}/witch.proto.ds ${RESDB_EXCELMMO_PATH}/witch.xlsx
	mkdir -p ${PROTOCGEN_FILE_PATH}
...
${PROTOCGEN_FILE_PATH}/WitchRewardexpDesc.h ${PROTOCGEN_FILE_PATH}/WitchRewardexpDesc.cpp:${PROTOCGEN_FILE_PATH}/witch.proto.ds ${RESDB_EXCELMMO_PATH}/witch.xlsx
	mkdir -p ${PROTOCGEN_FILE_PATH}
