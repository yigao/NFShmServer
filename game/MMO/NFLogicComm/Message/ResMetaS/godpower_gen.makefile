...
${PROTOCGEN_FILE_PATH}/GodpowerGodpowerDesc.h ${PROTOCGEN_FILE_PATH}/GodpowerGodpowerDesc.cpp:${PROTOCGEN_FILE_PATH}/godpower.proto.ds ${RESDB_EXCELMMO_PATH}/godpower.xlsx
	mkdir -p ${PROTOCGEN_FILE_PATH}
...
${PROTOCGEN_FILE_PATH}/GodpowerSkillupdateDesc.h ${PROTOCGEN_FILE_PATH}/GodpowerSkillupdateDesc.cpp:${PROTOCGEN_FILE_PATH}/godpower.proto.ds ${RESDB_EXCELMMO_PATH}/godpower.xlsx
	mkdir -p ${PROTOCGEN_FILE_PATH}
