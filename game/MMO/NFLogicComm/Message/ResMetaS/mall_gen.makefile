...
${PROTOCGEN_FILE_PATH}/MallMallDesc.h ${PROTOCGEN_FILE_PATH}/MallMallDesc.cpp:${PROTOCGEN_FILE_PATH}/mall.proto.ds ${RESDB_EXCELMMO_PATH}/mall.xlsx
	mkdir -p ${PROTOCGEN_FILE_PATH}
...
${PROTOCGEN_FILE_PATH}/MallMalltypeDesc.h ${PROTOCGEN_FILE_PATH}/MallMalltypeDesc.cpp:${PROTOCGEN_FILE_PATH}/mall.proto.ds ${RESDB_EXCELMMO_PATH}/mall.xlsx
	mkdir -p ${PROTOCGEN_FILE_PATH}
