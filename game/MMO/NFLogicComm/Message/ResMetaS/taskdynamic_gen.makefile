...
${PROTOCGEN_FILE_PATH}/TaskdynamicTaskdynamicDesc.h ${PROTOCGEN_FILE_PATH}/TaskdynamicTaskdynamicDesc.cpp:${PROTOCGEN_FILE_PATH}/taskdynamic.proto.ds ${RESDB_EXCELMMO_PATH}/taskdynamic.xlsx
	mkdir -p ${PROTOCGEN_FILE_PATH}
...
${PROTOCGEN_FILE_PATH}/TaskdynamicTaskcomcondDesc.h ${PROTOCGEN_FILE_PATH}/TaskdynamicTaskcomcondDesc.cpp:${PROTOCGEN_FILE_PATH}/taskdynamic.proto.ds ${RESDB_EXCELMMO_PATH}/taskdynamic.xlsx
	mkdir -p ${PROTOCGEN_FILE_PATH}
...
${PROTOCGEN_FILE_PATH}/TaskdynamicTasktextDesc.h ${PROTOCGEN_FILE_PATH}/TaskdynamicTasktextDesc.cpp:${PROTOCGEN_FILE_PATH}/taskdynamic.proto.ds ${RESDB_EXCELMMO_PATH}/taskdynamic.xlsx
	mkdir -p ${PROTOCGEN_FILE_PATH}
