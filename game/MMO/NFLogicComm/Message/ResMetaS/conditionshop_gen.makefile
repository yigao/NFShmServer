...
${PROTOCGEN_FILE_PATH}/ConditionshopConditionshopDesc.h ${PROTOCGEN_FILE_PATH}/ConditionshopConditionshopDesc.cpp:${PROTOCGEN_FILE_PATH}/conditionshop.proto.ds ${RESDB_EXCELMMO_PATH}/conditionshop.xlsx
	mkdir -p ${PROTOCGEN_FILE_PATH}
