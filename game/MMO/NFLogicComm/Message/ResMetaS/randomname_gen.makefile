...
${PROTOCGEN_FILE_PATH}/RandomnameManfirstDesc.h ${PROTOCGEN_FILE_PATH}/RandomnameManfirstDesc.cpp:${PROTOCGEN_FILE_PATH}/randomname.proto.ds ${RESDB_EXCELMMO_PATH}/randomname.xlsx
	mkdir -p ${PROTOCGEN_FILE_PATH}
...
${PROTOCGEN_FILE_PATH}/RandomnameMansecondDesc.h ${PROTOCGEN_FILE_PATH}/RandomnameMansecondDesc.cpp:${PROTOCGEN_FILE_PATH}/randomname.proto.ds ${RESDB_EXCELMMO_PATH}/randomname.xlsx
	mkdir -p ${PROTOCGEN_FILE_PATH}
...
${PROTOCGEN_FILE_PATH}/RandomnameManthirdDesc.h ${PROTOCGEN_FILE_PATH}/RandomnameManthirdDesc.cpp:${PROTOCGEN_FILE_PATH}/randomname.proto.ds ${RESDB_EXCELMMO_PATH}/randomname.xlsx
	mkdir -p ${PROTOCGEN_FILE_PATH}
...
${PROTOCGEN_FILE_PATH}/RandomnameWomanfirstDesc.h ${PROTOCGEN_FILE_PATH}/RandomnameWomanfirstDesc.cpp:${PROTOCGEN_FILE_PATH}/randomname.proto.ds ${RESDB_EXCELMMO_PATH}/randomname.xlsx
	mkdir -p ${PROTOCGEN_FILE_PATH}
...
${PROTOCGEN_FILE_PATH}/RandomnameWomansecondDesc.h ${PROTOCGEN_FILE_PATH}/RandomnameWomansecondDesc.cpp:${PROTOCGEN_FILE_PATH}/randomname.proto.ds ${RESDB_EXCELMMO_PATH}/randomname.xlsx
	mkdir -p ${PROTOCGEN_FILE_PATH}
...
${PROTOCGEN_FILE_PATH}/RandomnameWomanthirdDesc.h ${PROTOCGEN_FILE_PATH}/RandomnameWomanthirdDesc.cpp:${PROTOCGEN_FILE_PATH}/randomname.proto.ds ${RESDB_EXCELMMO_PATH}/randomname.xlsx
	mkdir -p ${PROTOCGEN_FILE_PATH}
