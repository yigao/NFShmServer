...
${PROTOCGEN_FILE_PATH}/AreaAreaDesc.h ${PROTOCGEN_FILE_PATH}/AreaAreaDesc.cpp:${PROTOCGEN_FILE_PATH}/area.proto.ds ${RESDB_EXCELMMO_PATH}/area.xlsx
	mkdir -p ${PROTOCGEN_FILE_PATH}
...
${PROTOCGEN_FILE_PATH}/AreaPathDesc.h ${PROTOCGEN_FILE_PATH}/AreaPathDesc.cpp:${PROTOCGEN_FILE_PATH}/area.proto.ds ${RESDB_EXCELMMO_PATH}/area.xlsx
	mkdir -p ${PROTOCGEN_FILE_PATH}
