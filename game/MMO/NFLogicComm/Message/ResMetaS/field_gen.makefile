...
all:${PROTOCGEN_FILE_PATH}/fieldfield.bin ${PROTOCGEN_FILE_PATH}/fieldreiki.bin ${PROTOCGEN_FILE_PATH}/fieldexp.bin ${PROTOCGEN_FILE_PATH}/fieldvalue.bin ${PROTOCGEN_FILE_PATH}/fieldexpand.bin ${PROTOCGEN_FILE_PATH}/fieldstong.bin 
