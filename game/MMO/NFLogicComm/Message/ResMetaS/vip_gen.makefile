...
all:${PROTOCGEN_FILE_PATH}/vipvip.bin ${PROTOCGEN_FILE_PATH}/VipVipDesc.h ${PROTOCGEN_FILE_PATH}/VipVipDesc.cpp ${PROTOCGEN_FILE_PATH}/vipprivilege.bin ${PROTOCGEN_FILE_PATH}/VipPrivilegeDesc.h ${PROTOCGEN_FILE_PATH}/VipPrivilegeDesc.cpp 
