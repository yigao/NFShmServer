...
${GAME_DATA_PATH}/offlineoffline.bin:${RESDB_META_DESCRIPTOR} ${RESDB_EXCELMMO_PATH}/offline.xlsx
	${EXCEL2BIN_MMO} --excel=${RESDB_EXCELMMO_PATH}/offline.xlsx  --proto_ds=${RESDB_META_DESCRIPTOR} --proto_package=proto_ff \
...
${GAME_DATA_PATH}/offlineitemlist.bin:${RESDB_META_DESCRIPTOR} ${RESDB_EXCELMMO_PATH}/offline.xlsx
	${EXCEL2BIN_MMO} --excel=${RESDB_EXCELMMO_PATH}/offline.xlsx  --proto_ds=${RESDB_META_DESCRIPTOR} --proto_package=proto_ff \
