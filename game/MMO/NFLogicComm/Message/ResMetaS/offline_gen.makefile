...
${PROTOCGEN_FILE_PATH}/OfflineOfflineDesc.h ${PROTOCGEN_FILE_PATH}/OfflineOfflineDesc.cpp:${PROTOCGEN_FILE_PATH}/offline.proto.ds ${RESDB_EXCELMMO_PATH}/offline.xlsx
	mkdir -p ${PROTOCGEN_FILE_PATH}
...
${PROTOCGEN_FILE_PATH}/OfflineItemlistDesc.h ${PROTOCGEN_FILE_PATH}/OfflineItemlistDesc.cpp:${PROTOCGEN_FILE_PATH}/offline.proto.ds ${RESDB_EXCELMMO_PATH}/offline.xlsx
	mkdir -p ${PROTOCGEN_FILE_PATH}
