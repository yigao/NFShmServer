...
all:${PROTOCGEN_FILE_PATH}/aiai.bin ${PROTOCGEN_FILE_PATH}/AiAiDesc.h ${PROTOCGEN_FILE_PATH}/AiAiDesc.cpp 
...
${PROTOCGEN_FILE_PATH}/AiAiDesc.h ${PROTOCGEN_FILE_PATH}/AiAiDesc.cpp:${PROTOCGEN_FILE_PATH}/ai.proto.ds ${RESDB_EXCELMMO_PATH}/ai.xlsx
	mkdir -p ${PROTOCGEN_FILE_PATH}
