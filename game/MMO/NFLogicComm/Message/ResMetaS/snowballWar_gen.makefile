...
${PROTOCGEN_FILE_PATH}/SnowballwarConsDesc.h ${PROTOCGEN_FILE_PATH}/SnowballwarConsDesc.cpp:${PROTOCGEN_FILE_PATH}/snowballWar.proto.ds ${RESDB_EXCELMMO_PATH}/snowballWar.xlsx
	mkdir -p ${PROTOCGEN_FILE_PATH}
