...
${PROTOCGEN_FILE_PATH}/TasktrackerTasktrackerDesc.h ${PROTOCGEN_FILE_PATH}/TasktrackerTasktrackerDesc.cpp:${PROTOCGEN_FILE_PATH}/tasktracker.proto.ds ${RESDB_EXCELMMO_PATH}/tasktracker.xlsx
	mkdir -p ${PROTOCGEN_FILE_PATH}
