...
${PROTOCGEN_FILE_PATH}/Gm5helpConsDesc.h ${PROTOCGEN_FILE_PATH}/Gm5helpConsDesc.cpp:${PROTOCGEN_FILE_PATH}/gm5Help.proto.ds ${RESDB_EXCELMMO_PATH}/gm5Help.xlsx
	mkdir -p ${PROTOCGEN_FILE_PATH}
...
${PROTOCGEN_FILE_PATH}/Gm5helpRewardDesc.h ${PROTOCGEN_FILE_PATH}/Gm5helpRewardDesc.cpp:${PROTOCGEN_FILE_PATH}/gm5Help.proto.ds ${RESDB_EXCELMMO_PATH}/gm5Help.xlsx
	mkdir -p ${PROTOCGEN_FILE_PATH}
