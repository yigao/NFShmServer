...
all:${PROTOCGEN_FILE_PATH}/arenarobot.bin ${PROTOCGEN_FILE_PATH}/arenarankaward.bin ${PROTOCGEN_FILE_PATH}/arenaarenAward.bin ${PROTOCGEN_FILE_PATH}/arenafirstrank.bin ${PROTOCGEN_FILE_PATH}/arenabuychallenge.bin 
