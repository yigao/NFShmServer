...
all:${PROTOCGEN_FILE_PATH}/arenarobot.bin ${PROTOCGEN_FILE_PATH}/ArenaRobotDesc.h ${PROTOCGEN_FILE_PATH}/ArenaRobotDesc.cpp ${PROTOCGEN_FILE_PATH}/arenaarenAward.bin ${PROTOCGEN_FILE_PATH}/ArenaArenawardDesc.h ${PROTOCGEN_FILE_PATH}/ArenaArenawardDesc.cpp ${PROTOCGEN_FILE_PATH}/arenarankaward.bin ${PROTOCGEN_FILE_PATH}/ArenaRankawardDesc.h ${PROTOCGEN_FILE_PATH}/ArenaRankawardDesc.cpp ${PROTOCGEN_FILE_PATH}/arenafirstrank.bin ${PROTOCGEN_FILE_PATH}/ArenaFirstrankDesc.h ${PROTOCGEN_FILE_PATH}/ArenaFirstrankDesc.cpp ${PROTOCGEN_FILE_PATH}/arenabuychallenge.bin ${PROTOCGEN_FILE_PATH}/ArenaBuychallengeDesc.h ${PROTOCGEN_FILE_PATH}/ArenaBuychallengeDesc.cpp 
