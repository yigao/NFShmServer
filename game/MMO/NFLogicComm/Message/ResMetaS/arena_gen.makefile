...
all:${PROTOCGEN_FILE_PATH}/E_ArenaRobot.bin ${PROTOCGEN_FILE_PATH}/ArenaRobotDesc.h ${PROTOCGEN_FILE_PATH}/ArenaRobotDesc.cpp ${PROTOCGEN_FILE_PATH}/E_ArenaRobotfacade.bin ${PROTOCGEN_FILE_PATH}/ArenaRobotfacadeDesc.h ${PROTOCGEN_FILE_PATH}/ArenaRobotfacadeDesc.cpp ${PROTOCGEN_FILE_PATH}/E_ArenaArenaward.bin ${PROTOCGEN_FILE_PATH}/ArenaArenawardDesc.h ${PROTOCGEN_FILE_PATH}/ArenaArenawardDesc.cpp ${PROTOCGEN_FILE_PATH}/E_ArenaRankaward.bin ${PROTOCGEN_FILE_PATH}/ArenaRankawardDesc.h ${PROTOCGEN_FILE_PATH}/ArenaRankawardDesc.cpp ${PROTOCGEN_FILE_PATH}/E_ArenaFirstrank.bin ${PROTOCGEN_FILE_PATH}/ArenaFirstrankDesc.h ${PROTOCGEN_FILE_PATH}/ArenaFirstrankDesc.cpp ${PROTOCGEN_FILE_PATH}/E_ArenaBuychallenge.bin ${PROTOCGEN_FILE_PATH}/ArenaBuychallengeDesc.h ${PROTOCGEN_FILE_PATH}/ArenaBuychallengeDesc.cpp 
...
${PROTOCGEN_FILE_PATH}/E_ArenaRobotfacade.bin:${PROTOCGEN_FILE_PATH}/arena.proto.ds ${RESDB_EXCELMMO_PATH}/arena.xlsx
	mkdir -p ${PROTOCGEN_FILE_PATH}
	${EXCEL2BIN_MMO} --excel=${RESDB_EXCELMMO_PATH}/arena.xlsx  --proto_ds=${PROTOCGEN_FILE_PATH}/arena.proto.ds --proto_package=proto_ff \
		--proto_sheet_msgname=Sheet_ArenaRobotfacade  --excel_sheetname=robotFacade  --proto_msgname=E_ArenaRobotfacade  --start_row=4 --out_path=${PROTOCGEN_FILE_PATH}/;
	${FILE_COPY_EXE} --src="${PROTOCGEN_FILE_PATH}/E_ArenaRobotfacade.bin" --dst=${GAME_DATA_PATH}/
	${FILE_COPY_EXE} --src="${PROTOCGEN_FILE_PATH}/ArenaRobotfacadeDesc.h ${PROTOCGEN_FILE_PATH}/ArenaRobotfacadeDesc.cpp" --dst=${DESC_STORE_PATH}/
