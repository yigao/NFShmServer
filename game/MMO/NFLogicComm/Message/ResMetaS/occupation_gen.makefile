...
${PROTOCGEN_FILE_PATH}/OccupationOccupationDesc.h ${PROTOCGEN_FILE_PATH}/OccupationOccupationDesc.cpp:${PROTOCGEN_FILE_PATH}/occupation.proto.ds ${RESDB_EXCELMMO_PATH}/occupation.xlsx
	mkdir -p ${PROTOCGEN_FILE_PATH}
...
${PROTOCGEN_FILE_PATH}/OccupationAptitudeDesc.h ${PROTOCGEN_FILE_PATH}/OccupationAptitudeDesc.cpp:${PROTOCGEN_FILE_PATH}/occupation.proto.ds ${RESDB_EXCELMMO_PATH}/occupation.xlsx
	mkdir -p ${PROTOCGEN_FILE_PATH}
...
${PROTOCGEN_FILE_PATH}/OccupationConditionlistDesc.h ${PROTOCGEN_FILE_PATH}/OccupationConditionlistDesc.cpp:${PROTOCGEN_FILE_PATH}/occupation.proto.ds ${RESDB_EXCELMMO_PATH}/occupation.xlsx
	mkdir -p ${PROTOCGEN_FILE_PATH}
