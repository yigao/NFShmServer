...
all:${PROTOCGEN_FILE_PATH}/functionunlockfunctionUnlock.bin ${PROTOCGEN_FILE_PATH}/FunctionunlockFunctionunlockDesc.h ${PROTOCGEN_FILE_PATH}/FunctionunlockFunctionunlockDesc.cpp 
...
${PROTOCGEN_FILE_PATH}/FunctionunlockFunctionunlockDesc.h ${PROTOCGEN_FILE_PATH}/FunctionunlockFunctionunlockDesc.cpp:${PROTOCGEN_FILE_PATH}/functionunlock.proto.ds ${RESDB_EXCELMMO_PATH}/functionunlock.xlsx
	mkdir -p ${PROTOCGEN_FILE_PATH}
