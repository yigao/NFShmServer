...
${GAME_DATA_PATH}/mountmount.bin:${RESDB_META_DESCRIPTOR} ${RESDB_EXCELMMO_PATH}/mount.xlsx
	${EXCEL2BIN_MMO} --excel=${RESDB_EXCELMMO_PATH}/mount.xlsx  --proto_ds=${RESDB_META_DESCRIPTOR} --proto_package=proto_ff \
		--proto_sheet_msgname=Sheet_mountmount  --excel_sheetname=mount  --proto_msgname=mountmount  --start_row=4 --out_path=${GAME_DATA_PATH}/

${GAME_DATA_PATH}/mountstarUp.bin:${RESDB_META_DESCRIPTOR} ${RESDB_EXCELMMO_PATH}/mount.xlsx
	${EXCEL2BIN_MMO} --excel=${RESDB_EXCELMMO_PATH}/mount.xlsx  --proto_ds=${RESDB_META_DESCRIPTOR} --proto_package=proto_ff \
