...
all:${PROTOCGEN_FILE_PATH}/rankingranking.bin ${PROTOCGEN_FILE_PATH}/RankingRankingDesc.h ${PROTOCGEN_FILE_PATH}/RankingRankingDesc.cpp ${PROTOCGEN_FILE_PATH}/rankingdate.bin ${PROTOCGEN_FILE_PATH}/RankingDateDesc.h ${PROTOCGEN_FILE_PATH}/RankingDateDesc.cpp ${PROTOCGEN_FILE_PATH}/rankingpkcons.bin ${PROTOCGEN_FILE_PATH}/RankingPkconsDesc.h ${PROTOCGEN_FILE_PATH}/RankingPkconsDesc.cpp 
