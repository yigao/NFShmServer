...
${PROTOCGEN_FILE_PATH}/ChatChatDesc.h ${PROTOCGEN_FILE_PATH}/ChatChatDesc.cpp:${PROTOCGEN_FILE_PATH}/chat.proto.ds ${RESDB_EXCELMMO_PATH}/chat.xlsx
	mkdir -p ${PROTOCGEN_FILE_PATH}
...
${PROTOCGEN_FILE_PATH}/ChatSpecialchatDesc.h ${PROTOCGEN_FILE_PATH}/ChatSpecialchatDesc.cpp:${PROTOCGEN_FILE_PATH}/chat.proto.ds ${RESDB_EXCELMMO_PATH}/chat.xlsx
	mkdir -p ${PROTOCGEN_FILE_PATH}
