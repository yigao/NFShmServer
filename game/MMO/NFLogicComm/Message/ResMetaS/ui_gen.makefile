...
all:${PROTOCGEN_FILE_PATH}/uieffect.bin ${PROTOCGEN_FILE_PATH}/UiEffectDesc.h ${PROTOCGEN_FILE_PATH}/UiEffectDesc.cpp 
...
${PROTOCGEN_FILE_PATH}/UiEffectDesc.h ${PROTOCGEN_FILE_PATH}/UiEffectDesc.cpp:${PROTOCGEN_FILE_PATH}/ui.proto.ds ${RESDB_EXCELMMO_PATH}/ui.xlsx
	mkdir -p ${PROTOCGEN_FILE_PATH}
