...
all:${PROTOCGEN_FILE_PATH}/msgphpmsg.bin ${PROTOCGEN_FILE_PATH}/MsgPhpmsgDesc.h ${PROTOCGEN_FILE_PATH}/MsgPhpmsgDesc.cpp 

${PROTOCGEN_FILE_PATH}/msgphpmsg.bin:${PROTOCGEN_FILE_PATH}/msg.proto.ds ${RESDB_EXCELMMO_PATH}/msg.xlsx
