...
all:${PROTOCGEN_FILE_PATH}/titletype.bin ${PROTOCGEN_FILE_PATH}/TitleTypeDesc.h ${PROTOCGEN_FILE_PATH}/TitleTypeDesc.cpp ${PROTOCGEN_FILE_PATH}/titletitle.bin ${PROTOCGEN_FILE_PATH}/TitleTitleDesc.h ${PROTOCGEN_FILE_PATH}/TitleTitleDesc.cpp 
...
${PROTOCGEN_FILE_PATH}/TitleTypeDesc.h ${PROTOCGEN_FILE_PATH}/TitleTypeDesc.cpp:${PROTOCGEN_FILE_PATH}/title.proto.ds ${RESDB_EXCELMMO_PATH}/title.xlsx
	mkdir -p ${PROTOCGEN_FILE_PATH}
...
${PROTOCGEN_FILE_PATH}/TitleTitleDesc.h ${PROTOCGEN_FILE_PATH}/TitleTitleDesc.cpp:${PROTOCGEN_FILE_PATH}/title.proto.ds ${RESDB_EXCELMMO_PATH}/title.xlsx
	mkdir -p ${PROTOCGEN_FILE_PATH}
