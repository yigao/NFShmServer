...
${PROTOCGEN_FILE_PATH}/CombineCitemDesc.h ${PROTOCGEN_FILE_PATH}/CombineCitemDesc.cpp:${PROTOCGEN_FILE_PATH}/combine.proto.ds ${RESDB_EXCELMMO_PATH}/combine.xlsx
	mkdir -p ${PROTOCGEN_FILE_PATH}
...
${PROTOCGEN_FILE_PATH}/CombineStarupDesc.h ${PROTOCGEN_FILE_PATH}/CombineStarupDesc.cpp:${PROTOCGEN_FILE_PATH}/combine.proto.ds ${RESDB_EXCELMMO_PATH}/combine.xlsx
	mkdir -p ${PROTOCGEN_FILE_PATH}
...
${PROTOCGEN_FILE_PATH}/CombineItemupDesc.h ${PROTOCGEN_FILE_PATH}/CombineItemupDesc.cpp:${PROTOCGEN_FILE_PATH}/combine.proto.ds ${RESDB_EXCELMMO_PATH}/combine.xlsx
	mkdir -p ${PROTOCGEN_FILE_PATH}
...
${PROTOCGEN_FILE_PATH}/CombineRankupDesc.h ${PROTOCGEN_FILE_PATH}/CombineRankupDesc.cpp:${PROTOCGEN_FILE_PATH}/combine.proto.ds ${RESDB_EXCELMMO_PATH}/combine.xlsx
	mkdir -p ${PROTOCGEN_FILE_PATH}
...
${PROTOCGEN_FILE_PATH}/CombineQualityupDesc.h ${PROTOCGEN_FILE_PATH}/CombineQualityupDesc.cpp:${PROTOCGEN_FILE_PATH}/combine.proto.ds ${RESDB_EXCELMMO_PATH}/combine.xlsx
	mkdir -p ${PROTOCGEN_FILE_PATH}
