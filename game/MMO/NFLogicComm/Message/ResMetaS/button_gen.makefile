...
all:${PROTOCGEN_FILE_PATH}/buttonbutton.bin ${PROTOCGEN_FILE_PATH}/ButtonButtonDesc.h ${PROTOCGEN_FILE_PATH}/ButtonButtonDesc.cpp 
...
${PROTOCGEN_FILE_PATH}/ButtonButtonDesc.h ${PROTOCGEN_FILE_PATH}/ButtonButtonDesc.cpp:${PROTOCGEN_FILE_PATH}/button.proto.ds ${RESDB_EXCELMMO_PATH}/button.xlsx
	mkdir -p ${PROTOCGEN_FILE_PATH}
