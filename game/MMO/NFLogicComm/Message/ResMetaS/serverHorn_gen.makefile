...
all:${PROTOCGEN_FILE_PATH}/serverHornserverHorn.bin ${PROTOCGEN_FILE_PATH}/ServerhornServerhornDesc.h ${PROTOCGEN_FILE_PATH}/ServerhornServerhornDesc.cpp 
...
${PROTOCGEN_FILE_PATH}/ServerhornServerhornDesc.h ${PROTOCGEN_FILE_PATH}/ServerhornServerhornDesc.cpp:${PROTOCGEN_FILE_PATH}/serverHorn.proto.ds ${RESDB_EXCELMMO_PATH}/serverHorn.xlsx
	mkdir -p ${PROTOCGEN_FILE_PATH}
	${FILE_COPY_EXE} --src="${PROTOCGEN_FILE_PATH}/ServerhornServerhornDesc.h ${PROTOCGEN_FILE_PATH}/ServerhornServerhornDesc.cpp" --dst=${DESC_STORE_PATH}/
