...
all:${PROTOCGEN_FILE_PATH}/mapmap.bin ${PROTOCGEN_FILE_PATH}/MapMapDesc.h ${PROTOCGEN_FILE_PATH}/MapMapDesc.cpp ${PROTOCGEN_FILE_PATH}/mapitemdrop.bin ${PROTOCGEN_FILE_PATH}/MapItemdropDesc.h ${PROTOCGEN_FILE_PATH}/MapItemdropDesc.cpp ${PROTOCGEN_FILE_PATH}/mapdestroyitem.bin ${PROTOCGEN_FILE_PATH}/MapDestroyitemDesc.h ${PROTOCGEN_FILE_PATH}/MapDestroyitemDesc.cpp 
...
${PROTOCGEN_FILE_PATH}/MapMapDesc.h ${PROTOCGEN_FILE_PATH}/MapMapDesc.cpp:${PROTOCGEN_FILE_PATH}/map.proto.ds ${RESDB_EXCELMMO_PATH}/map.xlsx
	mkdir -p ${PROTOCGEN_FILE_PATH}
...
${PROTOCGEN_FILE_PATH}/MapItemdropDesc.h ${PROTOCGEN_FILE_PATH}/MapItemdropDesc.cpp:${PROTOCGEN_FILE_PATH}/map.proto.ds ${RESDB_EXCELMMO_PATH}/map.xlsx
	mkdir -p ${PROTOCGEN_FILE_PATH}
...
${PROTOCGEN_FILE_PATH}/MapDestroyitemDesc.h ${PROTOCGEN_FILE_PATH}/MapDestroyitemDesc.cpp:${PROTOCGEN_FILE_PATH}/map.proto.ds ${RESDB_EXCELMMO_PATH}/map.xlsx
	mkdir -p ${PROTOCGEN_FILE_PATH}
