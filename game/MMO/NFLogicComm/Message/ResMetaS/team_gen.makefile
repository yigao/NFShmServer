...
all:${PROTOCGEN_FILE_PATH}/teamteam.bin ${PROTOCGEN_FILE_PATH}/TeamTeamDesc.h ${PROTOCGEN_FILE_PATH}/TeamTeamDesc.cpp 
...
${PROTOCGEN_FILE_PATH}/TeamTeamDesc.h ${PROTOCGEN_FILE_PATH}/TeamTeamDesc.cpp:${PROTOCGEN_FILE_PATH}/team.proto.ds ${RESDB_EXCELMMO_PATH}/team.xlsx
	mkdir -p ${PROTOCGEN_FILE_PATH}
