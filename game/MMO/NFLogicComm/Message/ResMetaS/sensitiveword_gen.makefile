...
all:${PROTOCGEN_FILE_PATH}/sensitivewordsensitive_word.bin ${PROTOCGEN_FILE_PATH}/SensitivewordSensitive_wordDesc.h ${PROTOCGEN_FILE_PATH}/SensitivewordSensitive_wordDesc.cpp ${PROTOCGEN_FILE_PATH}/sensitivewordrolesensitive.bin ${PROTOCGEN_FILE_PATH}/SensitivewordRolesensitiveDesc.h ${PROTOCGEN_FILE_PATH}/SensitivewordRolesensitiveDesc.cpp 
