...
${GAME_DATA_PATH}/roleborn.bin:${RESDB_META_DESCRIPTOR} ${RESDB_EXCELMMO_PATH}/role.xlsx
	${EXCEL2BIN_MMO} --excel=${RESDB_EXCELMMO_PATH}/role.xlsx  --proto_ds=${RESDB_META_DESCRIPTOR} --proto_package=proto_ff \
		--proto_sheet_msgname=Sheet_roleborn  --excel_sheetname=born  --proto_msgname=roleborn  --start_row=4 --out_path=${GAME_DATA_PATH}/

${GAME_DATA_PATH}/rolewarrior.bin:${RESDB_META_DESCRIPTOR} ${RESDB_EXCELMMO_PATH}/role.xlsx
	${EXCEL2BIN_MMO} --excel=${RESDB_EXCELMMO_PATH}/role.xlsx  --proto_ds=${RESDB_META_DESCRIPTOR} --proto_package=proto_ff \
...
${GAME_DATA_PATH}/rolemaster.bin:${RESDB_META_DESCRIPTOR} ${RESDB_EXCELMMO_PATH}/role.xlsx
	${EXCEL2BIN_MMO} --excel=${RESDB_EXCELMMO_PATH}/role.xlsx  --proto_ds=${RESDB_META_DESCRIPTOR} --proto_package=proto_ff \
		--proto_sheet_msgname=Sheet_rolemaster  --excel_sheetname=master  --proto_msgname=rolemaster  --start_row=4 --out_path=${GAME_DATA_PATH}/

${GAME_DATA_PATH}/roleassassin.bin:${RESDB_META_DESCRIPTOR} ${RESDB_EXCELMMO_PATH}/role.xlsx
	${EXCEL2BIN_MMO} --excel=${RESDB_EXCELMMO_PATH}/role.xlsx  --proto_ds=${RESDB_META_DESCRIPTOR} --proto_package=proto_ff \
...
${GAME_DATA_PATH}/roleshooter.bin:${RESDB_META_DESCRIPTOR} ${RESDB_EXCELMMO_PATH}/role.xlsx
	${EXCEL2BIN_MMO} --excel=${RESDB_EXCELMMO_PATH}/role.xlsx  --proto_ds=${RESDB_META_DESCRIPTOR} --proto_package=proto_ff \
...
${GAME_DATA_PATH}/roleexp.bin:${RESDB_META_DESCRIPTOR} ${RESDB_EXCELMMO_PATH}/role.xlsx
	${EXCEL2BIN_MMO} --excel=${RESDB_EXCELMMO_PATH}/role.xlsx  --proto_ds=${RESDB_META_DESCRIPTOR} --proto_package=proto_ff \
		--proto_sheet_msgname=Sheet_roleexp  --excel_sheetname=exp  --proto_msgname=roleexp  --start_row=4 --out_path=${GAME_DATA_PATH}/

${GAME_DATA_PATH}/roleskillType.bin:${RESDB_META_DESCRIPTOR} ${RESDB_EXCELMMO_PATH}/role.xlsx
	${EXCEL2BIN_MMO} --excel=${RESDB_EXCELMMO_PATH}/role.xlsx  --proto_ds=${RESDB_META_DESCRIPTOR} --proto_package=proto_ff \
...
${GAME_DATA_PATH}/roleaddSkill.bin:${RESDB_META_DESCRIPTOR} ${RESDB_EXCELMMO_PATH}/role.xlsx
	${EXCEL2BIN_MMO} --excel=${RESDB_EXCELMMO_PATH}/role.xlsx  --proto_ds=${RESDB_META_DESCRIPTOR} --proto_package=proto_ff \
...
${GAME_DATA_PATH}/roleworldexp.bin:${RESDB_META_DESCRIPTOR} ${RESDB_EXCELMMO_PATH}/role.xlsx
	${EXCEL2BIN_MMO} --excel=${RESDB_EXCELMMO_PATH}/role.xlsx  --proto_ds=${RESDB_META_DESCRIPTOR} --proto_package=proto_ff \
