...
${PROTOCGEN_FILE_PATH}/HandbookHandbookDesc.h ${PROTOCGEN_FILE_PATH}/HandbookHandbookDesc.cpp:${PROTOCGEN_FILE_PATH}/handbook.proto.ds ${RESDB_EXCELMMO_PATH}/handbook.xlsx
	mkdir -p ${PROTOCGEN_FILE_PATH}
...
${PROTOCGEN_FILE_PATH}/HandbookFateDesc.h ${PROTOCGEN_FILE_PATH}/HandbookFateDesc.cpp:${PROTOCGEN_FILE_PATH}/handbook.proto.ds ${RESDB_EXCELMMO_PATH}/handbook.xlsx
	mkdir -p ${PROTOCGEN_FILE_PATH}
...
${PROTOCGEN_FILE_PATH}/HandbookAttrDesc.h ${PROTOCGEN_FILE_PATH}/HandbookAttrDesc.cpp:${PROTOCGEN_FILE_PATH}/handbook.proto.ds ${RESDB_EXCELMMO_PATH}/handbook.xlsx
	mkdir -p ${PROTOCGEN_FILE_PATH}
