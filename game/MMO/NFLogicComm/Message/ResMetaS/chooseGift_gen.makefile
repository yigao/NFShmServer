...
all:${PROTOCGEN_FILE_PATH}/chooseGiftchooseGift.bin ${PROTOCGEN_FILE_PATH}/ChoosegiftChoosegiftDesc.h ${PROTOCGEN_FILE_PATH}/ChoosegiftChoosegiftDesc.cpp 
...
${PROTOCGEN_FILE_PATH}/ChoosegiftChoosegiftDesc.h ${PROTOCGEN_FILE_PATH}/ChoosegiftChoosegiftDesc.cpp:${PROTOCGEN_FILE_PATH}/chooseGift.proto.ds ${RESDB_EXCELMMO_PATH}/chooseGift.xlsx
	mkdir -p ${PROTOCGEN_FILE_PATH}
	${FILE_COPY_EXE} --src="${PROTOCGEN_FILE_PATH}/ChoosegiftChoosegiftDesc.h ${PROTOCGEN_FILE_PATH}/ChoosegiftChoosegiftDesc.cpp" --dst=${DESC_STORE_PATH}/
