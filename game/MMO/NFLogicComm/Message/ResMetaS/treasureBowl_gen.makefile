...
${PROTOCGEN_FILE_PATH}/TreasurebowlTreasurebowlDesc.h ${PROTOCGEN_FILE_PATH}/TreasurebowlTreasurebowlDesc.cpp:${PROTOCGEN_FILE_PATH}/treasureBowl.proto.ds ${RESDB_EXCELMMO_PATH}/treasureBowl.xlsx
	mkdir -p ${PROTOCGEN_FILE_PATH}
