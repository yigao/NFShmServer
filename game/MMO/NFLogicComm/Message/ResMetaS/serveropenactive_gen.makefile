...
${PROTOCGEN_FILE_PATH}/ServeropenactiveServiceactivityDesc.h ${PROTOCGEN_FILE_PATH}/ServeropenactiveServiceactivityDesc.cpp:${PROTOCGEN_FILE_PATH}/serveropenactive.proto.ds ${RESDB_EXCELMMO_PATH}/serveropenactive.xlsx
	mkdir -p ${PROTOCGEN_FILE_PATH}
...
${PROTOCGEN_FILE_PATH}/ServeropenactivePagebookDesc.h ${PROTOCGEN_FILE_PATH}/ServeropenactivePagebookDesc.cpp:${PROTOCGEN_FILE_PATH}/serveropenactive.proto.ds ${RESDB_EXCELMMO_PATH}/serveropenactive.xlsx
	mkdir -p ${PROTOCGEN_FILE_PATH}
...
${PROTOCGEN_FILE_PATH}/ServeropenactivePageDesc.h ${PROTOCGEN_FILE_PATH}/ServeropenactivePageDesc.cpp:${PROTOCGEN_FILE_PATH}/serveropenactive.proto.ds ${RESDB_EXCELMMO_PATH}/serveropenactive.xlsx
	mkdir -p ${PROTOCGEN_FILE_PATH}
...
${PROTOCGEN_FILE_PATH}/ServeropenactiveMrankDesc.h ${PROTOCGEN_FILE_PATH}/ServeropenactiveMrankDesc.cpp:${PROTOCGEN_FILE_PATH}/serveropenactive.proto.ds ${RESDB_EXCELMMO_PATH}/serveropenactive.xlsx
	mkdir -p ${PROTOCGEN_FILE_PATH}
...
${PROTOCGEN_FILE_PATH}/ServeropenactiveMadvancedDesc.h ${PROTOCGEN_FILE_PATH}/ServeropenactiveMadvancedDesc.cpp:${PROTOCGEN_FILE_PATH}/serveropenactive.proto.ds ${RESDB_EXCELMMO_PATH}/serveropenactive.xlsx
	mkdir -p ${PROTOCGEN_FILE_PATH}
...
${PROTOCGEN_FILE_PATH}/ServeropenactiveMrechargeDesc.h ${PROTOCGEN_FILE_PATH}/ServeropenactiveMrechargeDesc.cpp:${PROTOCGEN_FILE_PATH}/serveropenactive.proto.ds ${RESDB_EXCELMMO_PATH}/serveropenactive.xlsx
	mkdir -p ${PROTOCGEN_FILE_PATH}
...
${PROTOCGEN_FILE_PATH}/ServeropenactiveMgoodsDesc.h ${PROTOCGEN_FILE_PATH}/ServeropenactiveMgoodsDesc.cpp:${PROTOCGEN_FILE_PATH}/serveropenactive.proto.ds ${RESDB_EXCELMMO_PATH}/serveropenactive.xlsx
	mkdir -p ${PROTOCGEN_FILE_PATH}
