...
${GAME_DATA_PATH}/serveropenactiveserviceActivity.bin:${RESDB_META_DESCRIPTOR} ${RESDB_EXCELMMO_PATH}/serveropenactive.xlsx
	${EXCEL2BIN_MMO} --excel=${RESDB_EXCELMMO_PATH}/serveropenactive.xlsx  --proto_ds=${RESDB_META_DESCRIPTOR} --proto_package=proto_ff \
...
${GAME_DATA_PATH}/serveropenactivepageBook.bin:${RESDB_META_DESCRIPTOR} ${RESDB_EXCELMMO_PATH}/serveropenactive.xlsx
	${EXCEL2BIN_MMO} --excel=${RESDB_EXCELMMO_PATH}/serveropenactive.xlsx  --proto_ds=${RESDB_META_DESCRIPTOR} --proto_package=proto_ff \
...
${GAME_DATA_PATH}/serveropenactivepage.bin:${RESDB_META_DESCRIPTOR} ${RESDB_EXCELMMO_PATH}/serveropenactive.xlsx
	${EXCEL2BIN_MMO} --excel=${RESDB_EXCELMMO_PATH}/serveropenactive.xlsx  --proto_ds=${RESDB_META_DESCRIPTOR} --proto_package=proto_ff \
...
${GAME_DATA_PATH}/serveropenactivemRank.bin:${RESDB_META_DESCRIPTOR} ${RESDB_EXCELMMO_PATH}/serveropenactive.xlsx
	${EXCEL2BIN_MMO} --excel=${RESDB_EXCELMMO_PATH}/serveropenactive.xlsx  --proto_ds=${RESDB_META_DESCRIPTOR} --proto_package=proto_ff \
...
${GAME_DATA_PATH}/serveropenactivemAdvanced.bin:${RESDB_META_DESCRIPTOR} ${RESDB_EXCELMMO_PATH}/serveropenactive.xlsx
	${EXCEL2BIN_MMO} --excel=${RESDB_EXCELMMO_PATH}/serveropenactive.xlsx  --proto_ds=${RESDB_META_DESCRIPTOR} --proto_package=proto_ff \
...
${GAME_DATA_PATH}/serveropenactivemRecharge.bin:${RESDB_META_DESCRIPTOR} ${RESDB_EXCELMMO_PATH}/serveropenactive.xlsx
	${EXCEL2BIN_MMO} --excel=${RESDB_EXCELMMO_PATH}/serveropenactive.xlsx  --proto_ds=${RESDB_META_DESCRIPTOR} --proto_package=proto_ff \
...
${GAME_DATA_PATH}/serveropenactivemGoods.bin:${RESDB_META_DESCRIPTOR} ${RESDB_EXCELMMO_PATH}/serveropenactive.xlsx
	${EXCEL2BIN_MMO} --excel=${RESDB_EXCELMMO_PATH}/serveropenactive.xlsx  --proto_ds=${RESDB_META_DESCRIPTOR} --proto_package=proto_ff \
