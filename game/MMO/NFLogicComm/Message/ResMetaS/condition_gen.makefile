...
${PROTOCGEN_FILE_PATH}/ConditionConditionDesc.h ${PROTOCGEN_FILE_PATH}/ConditionConditionDesc.cpp:${PROTOCGEN_FILE_PATH}/condition.proto.ds ${RESDB_EXCELMMO_PATH}/condition.xlsx
	mkdir -p ${PROTOCGEN_FILE_PATH}
