...
all:${PROTOCGEN_FILE_PATH}/itemitem.bin ${PROTOCGEN_FILE_PATH}/ItemItemDesc.h ${PROTOCGEN_FILE_PATH}/ItemItemDesc.cpp 
...
${PROTOCGEN_FILE_PATH}/ItemItemDesc.h ${PROTOCGEN_FILE_PATH}/ItemItemDesc.cpp:${PROTOCGEN_FILE_PATH}/item.proto.ds ${RESDB_EXCELMMO_PATH}/item.xlsx
	mkdir -p ${PROTOCGEN_FILE_PATH}
