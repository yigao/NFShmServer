...
all:${PROTOCGEN_FILE_PATH}/getTreasurerareItem.bin ${PROTOCGEN_FILE_PATH}/getTreasuretimesControl.bin ${PROTOCGEN_FILE_PATH}/getTreasureArrivalBossReward.bin ${PROTOCGEN_FILE_PATH}/getTreasureArrivalBossControl.bin ${PROTOCGEN_FILE_PATH}/getTreasurevipBossControl.bin ${PROTOCGEN_FILE_PATH}/getTreasureboss.bin ${PROTOCGEN_FILE_PATH}/getTreasurehelp.bin 
