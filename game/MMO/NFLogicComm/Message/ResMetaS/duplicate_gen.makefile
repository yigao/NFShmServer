...
${GAME_DATA_PATH}/duplicateduplicate.bin:${PROTOCGEN_FILE_PATH}/duplicate.proto.ds ${RESDB_EXCELMMO_PATH}/duplicate.xlsx
...
${GAME_DATA_PATH}/duplicateconstant.bin:${PROTOCGEN_FILE_PATH}/duplicate.proto.ds ${RESDB_EXCELMMO_PATH}/duplicate.xlsx
	${EXCEL2BIN_MMO} --excel=${RESDB_EXCELMMO_PATH}/duplicate.xlsx  --proto_ds=${PROTOCGEN_FILE_PATH}/duplicate.proto.ds --proto_package=proto_ff \
...
${GAME_DATA_PATH}/duplicateendlessMaze.bin:${PROTOCGEN_FILE_PATH}/duplicate.proto.ds ${RESDB_EXCELMMO_PATH}/duplicate.xlsx
	${EXCEL2BIN_MMO} --excel=${RESDB_EXCELMMO_PATH}/duplicate.xlsx  --proto_ds=${PROTOCGEN_FILE_PATH}/duplicate.proto.ds --proto_package=proto_ff \
...
${GAME_DATA_PATH}/duplicatetowerReward.bin:${PROTOCGEN_FILE_PATH}/duplicate.proto.ds ${RESDB_EXCELMMO_PATH}/duplicate.xlsx
	${EXCEL2BIN_MMO} --excel=${RESDB_EXCELMMO_PATH}/duplicate.xlsx  --proto_ds=${PROTOCGEN_FILE_PATH}/duplicate.proto.ds --proto_package=proto_ff \
...
${GAME_DATA_PATH}/duplicatedungeonReward.bin:${PROTOCGEN_FILE_PATH}/duplicate.proto.ds ${RESDB_EXCELMMO_PATH}/duplicate.xlsx
	${EXCEL2BIN_MMO} --excel=${RESDB_EXCELMMO_PATH}/duplicate.xlsx  --proto_ds=${PROTOCGEN_FILE_PATH}/duplicate.proto.ds --proto_package=proto_ff \
...
${GAME_DATA_PATH}/duplicategroup.bin:${PROTOCGEN_FILE_PATH}/duplicate.proto.ds ${RESDB_EXCELMMO_PATH}/duplicate.xlsx
	${EXCEL2BIN_MMO} --excel=${RESDB_EXCELMMO_PATH}/duplicate.xlsx  --proto_ds=${PROTOCGEN_FILE_PATH}/duplicate.proto.ds --proto_package=proto_ff \
...
${GAME_DATA_PATH}/duplicatesweepmonsterNum.bin:${PROTOCGEN_FILE_PATH}/duplicate.proto.ds ${RESDB_EXCELMMO_PATH}/duplicate.xlsx
	${EXCEL2BIN_MMO} --excel=${RESDB_EXCELMMO_PATH}/duplicate.xlsx  --proto_ds=${PROTOCGEN_FILE_PATH}/duplicate.proto.ds --proto_package=proto_ff \
...
${GAME_DATA_PATH}/duplicateGuildbosstime.bin:${PROTOCGEN_FILE_PATH}/duplicate.proto.ds ${RESDB_EXCELMMO_PATH}/duplicate.xlsx
	${EXCEL2BIN_MMO} --excel=${RESDB_EXCELMMO_PATH}/duplicate.xlsx  --proto_ds=${PROTOCGEN_FILE_PATH}/duplicate.proto.ds --proto_package=proto_ff \
...
${GAME_DATA_PATH}/duplicateGuildboss.bin:${PROTOCGEN_FILE_PATH}/duplicate.proto.ds ${RESDB_EXCELMMO_PATH}/duplicate.xlsx
	${EXCEL2BIN_MMO} --excel=${RESDB_EXCELMMO_PATH}/duplicate.xlsx  --proto_ds=${PROTOCGEN_FILE_PATH}/duplicate.proto.ds --proto_package=proto_ff \
...
${GAME_DATA_PATH}/duplicateGuildDuplicate.bin:${PROTOCGEN_FILE_PATH}/duplicate.proto.ds ${RESDB_EXCELMMO_PATH}/duplicate.xlsx
	${EXCEL2BIN_MMO} --excel=${RESDB_EXCELMMO_PATH}/duplicate.xlsx  --proto_ds=${PROTOCGEN_FILE_PATH}/duplicate.proto.ds --proto_package=proto_ff \
