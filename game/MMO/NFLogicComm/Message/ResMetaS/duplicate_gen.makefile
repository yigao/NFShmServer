...
${PROTOCGEN_FILE_PATH}/DuplicateDuplicateDesc.h ${PROTOCGEN_FILE_PATH}/DuplicateDuplicateDesc.cpp:${PROTOCGEN_FILE_PATH}/duplicate.proto.ds ${RESDB_EXCELMMO_PATH}/duplicate.xlsx
	mkdir -p ${PROTOCGEN_FILE_PATH}
...
${PROTOCGEN_FILE_PATH}/DuplicateConstantDesc.h ${PROTOCGEN_FILE_PATH}/DuplicateConstantDesc.cpp:${PROTOCGEN_FILE_PATH}/duplicate.proto.ds ${RESDB_EXCELMMO_PATH}/duplicate.xlsx
	mkdir -p ${PROTOCGEN_FILE_PATH}
...
${PROTOCGEN_FILE_PATH}/DuplicateEndlessmazeDesc.h ${PROTOCGEN_FILE_PATH}/DuplicateEndlessmazeDesc.cpp:${PROTOCGEN_FILE_PATH}/duplicate.proto.ds ${RESDB_EXCELMMO_PATH}/duplicate.xlsx
	mkdir -p ${PROTOCGEN_FILE_PATH}
...
${PROTOCGEN_FILE_PATH}/DuplicateTowerrewardDesc.h ${PROTOCGEN_FILE_PATH}/DuplicateTowerrewardDesc.cpp:${PROTOCGEN_FILE_PATH}/duplicate.proto.ds ${RESDB_EXCELMMO_PATH}/duplicate.xlsx
	mkdir -p ${PROTOCGEN_FILE_PATH}
...
${PROTOCGEN_FILE_PATH}/DuplicateDungeonrewardDesc.h ${PROTOCGEN_FILE_PATH}/DuplicateDungeonrewardDesc.cpp:${PROTOCGEN_FILE_PATH}/duplicate.proto.ds ${RESDB_EXCELMMO_PATH}/duplicate.xlsx
	mkdir -p ${PROTOCGEN_FILE_PATH}
...
${PROTOCGEN_FILE_PATH}/DuplicateGroupDesc.h ${PROTOCGEN_FILE_PATH}/DuplicateGroupDesc.cpp:${PROTOCGEN_FILE_PATH}/duplicate.proto.ds ${RESDB_EXCELMMO_PATH}/duplicate.xlsx
	mkdir -p ${PROTOCGEN_FILE_PATH}
...
${PROTOCGEN_FILE_PATH}/DuplicateSweepmonsternumDesc.h ${PROTOCGEN_FILE_PATH}/DuplicateSweepmonsternumDesc.cpp:${PROTOCGEN_FILE_PATH}/duplicate.proto.ds ${RESDB_EXCELMMO_PATH}/duplicate.xlsx
	mkdir -p ${PROTOCGEN_FILE_PATH}
...
${PROTOCGEN_FILE_PATH}/DuplicateGuildbosstimeDesc.h ${PROTOCGEN_FILE_PATH}/DuplicateGuildbosstimeDesc.cpp:${PROTOCGEN_FILE_PATH}/duplicate.proto.ds ${RESDB_EXCELMMO_PATH}/duplicate.xlsx
	mkdir -p ${PROTOCGEN_FILE_PATH}
...
${PROTOCGEN_FILE_PATH}/DuplicateGuildbossDesc.h ${PROTOCGEN_FILE_PATH}/DuplicateGuildbossDesc.cpp:${PROTOCGEN_FILE_PATH}/duplicate.proto.ds ${RESDB_EXCELMMO_PATH}/duplicate.xlsx
	mkdir -p ${PROTOCGEN_FILE_PATH}
...
${PROTOCGEN_FILE_PATH}/DuplicateGuildduplicateDesc.h ${PROTOCGEN_FILE_PATH}/DuplicateGuildduplicateDesc.cpp:${PROTOCGEN_FILE_PATH}/duplicate.proto.ds ${RESDB_EXCELMMO_PATH}/duplicate.xlsx
	mkdir -p ${PROTOCGEN_FILE_PATH}
