...
${PROTOCGEN_FILE_PATH}/ArtifactArtifactDesc.h ${PROTOCGEN_FILE_PATH}/ArtifactArtifactDesc.cpp:${PROTOCGEN_FILE_PATH}/artifact.proto.ds ${RESDB_EXCELMMO_PATH}/artifact.xlsx
	mkdir -p ${PROTOCGEN_FILE_PATH}
