...
all:${PROTOCGEN_FILE_PATH}/rechargerecharge.bin ${PROTOCGEN_FILE_PATH}/RechargeRechargeDesc.h ${PROTOCGEN_FILE_PATH}/RechargeRechargeDesc.cpp 
...
${PROTOCGEN_FILE_PATH}/RechargeRechargeDesc.h ${PROTOCGEN_FILE_PATH}/RechargeRechargeDesc.cpp:${PROTOCGEN_FILE_PATH}/recharge.proto.ds ${RESDB_EXCELMMO_PATH}/recharge.xlsx
	mkdir -p ${PROTOCGEN_FILE_PATH}
