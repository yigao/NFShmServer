...
all:${PROTOCGEN_FILE_PATH}/taskrewardtaskreward.bin ${PROTOCGEN_FILE_PATH}/TaskrewardTaskrewardDesc.h ${PROTOCGEN_FILE_PATH}/TaskrewardTaskrewardDesc.cpp 
...
${PROTOCGEN_FILE_PATH}/TaskrewardTaskrewardDesc.h ${PROTOCGEN_FILE_PATH}/TaskrewardTaskrewardDesc.cpp:${PROTOCGEN_FILE_PATH}/taskreward.proto.ds ${RESDB_EXCELMMO_PATH}/taskreward.xlsx
	mkdir -p ${PROTOCGEN_FILE_PATH}
