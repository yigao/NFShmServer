...
int OccupationConditionlistDesc::Load(NFResDB *pDB)
{
	...
	{
		NFLogError(NF_LOG_COMM_LOGIC_PLUGIN, 0, "Invalid TotalNum:{}", table.occupationconditionList_list_size());
		return -2;
	}
	...
	NFLogTrace(NF_LOG_COMM_LOGIC_PLUGIN, 0, "load {}, num={}", iRet, table.occupationconditionList_list_size());
	return 0;
...
const proto_ff_s::occupationconditionList_s * OccupationConditionlistDesc::CetDesc(int id) const
{
