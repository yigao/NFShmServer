...
public:
	...
	int CreateInit();
	int ResumeInit();
	const proto_ff_s::pointpoint_s* GetDesc(int id) const;
	proto_ff_s::pointpoint_s* GetDesc(int id);
public:
IMPL_RES_HASH_DESC(proto_ff_s::pointpoint_s, pointpoint, MAX_POINT_POINT_NUM);
