...
int TaskdynamicTaskcomcondDesc::Load(NFResDB *pDB)
{
	...
	{
		NFLogError(NF_LOG_COMM_LOGIC_PLUGIN, 0, "Invalid TotalNum:{}", table.taskdynamictaskcomcond_list_size());
		return -2;
	}
	...
	NFLogTrace(NF_LOG_COMM_LOGIC_PLUGIN, 0, "load {}, num={}", iRet, table.taskdynamictaskcomcond_list_size());
	return 0;
...
const proto_ff_s::taskdynamictaskcomcond_s * TaskdynamicTaskcomcondDesc::CetDesc(int id) const
{
