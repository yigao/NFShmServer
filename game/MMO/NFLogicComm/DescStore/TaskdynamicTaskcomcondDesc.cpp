...
const proto_ff_s::E_TaskdynamicTaskcomcond_s * TaskdynamicTaskcomcondDesc::GetDesc(int id) const
{
...
proto_ff_s::E_TaskdynamicTaskcomcond_s * TaskdynamicTaskcomcondDesc::GetDesc(int id)
{
