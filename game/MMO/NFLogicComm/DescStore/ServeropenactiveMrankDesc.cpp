...
int ServeropenactiveMrankDesc::Load(NFResDB *pDB)
{
	...
	{
		NFLogError(NF_LOG_COMM_LOGIC_PLUGIN, 0, "Invalid TotalNum:{}", table.serveropenactivemRank_list_size());
		return -2;
	}
	...
	NFLogTrace(NF_LOG_COMM_LOGIC_PLUGIN, 0, "load {}, num={}", iRet, table.serveropenactivemRank_list_size());
	return 0;
...
const proto_ff_s::serveropenactivemRank_s * ServeropenactiveMrankDesc::CetDesc(int id) const
{
