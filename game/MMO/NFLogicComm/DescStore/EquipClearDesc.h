...
public:
	...
	int CreateInit();
	int ResumeInit();
	const proto_ff_s::E_EquipClear_s* GetDesc(int64_t id) const;
	proto_ff_s::E_EquipClear_s* GetDesc(int64_t id);
	int GetDescIndex(int id) const;
	const proto_ff_s::E_EquipClear_s* GetDescByIndex(int index) const;
	proto_ff_s::E_EquipClear_s* GetDescByIndex(int index);
public:
