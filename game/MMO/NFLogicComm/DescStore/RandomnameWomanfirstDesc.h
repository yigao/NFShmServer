...
public:
	...
	int CreateInit();
	int ResumeInit();
	const proto_ff_s::E_RandomnameWomanfirst_s* GetDesc(int id) const;
	proto_ff_s::E_RandomnameWomanfirst_s* GetDesc(int id);
public:
IMPL_RES_HASH_DESC(proto_ff_s::E_RandomnameWomanfirst_s, E_RandomnameWomanfirst, MAX_RANDOMNAME_WOMANFIRST_NUM);
