...
int AvatarDisplayDesc::Load(NFResDB *pDB)
{
	...
	m_astDesc.resize(table.e_avatardisplay_list_size());
...
const proto_ff_s::E_AvatarDisplay_s * AvatarDisplayDesc::GetDesc(int id) const
{
...
proto_ff_s::E_AvatarDisplay_s * AvatarDisplayDesc::GetDesc(int id)
{
