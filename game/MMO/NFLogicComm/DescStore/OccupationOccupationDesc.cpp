...
const proto_ff_s::E_OccupationOccupation_s * OccupationOccupationDesc::GetDesc(int id) const
{
...
proto_ff_s::E_OccupationOccupation_s * OccupationOccupationDesc::GetDesc(int id)
{
