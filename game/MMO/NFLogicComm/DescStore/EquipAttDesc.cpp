...
int EquipAttDesc::Load(NFResDB *pDB)
{
	...
	{
		NFLogError(NF_LOG_SYSTEMLOG, 0, "Invalid TotalNum:{}", table.equipatt_list_size());
		return -2;
	}
	...
	NFLogTrace(NF_LOG_SYSTEMLOG, 0, "load {}, num={}", iRet, table.equipatt_list_size());
...
const proto_ff_s::equipatt_s * EquipAttDesc::GetDesc(int id) const
{
