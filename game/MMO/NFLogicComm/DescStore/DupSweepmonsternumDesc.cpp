...
const proto_ff_s::E_DupSweepmonsternum_s * DupSweepmonsternumDesc::GetDesc(int id) const
{
...
proto_ff_s::E_DupSweepmonsternum_s * DupSweepmonsternumDesc::GetDesc(int id)
{
