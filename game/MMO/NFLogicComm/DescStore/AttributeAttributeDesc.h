...
public:
	...
	int CreateInit();
	int ResumeInit();
	const proto_ff_s::E_AttributeAttribute_s* GetDesc(int id) const;
	proto_ff_s::E_AttributeAttribute_s* GetDesc(int id);
public:
IMPL_RES_HASH_DESC(proto_ff_s::E_AttributeAttribute_s, attributeattribute, MAX_ATTRIBUTE_ATTRIBUTE_NUM);
