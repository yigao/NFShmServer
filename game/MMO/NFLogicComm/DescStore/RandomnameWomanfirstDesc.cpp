...
const proto_ff_s::E_RandomnameWomanfirst_s * RandomnameWomanfirstDesc::GetDesc(int id) const
{
...
proto_ff_s::E_RandomnameWomanfirst_s * RandomnameWomanfirstDesc::GetDesc(int id)
{
