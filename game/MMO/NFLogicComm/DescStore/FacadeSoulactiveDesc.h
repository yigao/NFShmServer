...
public:
	...
	int CreateInit();
	int ResumeInit();
	const proto_ff_s::E_FacadeSoulactive_s* GetDesc(int id) const;
	proto_ff_s::E_FacadeSoulactive_s* GetDesc(int id);
public:
IMPL_RES_HASH_DESC(proto_ff_s::E_FacadeSoulactive_s, E_FacadeSoulactive, MAX_FACADE_SOULACTIVE_NUM);
