...
const proto_ff_s::E_RandomnameWomansecond_s * RandomnameWomansecondDesc::GetDesc(int id) const
{
...
proto_ff_s::E_RandomnameWomansecond_s * RandomnameWomansecondDesc::GetDesc(int id)
{
