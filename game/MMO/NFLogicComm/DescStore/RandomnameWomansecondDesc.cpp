...
int RandomnameWomansecondDesc::Load(NFResDB *pDB)
{
	...
	{
		NFLogError(NF_LOG_COMM_LOGIC_PLUGIN, 0, "Invalid TotalNum:{}", table.randomnamewomansecond_list_size());
		return -2;
	}
	...
	NFLogTrace(NF_LOG_COMM_LOGIC_PLUGIN, 0, "load {}, num={}", iRet, table.randomnamewomansecond_list_size());
	return 0;
...
const proto_ff_s::randomnamewomansecond_s * RandomnameWomansecondDesc::CetDesc(int id) const
{
