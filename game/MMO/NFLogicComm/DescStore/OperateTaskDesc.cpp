...
int OperateTaskDesc::Load(NFResDB *pDB)
{
	...
	{
		NFLogError(NF_LOG_SYSTEMLOG, 0, "Invalid TotalNum:{}", table.operatetask_list_size());
		return -2;
	}
	...
	NFLogTrace(NF_LOG_SYSTEMLOG, 0, "load {}, num={}", iRet, table.operatetask_list_size());
...
const proto_ff_s::operatetask_s * OperateTaskDesc::GetDesc(int id) const
{
