...
public:
	...
	int CreateInit();
	int ResumeInit();
	const proto_ff_s::E_ConstantConstant_s* GetDesc(int id) const;
	proto_ff_s::E_ConstantConstant_s* GetDesc(int id);
public:
IMPL_RES_HASH_DESC(proto_ff_s::E_ConstantConstant_s, E_ConstantConstant, MAX_CONSTANT_CONSTANT_NUM);
