...
int MonsterMonsterDesc::Load(NFResDB *pDB)
{
	...
	{
		NFLogError(NF_LOG_COMM_LOGIC_PLUGIN, 0, "Invalid TotalNum:{}", table.monstermonster_list_size());
		return -2;
	}
	...
	NFLogTrace(NF_LOG_COMM_LOGIC_PLUGIN, 0, "load {}, num={}", iRet, table.monstermonster_list_size());
	return 0;
...
const proto_ff_s::monstermonster_s * MonsterMonsterDesc::CetDesc(int id) const
{
