...
int FestivalBigyanhuacostDesc::Load(NFResDB *pDB)
{
	...
	{
		NFLogError(NF_LOG_COMM_LOGIC_PLUGIN, 0, "Invalid TotalNum:{}", table.festivalbigyanhuacost_list_size());
		return -2;
	}
	...
	NFLogTrace(NF_LOG_COMM_LOGIC_PLUGIN, 0, "load {}, num={}", iRet, table.festivalbigyanhuacost_list_size());
	return 0;
...
const proto_ff_s::festivalbigyanhuacost_s * FestivalBigyanhuacostDesc::CetDesc(int id) const
{
