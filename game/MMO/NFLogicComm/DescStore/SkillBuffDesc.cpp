...
int SkillBuffDesc::Load(NFResDB *pDB)
{
	...
	if ((table.e_skillbuff_list_size() < 0) || (table.e_skillbuff_list_size() > (int)(m_astDesc.size())))
	{
...
const proto_ff_s::E_SkillBuff_s * SkillBuffDesc::GetDesc(int id) const
{
...
proto_ff_s::E_SkillBuff_s * SkillBuffDesc::GetDesc(int id)
{
