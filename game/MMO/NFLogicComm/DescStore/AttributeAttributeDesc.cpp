...
const proto_ff_s::E_AttributeAttribute_s * AttributeAttributeDesc::GetDesc(int id) const
{
...
proto_ff_s::E_AttributeAttribute_s * AttributeAttributeDesc::GetDesc(int id)
{
