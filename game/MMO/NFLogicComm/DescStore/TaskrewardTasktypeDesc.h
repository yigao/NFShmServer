...
public:
	...
	int CreateInit();
	int ResumeInit();
	const proto_ff_s::taskrewardtasktype_s* GetDesc(int id) const;
	proto_ff_s::taskrewardtasktype_s* GetDesc(int id);
public:
IMPL_RES_HASH_DESC(proto_ff_s::taskrewardtasktype_s, taskrewardtasktype, MAX_TASKREWARD_TASKTYPE_NUM);
