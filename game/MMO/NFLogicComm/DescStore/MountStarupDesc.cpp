...
int MountStarupDesc::Load(NFResDB *pDB)
{
	...
	{
		NFLogError(NF_LOG_SYSTEMLOG, 0, "Invalid TotalNum:{}", table.mountstarup_list_size());
		return -2;
	}
	...
	NFLogTrace(NF_LOG_SYSTEMLOG, 0, "load {}, num={}", iRet, table.mountstarup_list_size());
...
const proto_ff_s::mountstarUp_s * MountStarupDesc::GetDesc(int id) const
{
