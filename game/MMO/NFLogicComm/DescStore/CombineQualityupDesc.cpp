...
int CombineQualityupDesc::Load(NFResDB *pDB)
{
	...
	{
		NFLogError(NF_LOG_COMM_LOGIC_PLUGIN, 0, "Invalid TotalNum:{}", table.combinequalityUp_list_size());
		return -2;
	}
	...
	NFLogTrace(NF_LOG_COMM_LOGIC_PLUGIN, 0, "load {}, num={}", iRet, table.combinequalityUp_list_size());
	return 0;
...
const proto_ff_s::combinequalityUp_s * CombineQualityupDesc::CetDesc(int id) const
{
