...
int AvatarChangeDesc::Load(NFResDB *pDB)
{
	...
	m_astDesc.resize(table.e_avatarchange_list_size());
...
const proto_ff_s::E_AvatarChange_s * AvatarChangeDesc::GetDesc(int id) const
{
...
proto_ff_s::E_AvatarChange_s * AvatarChangeDesc::GetDesc(int id)
{
