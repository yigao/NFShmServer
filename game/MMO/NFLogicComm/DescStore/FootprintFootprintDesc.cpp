...
const proto_ff_s::E_FootprintFootprint_s * FootprintFootprintDesc::GetDesc(int id) const
{
...
proto_ff_s::E_FootprintFootprint_s * FootprintFootprintDesc::GetDesc(int id)
{
