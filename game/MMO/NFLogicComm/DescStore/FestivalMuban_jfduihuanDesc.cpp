...
int FestivalMuban_jfduihuanDesc::Load(NFResDB *pDB)
{
	...
	{
		NFLogError(NF_LOG_COMM_LOGIC_PLUGIN, 0, "Invalid TotalNum:{}", table.festivalmuban_JFduihuan_list_size());
		return -2;
	}
	...
	NFLogTrace(NF_LOG_COMM_LOGIC_PLUGIN, 0, "load {}, num={}", iRet, table.festivalmuban_JFduihuan_list_size());
	return 0;
...
const proto_ff_s::festivalmuban_JFduihuan_s * FestivalMuban_jfduihuanDesc::CetDesc(int id) const
{
