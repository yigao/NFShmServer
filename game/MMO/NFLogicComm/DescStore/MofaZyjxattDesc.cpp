...
int MofaZyjxattDesc::Load(NFResDB *pDB)
{
	...
	if ((table.e_mofazyjxatt_list_size() < 0) || (table.e_mofazyjxatt_list_size() > (int)(m_astDescMap.max_size())))
	{
...
const proto_ff_s::E_MofaZyjxatt_s* MofaZyjxattDesc::GetDescByAttidJxlv(int64_t Attid, int64_t Jxlv)
{
	MofaZyjxattAttidJxlv data;
	data.m_AttID = Attid;
	data.m_JxLv = Jxlv;
