...
public:
	...
	int CreateInit();
	int ResumeInit();
	const proto_ff_s::decoratedecorate_s* GetDesc(int id) const;
	proto_ff_s::decoratedecorate_s* GetDesc(int id);
public:
IMPL_RES_HASH_DESC(proto_ff_s::decoratedecorate_s, decoratedecorate, MAX_DECORATE_DECORATE_NUM);
