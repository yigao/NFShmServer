...
int GettreasureHelpDesc::Load(NFResDB *pDB)
{
	...
	{
		NFLogError(NF_LOG_SYSTEMLOG, 0, "Invalid TotalNum:{}", table.gettreasurehelp_list_size());
		return -2;
	}
	...
	NFLogTrace(NF_LOG_SYSTEMLOG, 0, "load {}, num={}", iRet, table.gettreasurehelp_list_size());
...
const proto_ff_s::getTreasurehelp_s * GettreasureHelpDesc::GetDesc(int id) const
{
