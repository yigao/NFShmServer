...
int WorldmapbossFestivalDesc::Load(NFResDB *pDB)
{
	...
	{
		NFLogError(NF_LOG_COMM_LOGIC_PLUGIN, 0, "Invalid TotalNum:{}", table.worldmapbossfestival_list_size());
		return -2;
	}
	...
	NFLogTrace(NF_LOG_COMM_LOGIC_PLUGIN, 0, "load {}, num={}", iRet, table.worldmapbossfestival_list_size());
	return 0;
...
const proto_ff_s::worldmapbossfestival_s * WorldmapbossFestivalDesc::CetDesc(int id) const
{
