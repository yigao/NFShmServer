...
const proto_ff_s::E_FacadeSoulachievement_s * FacadeSoulachievementDesc::GetDesc(int id) const
{
...
proto_ff_s::E_FacadeSoulachievement_s * FacadeSoulachievementDesc::GetDesc(int id)
{
