...
int HeadportraitFrameDesc::Load(NFResDB *pDB)
{
	...
	{
		NFLogError(NF_LOG_COMM_LOGIC_PLUGIN, 0, "Invalid TotalNum:{}", table.headPortraitframe_list_size());
		return -2;
	}
	...
	NFLogTrace(NF_LOG_COMM_LOGIC_PLUGIN, 0, "load {}, num={}", iRet, table.headPortraitframe_list_size());
	return 0;
...
const proto_ff_s::headPortraitframe_s * HeadportraitFrameDesc::CetDesc(int id) const
{
