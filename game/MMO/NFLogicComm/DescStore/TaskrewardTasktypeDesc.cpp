...
const proto_ff_s::E_TaskrewardTasktype_s * TaskrewardTasktypeDesc::GetDesc(int id) const
{
...
proto_ff_s::E_TaskrewardTasktype_s * TaskrewardTasktypeDesc::GetDesc(int id)
{
