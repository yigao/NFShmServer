...
int FestivalEggconstantDesc::Load(NFResDB *pDB)
{
	...
	{
		NFLogError(NF_LOG_COMM_LOGIC_PLUGIN, 0, "Invalid TotalNum:{}", table.festivaleggConstant_list_size());
		return -2;
	}
	...
	NFLogTrace(NF_LOG_COMM_LOGIC_PLUGIN, 0, "load {}, num={}", iRet, table.festivaleggConstant_list_size());
	return 0;
...
const proto_ff_s::festivaleggConstant_s * FestivalEggconstantDesc::CetDesc(int id) const
{
