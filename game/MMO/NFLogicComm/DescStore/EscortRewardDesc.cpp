...
int EscortRewardDesc::Load(NFResDB *pDB)
{
	...
	m_astDesc.resize(table.e_escortreward_list_size());
...
const proto_ff_s::E_EscortReward_s * EscortRewardDesc::GetDesc(int id) const
{
...
proto_ff_s::E_EscortReward_s * EscortRewardDesc::GetDesc(int id)
{
