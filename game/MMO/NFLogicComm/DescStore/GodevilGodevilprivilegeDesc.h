...
public:
	...
	int CreateInit();
	int ResumeInit();
	const proto_ff_s::E_GodevilGodevilprivilege_s* GetDesc(int id) const;
	proto_ff_s::E_GodevilGodevilprivilege_s* GetDesc(int id);
public:
IMPL_RES_HASH_DESC(proto_ff_s::E_GodevilGodevilprivilege_s, E_GodevilGodevilprivilege, MAX_GODEVIL_GODEVILPRIVILEGE_NUM);
