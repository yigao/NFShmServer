...
int GodgmGodgmDesc::Load(NFResDB *pDB)
{
	...
	{
		NFLogError(NF_LOG_COMM_LOGIC_PLUGIN, 0, "Invalid TotalNum:{}", table.godGMgodGM_list_size());
		return -2;
	}
	...
	NFLogTrace(NF_LOG_COMM_LOGIC_PLUGIN, 0, "load {}, num={}", iRet, table.godGMgodGM_list_size());
	return 0;
...
const proto_ff_s::godGMgodGM_s * GodgmGodgmDesc::CetDesc(int id) const
{
