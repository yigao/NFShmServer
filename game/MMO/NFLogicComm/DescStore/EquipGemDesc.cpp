...
int EquipGemDesc::Load(NFResDB *pDB)
{
	...
	{
		NFLogError(NF_LOG_COMM_LOGIC_PLUGIN, 0, "Invalid TotalNum:{}", table.equipgem_list_size());
		return -2;
	}
	...
	NFLogTrace(NF_LOG_COMM_LOGIC_PLUGIN, 0, "load {}, num={}", iRet, table.equipgem_list_size());
