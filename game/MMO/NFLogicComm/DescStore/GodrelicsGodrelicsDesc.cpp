...
int GodrelicsGodrelicsDesc::Load(NFResDB *pDB)
{
	...
	if ((table.e_godrelicsgodrelics_list_size() < 0) || (table.e_godrelicsgodrelics_list_size() > (int)(m_astDesc.size())))
	{
...
const proto_ff_s::E_GodrelicsGodrelics_s * GodrelicsGodrelicsDesc::GetDesc(int id) const
{
...
proto_ff_s::E_GodrelicsGodrelics_s * GodrelicsGodrelicsDesc::GetDesc(int id)
{
