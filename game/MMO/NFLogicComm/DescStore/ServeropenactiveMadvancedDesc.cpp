...
int ServeropenactiveMadvancedDesc::Load(NFResDB *pDB)
{
	...
	{
		NFLogError(NF_LOG_SYSTEMLOG, 0, "Invalid TotalNum:{}", table.serveropenactivemadvanced_list_size());
		return -2;
	}
	...
	NFLogTrace(NF_LOG_SYSTEMLOG, 0, "load {}, num={}", iRet, table.serveropenactivemadvanced_list_size());
...
const proto_ff_s::serveropenactivemAdvanced_s * ServeropenactiveMadvancedDesc::GetDesc(int id) const
{
