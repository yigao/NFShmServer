...
const proto_ff_s::E_SensitivewordSensitive_word_s * SensitivewordSensitive_wordDesc::GetDesc(int id) const
{
...
proto_ff_s::E_SensitivewordSensitive_word_s * SensitivewordSensitive_wordDesc::GetDesc(int id)
{
