...
int FieldStongDesc::Load(NFResDB *pDB)
{
	...
	{
		NFLogError(NF_LOG_SYSTEMLOG, 0, "Invalid TotalNum:{}", table.fieldstong_list_size());
		return -2;
	}
	...
	NFLogTrace(NF_LOG_SYSTEMLOG, 0, "load {}, num={}", iRet, table.fieldstong_list_size());
...
const proto_ff_s::fieldstong_s * FieldStongDesc::GetDesc(int id) const
{
