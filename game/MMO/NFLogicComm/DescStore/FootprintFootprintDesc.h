...
public:
	...
	int CreateInit();
	int ResumeInit();
	const proto_ff_s::footprintfootprint_s* GetDesc(int id) const;
	proto_ff_s::footprintfootprint_s* GetDesc(int id);
public:
IMPL_RES_HASH_DESC(proto_ff_s::footprintfootprint_s, footprintfootprint, MAX_FOOTPRINT_FOOTPRINT_NUM);
