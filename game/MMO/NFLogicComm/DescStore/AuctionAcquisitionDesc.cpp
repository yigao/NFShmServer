...
int AuctionAcquisitionDesc::Load(NFResDB *pDB)
{
	...
	{
		NFLogError(NF_LOG_COMM_LOGIC_PLUGIN, 0, "Invalid TotalNum:{}", table.auctionacquisition_list_size());
		return -2;
	}
	...
	NFLogTrace(NF_LOG_COMM_LOGIC_PLUGIN, 0, "load {}, num={}", iRet, table.auctionacquisition_list_size());
	return 0;
...
const proto_ff_s::auctionacquisition_s * AuctionAcquisitionDesc::CetDesc(int id) const
{
