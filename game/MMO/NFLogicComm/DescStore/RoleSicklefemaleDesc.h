...
public:
	...
	int CreateInit();
	int ResumeInit();
	const proto_ff_s::E_RoleSicklefemale_s* GetDesc(int id) const;
	proto_ff_s::E_RoleSicklefemale_s* GetDesc(int id);
public:
IMPL_RES_HASH_DESC(proto_ff_s::E_RoleSicklefemale_s, E_RoleSicklefemale, MAX_ROLE_SICKLEFEMALE_NUM);
