...
int EscortEscortDesc::Load(NFResDB *pDB)
{
	...
	{
		NFLogError(NF_LOG_COMM_LOGIC_PLUGIN, 0, "Invalid TotalNum:{}", table.escortescort_list_size());
		return -2;
	}
	...
	NFLogTrace(NF_LOG_COMM_LOGIC_PLUGIN, 0, "load {}, num={}", iRet, table.escortescort_list_size());
	return 0;
...
const proto_ff_s::escortescort_s * EscortEscortDesc::CetDesc(int id) const
{
