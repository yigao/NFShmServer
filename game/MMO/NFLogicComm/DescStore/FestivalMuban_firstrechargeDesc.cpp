#include "FestivalMuban_firstrechargeDesc.h"
...
int FestivalMuban_firstrechargeDesc::Load(NFResDB *pDB)
{
	...
	if ((table.e_festivalmuban_firstrecharge_list_size() < 0) || (table.e_festivalmuban_firstrecharge_list_size() > (int)(m_astDesc.max_size())))
	{
