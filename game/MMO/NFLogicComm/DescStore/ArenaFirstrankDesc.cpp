...
int ArenaFirstrankDesc::Load(NFResDB *pDB)
{
	...
	{
		NFLogError(NF_LOG_COMM_LOGIC_PLUGIN, 0, "Invalid TotalNum:{}", table.arenafirstrank_list_size());
		return -2;
	}
	...
	NFLogTrace(NF_LOG_COMM_LOGIC_PLUGIN, 0, "load {}, num={}", iRet, table.arenafirstrank_list_size());
	return 0;
...
const proto_ff_s::arenafirstrank_s * ArenaFirstrankDesc::CetDesc(int id) const
{
