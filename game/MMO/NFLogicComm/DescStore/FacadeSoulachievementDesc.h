...
public:
	...
	int CreateInit();
	int ResumeInit();
	const proto_ff_s::E_FacadeSoulachievement_s* GetDesc(int id) const;
	proto_ff_s::E_FacadeSoulachievement_s* GetDesc(int id);
public:
IMPL_RES_HASH_DESC(proto_ff_s::E_FacadeSoulachievement_s, facadesoulAchievement, MAX_FACADE_SOULACHIEVEMENT_NUM);
