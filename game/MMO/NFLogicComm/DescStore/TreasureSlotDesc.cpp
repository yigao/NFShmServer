...
int TreasureSlotDesc::Load(NFResDB *pDB)
{
	...
	{
		NFLogError(NF_LOG_COMM_LOGIC_PLUGIN, 0, "Invalid TotalNum:{}", table.treasureslot_list_size());
		return -2;
	}
	...
	NFLogTrace(NF_LOG_COMM_LOGIC_PLUGIN, 0, "load {}, num={}", iRet, table.treasureslot_list_size());
	return 0;
...
const proto_ff_s::treasureslot_s * TreasureSlotDesc::CetDesc(int id) const
{
