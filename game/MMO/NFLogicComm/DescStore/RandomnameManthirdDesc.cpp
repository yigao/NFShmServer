...
int RandomnameManthirdDesc::Load(NFResDB *pDB)
{
	...
	{
		NFLogError(NF_LOG_COMM_LOGIC_PLUGIN, 0, "Invalid TotalNum:{}", table.randomnamemanthird_list_size());
		return -2;
	}
	...
	NFLogTrace(NF_LOG_COMM_LOGIC_PLUGIN, 0, "load {}, num={}", iRet, table.randomnamemanthird_list_size());
	return 0;
...
const proto_ff_s::randomnamemanthird_s * RandomnameManthirdDesc::CetDesc(int id) const
{
