...
const proto_ff_s::E_GmcommandGmcommand_s * GmcommandGmcommandDesc::GetDesc(int id) const
{
...
proto_ff_s::E_GmcommandGmcommand_s * GmcommandGmcommandDesc::GetDesc(int id)
{
