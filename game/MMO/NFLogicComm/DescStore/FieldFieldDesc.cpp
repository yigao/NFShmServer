...
int FieldFieldDesc::Load(NFResDB *pDB)
{
	...
	{
		NFLogError(NF_LOG_COMM_LOGIC_PLUGIN, 0, "Invalid TotalNum:{}", table.fieldfield_list_size());
		return -2;
	}
	...
	NFLogTrace(NF_LOG_COMM_LOGIC_PLUGIN, 0, "load {}, num={}", iRet, table.fieldfield_list_size());
	return 0;
...
const proto_ff_s::fieldfield_s * FieldFieldDesc::CetDesc(int id) const
{
