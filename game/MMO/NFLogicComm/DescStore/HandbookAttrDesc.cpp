...
int HandbookAttrDesc::Load(NFResDB *pDB)
{
	...
	{
		NFLogError(NF_LOG_COMM_LOGIC_PLUGIN, 0, "Invalid TotalNum:{}", table.handbookattr_list_size());
		return -2;
	}
	...
	NFLogTrace(NF_LOG_COMM_LOGIC_PLUGIN, 0, "load {}, num={}", iRet, table.handbookattr_list_size());
	return 0;
...
const proto_ff_s::handbookattr_s * HandbookAttrDesc::CetDesc(int id) const
{
