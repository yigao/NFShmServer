...
int GmtoolsGiftDesc::Load(NFResDB *pDB)
{
	...
	{
		NFLogError(NF_LOG_COMM_LOGIC_PLUGIN, 0, "Invalid TotalNum:{}", table.GMtoolsgift_list_size());
		return -2;
	}
	...
	NFLogTrace(NF_LOG_COMM_LOGIC_PLUGIN, 0, "load {}, num={}", iRet, table.GMtoolsgift_list_size());
	return 0;
...
const proto_ff_s::GMtoolsgift_s * GmtoolsGiftDesc::CetDesc(int id) const
{
