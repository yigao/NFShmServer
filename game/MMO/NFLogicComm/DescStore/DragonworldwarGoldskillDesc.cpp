...
int DragonworldwarGoldskillDesc::Load(NFResDB *pDB)
{
	...
	{
		NFLogError(NF_LOG_SYSTEMLOG, 0, "Invalid TotalNum:{}", table.dragonworldwargoldskill_list_size());
		return -2;
	}
	...
	NFLogTrace(NF_LOG_SYSTEMLOG, 0, "load {}, num={}", iRet, table.dragonworldwargoldskill_list_size());
...
const proto_ff_s::dragonWorldWargoldskill_s * DragonworldwarGoldskillDesc::GetDesc(int id) const
{
