...
int DuplicateGuildbossDesc::Load(NFResDB *pDB)
{
	...
	{
		NFLogError(NF_LOG_SYSTEMLOG, 0, "Invalid TotalNum:{}", table.duplicateguildboss_list_size());
		return -2;
	}
	...
	NFLogTrace(NF_LOG_SYSTEMLOG, 0, "load {}, num={}", iRet, table.duplicateguildboss_list_size());
...
const proto_ff_s::duplicateGuildboss_s * DuplicateGuildbossDesc::GetDesc(int id) const
{
