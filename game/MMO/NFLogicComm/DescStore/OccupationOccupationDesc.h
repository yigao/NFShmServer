...
public:
	...
	int CreateInit();
	int ResumeInit();
	const proto_ff_s::E_OccupationOccupation_s* GetDesc(int id) const;
	proto_ff_s::E_OccupationOccupation_s* GetDesc(int id);
public:
IMPL_RES_HASH_DESC(proto_ff_s::E_OccupationOccupation_s, E_OccupationOccupation, MAX_OCCUPATION_OCCUPATION_NUM);
