...
const proto_ff_s::E_RandomnameMansecond_s * RandomnameMansecondDesc::GetDesc(int id) const
{
...
proto_ff_s::E_RandomnameMansecond_s * RandomnameMansecondDesc::GetDesc(int id)
{
