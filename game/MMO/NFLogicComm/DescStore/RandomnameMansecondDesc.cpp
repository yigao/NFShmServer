...
int RandomnameMansecondDesc::Load(NFResDB *pDB)
{
	...
	{
		NFLogError(NF_LOG_COMM_LOGIC_PLUGIN, 0, "Invalid TotalNum:{}", table.randomnamemansecond_list_size());
		return -2;
	}
	...
	NFLogTrace(NF_LOG_COMM_LOGIC_PLUGIN, 0, "load {}, num={}", iRet, table.randomnamemansecond_list_size());
	return 0;
...
const proto_ff_s::randomnamemansecond_s * RandomnameMansecondDesc::CetDesc(int id) const
{
