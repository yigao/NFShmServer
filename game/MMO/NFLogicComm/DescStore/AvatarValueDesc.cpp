...
IMPLEMENT_IDCREATE_WITHTYPE(AvatarValueDesc, EOT_CONST_AVATAR_VALUE_DESC_ID, NFShmObj)
...
int AvatarValueDesc::Load(NFResDB *pDB)
{
	...
	m_astDesc.resize(table.e_avatarvalue_list_size());
...
const proto_ff_s::E_AvatarValue_s * AvatarValueDesc::GetDesc(int id) const
{
...
proto_ff_s::E_AvatarValue_s * AvatarValueDesc::GetDesc(int id)
{
