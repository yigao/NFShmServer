...
int IntimacyGiftDesc::Load(NFResDB *pDB)
{
	...
	{
		NFLogError(NF_LOG_COMM_LOGIC_PLUGIN, 0, "Invalid TotalNum:{}", table.intimacygift_list_size());
		return -2;
	}
	...
	NFLogTrace(NF_LOG_COMM_LOGIC_PLUGIN, 0, "load {}, num={}", iRet, table.intimacygift_list_size());
	return 0;
...
const proto_ff_s::intimacygift_s * IntimacyGiftDesc::CetDesc(int id) const
{
