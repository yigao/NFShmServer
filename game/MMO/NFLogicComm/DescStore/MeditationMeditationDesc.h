...
public:
	...
	int CreateInit();
	int ResumeInit();
	const proto_ff_s::meditationmeditation_s* GetDesc(int id) const;
	proto_ff_s::meditationmeditation_s* GetDesc(int id);
public:
IMPL_RES_HASH_DESC(proto_ff_s::meditationmeditation_s, meditationmeditation, MAX_MEDITATION_MEDITATION_NUM);
