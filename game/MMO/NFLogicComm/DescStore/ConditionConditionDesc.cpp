...
const proto_ff_s::E_ConditionCondition_s * ConditionConditionDesc::GetDesc(int id) const
{
...
proto_ff_s::E_ConditionCondition_s * ConditionConditionDesc::GetDesc(int id)
{
