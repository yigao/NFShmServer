...
int WarlandConstantDesc::Load(NFResDB *pDB)
{
	...
	{
		NFLogError(NF_LOG_COMM_LOGIC_PLUGIN, 0, "Invalid TotalNum:{}", table.warlandconstant_list_size());
		return -2;
	}
	...
	NFLogTrace(NF_LOG_COMM_LOGIC_PLUGIN, 0, "load {}, num={}", iRet, table.warlandconstant_list_size());
	return 0;
...
const proto_ff_s::warlandconstant_s * WarlandConstantDesc::CetDesc(int id) const
{
