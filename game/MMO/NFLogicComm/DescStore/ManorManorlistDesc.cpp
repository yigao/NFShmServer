...
int ManorManorlistDesc::Load(NFResDB *pDB)
{
	...
	{
		NFLogError(NF_LOG_SYSTEMLOG, 0, "Invalid TotalNum:{}", table.manormanorlist_list_size());
		return -2;
	}
	...
	NFLogTrace(NF_LOG_SYSTEMLOG, 0, "load {}, num={}", iRet, table.manormanorlist_list_size());
...
const proto_ff_s::manormanorlist_s * ManorManorlistDesc::GetDesc(int id) const
{
