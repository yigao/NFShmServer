...
public:
	...
	int CreateInit();
	int ResumeInit();
	const proto_ff_s::rolemasterFemale_s* GetDesc(int id) const;
	proto_ff_s::rolemasterFemale_s* GetDesc(int id);
public:
IMPL_RES_HASH_DESC(proto_ff_s::rolemasterFemale_s, rolemasterFemale, MAX_ROLE_MASTERFEMALE_NUM);
