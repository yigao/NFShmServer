...
int TreasureChangeDesc::Load(NFResDB *pDB)
{
	...
	{
		NFLogError(NF_LOG_SYSTEMLOG, 0, "Invalid TotalNum:{}", table.treasurechange_list_size());
		return -2;
	}
	...
	NFLogTrace(NF_LOG_SYSTEMLOG, 0, "load {}, num={}", iRet, table.treasurechange_list_size());
...
const proto_ff_s::treasurechange_s * TreasureChangeDesc::GetDesc(int id) const
{
