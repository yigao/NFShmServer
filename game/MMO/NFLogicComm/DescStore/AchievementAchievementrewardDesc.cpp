...
int AchievementAchievementrewardDesc::Load(NFResDB *pDB)
{
	...
	{
		NFLogError(NF_LOG_COMM_LOGIC_PLUGIN, 0, "Invalid TotalNum:{}", table.achievementachievementreward_list_size());
		return -2;
	}
	...
	NFLogTrace(NF_LOG_COMM_LOGIC_PLUGIN, 0, "load {}, num={}", iRet, table.achievementachievementreward_list_size());
	return 0;
...
const proto_ff_s::achievementachievementreward_s * AchievementAchievementrewardDesc::CetDesc(int id) const
{
