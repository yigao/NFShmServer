...
int ActivityWorldtreasuremonsterDesc::Load(NFResDB *pDB)
{
	...
	{
		NFLogError(NF_LOG_SYSTEMLOG, 0, "Invalid TotalNum:{}", table.activityworldtreasuremonster_list_size());
		return -2;
	}
	...
	NFLogTrace(NF_LOG_SYSTEMLOG, 0, "load {}, num={}", iRet, table.activityworldtreasuremonster_list_size());
...
const proto_ff_s::activityworldTreasureMonster_s * ActivityWorldtreasuremonsterDesc::GetDesc(int id) const
{
