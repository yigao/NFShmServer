...
int GuildWarconstantDesc::Load(NFResDB *pDB)
{
	...
	{
		NFLogError(NF_LOG_COMM_LOGIC_PLUGIN, 0, "Invalid TotalNum:{}", table.guildwarconstant_list_size());
		return -2;
	}
	...
	NFLogTrace(NF_LOG_COMM_LOGIC_PLUGIN, 0, "load {}, num={}", iRet, table.guildwarconstant_list_size());
	return 0;
...
const proto_ff_s::guildwarconstant_s * GuildWarconstantDesc::CetDesc(int id) const
{
