...
int FunctionunlockPreviewDesc::Load(NFResDB *pDB)
{
	...
	for (int i = 0; i < (int)table.functionunlockpreview_list_size(); i++)
	{
		const proto_ff::functionunlockpreview& desc = table.functionunlockpreview_list(i);
	...
	NFLogTrace(NF_LOG_SYSTEMLOG, 0, "load {}, num={}", iRet, table.functionunlockpreview_list_size());
...
const proto_ff_s::functionunlockpreview_s * FunctionunlockPreviewDesc::GetDesc(int id) const
{
...
proto_ff_s::functionunlockpreview_s * FunctionunlockPreviewDesc::GetDesc(int id)
{
	return const_cast<proto_ff_s::functionunlockpreview_s *>((static_cast<const FunctionunlockPreviewDesc*>(this))->GetDesc(id));
}
