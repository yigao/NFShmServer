...
const proto_ff_s::E_GodevilPreposetask_s * GodevilPreposetaskDesc::GetDesc(int id) const
{
...
proto_ff_s::E_GodevilPreposetask_s * GodevilPreposetaskDesc::GetDesc(int id)
{
