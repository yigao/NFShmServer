...
int GuildGuildanceDesc::Load(NFResDB *pDB)
{
	...
	{
		NFLogError(NF_LOG_COMM_LOGIC_PLUGIN, 0, "Invalid TotalNum:{}", table.guildguildance_list_size());
		return -2;
	}
	...
	NFLogTrace(NF_LOG_COMM_LOGIC_PLUGIN, 0, "load {}, num={}", iRet, table.guildguildance_list_size());
	return 0;
...
const proto_ff_s::guildguildance_s * GuildGuildanceDesc::CetDesc(int id) const
{
