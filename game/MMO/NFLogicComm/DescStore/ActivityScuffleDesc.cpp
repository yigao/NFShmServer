...
int ActivityScuffleDesc::Load(NFResDB *pDB)
{
	...
	{
		NFLogError(NF_LOG_COMM_LOGIC_PLUGIN, 0, "Invalid TotalNum:{}", table.activityscuffle_list_size());
		return -2;
	}
	...
	NFLogTrace(NF_LOG_COMM_LOGIC_PLUGIN, 0, "load {}, num={}", iRet, table.activityscuffle_list_size());
	return 0;
...
const proto_ff_s::activityscuffle_s * ActivityScuffleDesc::CetDesc(int id) const
{
