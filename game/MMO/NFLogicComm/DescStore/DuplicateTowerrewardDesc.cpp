...
int DuplicateTowerrewardDesc::Load(NFResDB *pDB)
{
	...
	{
		NFLogError(NF_LOG_COMM_LOGIC_PLUGIN, 0, "Invalid TotalNum:{}", table.duplicatetowerReward_list_size());
		return -2;
	}
	...
	NFLogTrace(NF_LOG_COMM_LOGIC_PLUGIN, 0, "load {}, num={}", iRet, table.duplicatetowerReward_list_size());
	return 0;
...
const proto_ff_s::duplicatetowerReward_s * DuplicateTowerrewardDesc::CetDesc(int id) const
{
