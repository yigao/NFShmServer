...
#define DEFINE_SHEET_FESTIVALTEMPLATE_E_FESTIVALTEMPLATE_LIST_MAX_NUM 256
#define DEFINE_SHEET_FESTIVALMUBAN_CONSUMERANK_E_FESTIVALMUBAN_CONSUMERANK_LIST_MAX_NUM 128
...
namespace proto_ff_s {
	...
	struct E_FestivalMuban_consumerank_s : public NFDescStoreSeqOP {
		E_FestivalMuban_consumerank_s();
		virtual ~E_FestivalMuban_consumerank_s(){}
		int CreateInit();
		int ResumeInit();
		int32_t m_id;//id
		int32_t m_period;//期数
		...
		virtual void write_to_pbmsg(::proto_ff::E_FestivalMuban_consumerank & msg) const;
		virtual void read_from_pbmsg(const ::proto_ff::E_FestivalMuban_consumerank & msg);
		static ::proto_ff::E_FestivalMuban_consumerank* new_pbmsg(){ return new ::proto_ff::E_FestivalMuban_consumerank(); }
		static ::proto_ff::E_FestivalMuban_consumerank make_pbmsg(){ return ::proto_ff::E_FestivalMuban_consumerank(); }
	};
	typedef struct E_FestivalMuban_consumerank_s E_FestivalMuban_consumerank_t;

	struct Sheet_FestivalMuban_consumerank_s : public NFDescStoreSeqOP {
		Sheet_FestivalMuban_consumerank_s();
		virtual ~Sheet_FestivalMuban_consumerank_s(){}
		int CreateInit();
		int ResumeInit();
		NFShmVector<struct E_FestivalMuban_consumerank_s, DEFINE_SHEET_FESTIVALMUBAN_CONSUMERANK_E_FESTIVALMUBAN_CONSUMERANK_LIST_MAX_NUM> E_FestivalMuban_consumerank_List;//

		virtual void write_to_pbmsg(::proto_ff::Sheet_FestivalMuban_consumerank & msg) const;
		virtual void read_from_pbmsg(const ::proto_ff::Sheet_FestivalMuban_consumerank & msg);
		static ::proto_ff::Sheet_FestivalMuban_consumerank* new_pbmsg(){ return new ::proto_ff::Sheet_FestivalMuban_consumerank(); }
		static ::proto_ff::Sheet_FestivalMuban_consumerank make_pbmsg(){ return ::proto_ff::Sheet_FestivalMuban_consumerank(); }
	};
	typedef struct Sheet_FestivalMuban_consumerank_s Sheet_FestivalMuban_consumerank_t;
