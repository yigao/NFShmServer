...
class E_FestivalMuban_consumerank;
class Sheet_FestivalMuban_consumerank;
...
class E_FestivalMuban_consumerank : public ::google::protobuf::Message {
 public:
  E_FestivalMuban_consumerank();
  virtual ~E_FestivalMuban_consumerank();

  E_FestivalMuban_consumerank(const E_FestivalMuban_consumerank& from);

  inline E_FestivalMuban_consumerank& operator=(const E_FestivalMuban_consumerank& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const E_FestivalMuban_consumerank& default_instance();

  void Swap(E_FestivalMuban_consumerank* other);

  // implements Message ----------------------------------------------

  E_FestivalMuban_consumerank* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const E_FestivalMuban_consumerank& from);
  void MergeFrom(const E_FestivalMuban_consumerank& from);
  void Clear();
  bool IsInitialized() const;
 ...
 private:
  ...
  void InitAsDefaultInstance();
  static E_FestivalMuban_consumerank* default_instance_;
};
// -------------------------------------------------------------------

class Sheet_FestivalMuban_consumerank : public ::google::protobuf::Message {
 public:
  Sheet_FestivalMuban_consumerank();
  virtual ~Sheet_FestivalMuban_consumerank();

  Sheet_FestivalMuban_consumerank(const Sheet_FestivalMuban_consumerank& from);

  inline Sheet_FestivalMuban_consumerank& operator=(const Sheet_FestivalMuban_consumerank& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const Sheet_FestivalMuban_consumerank& default_instance();

  void Swap(Sheet_FestivalMuban_consumerank* other);

  // implements Message ----------------------------------------------

  Sheet_FestivalMuban_consumerank* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const Sheet_FestivalMuban_consumerank& from);
  void MergeFrom(const Sheet_FestivalMuban_consumerank& from);
  void Clear();
  bool IsInitialized() const;
  ...
  // repeated .proto_ff.E_FestivalMuban_consumerank E_FestivalMuban_consumerank_List = 1;
  inline int e_festivalmuban_consumerank_list_size() const;
  inline void clear_e_festivalmuban_consumerank_list();
  static const int kEFestivalMubanConsumerankListFieldNumber = 1;
  inline const ::proto_ff::E_FestivalMuban_consumerank& e_festivalmuban_consumerank_list(int index) const;
  inline ::proto_ff::E_FestivalMuban_consumerank* mutable_e_festivalmuban_consumerank_list(int index);
  inline ::proto_ff::E_FestivalMuban_consumerank* add_e_festivalmuban_consumerank_list();
  inline const ::google::protobuf::RepeatedPtrField< ::proto_ff::E_FestivalMuban_consumerank >&
      e_festivalmuban_consumerank_list() const;
  inline ::google::protobuf::RepeatedPtrField< ::proto_ff::E_FestivalMuban_consumerank >*
      mutable_e_festivalmuban_consumerank_list();

  // @@protoc_insertion_point(class_scope:proto_ff.Sheet_FestivalMuban_consumerank)
 private:

  ::google::protobuf::UnknownFieldSet _unknown_fields_;

  ::google::protobuf::RepeatedPtrField< ::proto_ff::E_FestivalMuban_consumerank > e_festivalmuban_consumerank_list_;
  ...
  void InitAsDefaultInstance();
  static Sheet_FestivalMuban_consumerank* default_instance_;
};
// -------------------------------------------------------------------
...
// optional int32 m_id = 1;
inline bool E_FestivalMuban_consumerank::has_m_id() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void E_FestivalMuban_consumerank::set_has_m_id() {
  _has_bits_[0] |= 0x00000001u;
}
inline void E_FestivalMuban_consumerank::clear_has_m_id() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void E_FestivalMuban_consumerank::clear_m_id() {
  m_id_ = 0;
  clear_has_m_id();
}
inline ::google::protobuf::int32 E_FestivalMuban_consumerank::m_id() const {
  return m_id_;
}
inline void E_FestivalMuban_consumerank::set_m_id(::google::protobuf::int32 value) {
  set_has_m_id();
  m_id_ = value;
}

// optional int32 m_period = 2;
inline bool E_FestivalMuban_consumerank::has_m_period() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void E_FestivalMuban_consumerank::set_has_m_period() {
  _has_bits_[0] |= 0x00000002u;
}
inline void E_FestivalMuban_consumerank::clear_has_m_period() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void E_FestivalMuban_consumerank::clear_m_period() {
  m_period_ = 0;
  clear_has_m_period();
}
inline ::google::protobuf::int32 E_FestivalMuban_consumerank::m_period() const {
  return m_period_;
}
inline void E_FestivalMuban_consumerank::set_m_period(::google::protobuf::int32 value) {
  set_has_m_period();
  m_period_ = value;
}

// optional int32 m_dataGroupID = 3;
inline bool E_FestivalMuban_consumerank::has_m_datagroupid() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
inline void E_FestivalMuban_consumerank::set_has_m_datagroupid() {
  _has_bits_[0] |= 0x00000004u;
}
inline void E_FestivalMuban_consumerank::clear_has_m_datagroupid() {
  _has_bits_[0] &= ~0x00000004u;
}
inline void E_FestivalMuban_consumerank::clear_m_datagroupid() {
  m_datagroupid_ = 0;
  clear_has_m_datagroupid();
}
inline ::google::protobuf::int32 E_FestivalMuban_consumerank::m_datagroupid() const {
  return m_datagroupid_;
}
inline void E_FestivalMuban_consumerank::set_m_datagroupid(::google::protobuf::int32 value) {
  set_has_m_datagroupid();
  m_datagroupid_ = value;
}

// optional int32 m_rankType = 4;
inline bool E_FestivalMuban_consumerank::has_m_ranktype() const {
  return (_has_bits_[0] & 0x00000008u) != 0;
}
inline void E_FestivalMuban_consumerank::set_has_m_ranktype() {
  _has_bits_[0] |= 0x00000008u;
}
inline void E_FestivalMuban_consumerank::clear_has_m_ranktype() {
  _has_bits_[0] &= ~0x00000008u;
}
inline void E_FestivalMuban_consumerank::clear_m_ranktype() {
  m_ranktype_ = 0;
  clear_has_m_ranktype();
}
inline ::google::protobuf::int32 E_FestivalMuban_consumerank::m_ranktype() const {
  return m_ranktype_;
}
inline void E_FestivalMuban_consumerank::set_m_ranktype(::google::protobuf::int32 value) {
  set_has_m_ranktype();
  m_ranktype_ = value;
}

// optional int32 m_redPointBox = 5;
inline bool E_FestivalMuban_consumerank::has_m_redpointbox() const {
  return (_has_bits_[0] & 0x00000010u) != 0;
}
inline void E_FestivalMuban_consumerank::set_has_m_redpointbox() {
  _has_bits_[0] |= 0x00000010u;
}
inline void E_FestivalMuban_consumerank::clear_has_m_redpointbox() {
  _has_bits_[0] &= ~0x00000010u;
}
inline void E_FestivalMuban_consumerank::clear_m_redpointbox() {
  m_redpointbox_ = 0;
  clear_has_m_redpointbox();
}
inline ::google::protobuf::int32 E_FestivalMuban_consumerank::m_redpointbox() const {
  return m_redpointbox_;
}
inline void E_FestivalMuban_consumerank::set_m_redpointbox(::google::protobuf::int32 value) {
...
// repeated .proto_ff.E_FestivalMuban_consumerank E_FestivalMuban_consumerank_List = 1;
inline int Sheet_FestivalMuban_consumerank::e_festivalmuban_consumerank_list_size() const {
  return e_festivalmuban_consumerank_list_.size();
}
inline void Sheet_FestivalMuban_consumerank::clear_e_festivalmuban_consumerank_list() {
  e_festivalmuban_consumerank_list_.Clear();
}
inline const ::proto_ff::E_FestivalMuban_consumerank& Sheet_FestivalMuban_consumerank::e_festivalmuban_consumerank_list(int index) const {
  return e_festivalmuban_consumerank_list_.Get(index);
}
inline ::proto_ff::E_FestivalMuban_consumerank* Sheet_FestivalMuban_consumerank::mutable_e_festivalmuban_consumerank_list(int index) {
  return e_festivalmuban_consumerank_list_.Mutable(index);
}
inline ::proto_ff::E_FestivalMuban_consumerank* Sheet_FestivalMuban_consumerank::add_e_festivalmuban_consumerank_list() {
  return e_festivalmuban_consumerank_list_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::proto_ff::E_FestivalMuban_consumerank >&
Sheet_FestivalMuban_consumerank::e_festivalmuban_consumerank_list() const {
  return e_festivalmuban_consumerank_list_;
}
inline ::google::protobuf::RepeatedPtrField< ::proto_ff::E_FestivalMuban_consumerank >*
Sheet_FestivalMuban_consumerank::mutable_e_festivalmuban_consumerank_list() {
  return &e_festivalmuban_consumerank_list_;
}
