...
void protobuf_AssignDesc_E_5fFunctionunlock_2eproto() {
  protobuf_AddDesc_E_5fFunctionunlock_2eproto();
  const ::google::protobuf::FileDescriptor* file =
    ::google::protobuf::DescriptorPool::generated_pool()->FindFileByName(
      "E_Functionunlock.proto");
  GOOGLE_CHECK(file != NULL);
  E_FunctionunlockFunctionunlock_descriptor_ = file->message_type(0);
  static const int E_FunctionunlockFunctionunlock_offsets_[8] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(E_FunctionunlockFunctionunlock, m_defaultclosed_),
...
inline void protobuf_AssignDescriptorsOnce() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AssignDescriptors_once_,
                 &protobuf_AssignDesc_E_5fFunctionunlock_2eproto);
}
...
void protobuf_AddDesc_E_5fFunctionunlock_2eproto() {
  ...
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "E_Functionunlock.proto", &protobuf_RegisterTypes);
  ...
  ::google::protobuf::internal::OnShutdown(&protobuf_ShutdownFile_E_5fFunctionunlock_2eproto);
}

// Force AddDescriptors() to be called at static initialization time.
struct StaticDescriptorInitializer_E_5fFunctionunlock_2eproto {
  StaticDescriptorInitializer_E_5fFunctionunlock_2eproto() {
    protobuf_AddDesc_E_5fFunctionunlock_2eproto();
  }
} static_descriptor_initializer_E_5fFunctionunlock_2eproto_;
...
const E_FunctionunlockFunctionunlock& E_FunctionunlockFunctionunlock::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_E_5fFunctionunlock_2eproto();
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 7: {
        ...
        if (input->ExpectTag(64)) goto parse_m_belong;
        break;
      }
...
void E_FunctionunlockFunctionunlock::SerializeWithCachedSizes(
  ...
  // optional int32 m_belong = 8;
  if (has_m_belong()) {
    ::google::protobuf::internal::WireFormatLite::WriteInt32(8, this->m_belong(), output);
  }
...
::google::protobuf::uint8* E_FunctionunlockFunctionunlock::SerializeWithCachedSizesToArray(
  ...
  // optional int32 m_belong = 8;
  if (has_m_belong()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteInt32ToArray(8, this->m_belong(), target);
  }
...
void E_FunctionunlockFunctionunlock::MergeFrom(const E_FunctionunlockFunctionunlock& from) {
  ...
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    ...
    if (from.has_m_defaultclosed()) {
      set_m_defaultclosed(from.m_defaultclosed());
    }
...
void E_FunctionunlockFunctionunlock::Swap(E_FunctionunlockFunctionunlock* other) {
  if (other != this) {
    ...
    std::swap(m_defaultclosed_, other->m_defaultclosed_);
