...
#ifndef PROTOBUF_E_5fItem_2eproto__INCLUDED
#define PROTOBUF_E_5fItem_2eproto__INCLUDED
...
class E_ItemItem : public ::google::protobuf::Message {
 ...
 private:
  ...
  friend void  protobuf_AddDesc_E_5fItem_2eproto();
  friend void protobuf_AssignDesc_E_5fItem_2eproto();
  friend void protobuf_ShutdownFile_E_5fItem_2eproto();
...
inline ::google::protobuf::int32 E_ItemItem::m_id() const {
  return m_id_;
}
inline void E_ItemItem::set_m_id(::google::protobuf::int32 value) {
  set_has_m_id();
  m_id_ = value;
}
...
#endif  // PROTOBUF_E_5fItem_2eproto__INCLUDED
