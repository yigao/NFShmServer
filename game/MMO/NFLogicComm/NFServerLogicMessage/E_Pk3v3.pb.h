...
class E_Pk3v3Constant : public ::google::protobuf::Message {
 public:
  ...
  inline bool has_m_entrylosereward() const;
  inline void clear_m_entrylosereward();
  static const int kMEntryLoseRewardFieldNumber = 8;
  inline ::google::protobuf::int32 m_entrylosereward() const;
  inline void set_m_entrylosereward(::google::protobuf::int32 value);

  // optional int32 m_entrTimes = 9;
  inline bool has_m_entrtimes() const;
  inline void clear_m_entrtimes();
  static const int kMEntrTimesFieldNumber = 9;
  ...
  static const int kMMvpRewardFieldNumber = 10;
  ...
  static const int kMMvpTimesFieldNumber = 11;
  ...
  static const int kMMatchTimeFieldNumber = 12;
  ...
  static const int kMUnitNameFieldNumber = 13;
  ...
  static const int kMUnitCostFieldNumber = 14;
  ...
  static const int kMInitialZLidFieldNumber = 15;
  ...
  static const int kMInitialZLNameFieldNumber = 16;
  ...
  static const int kMShowRewardFieldNumber = 21;
 ...
 private:
  ...
  inline void set_has_m_entrylosereward();
  inline void clear_has_m_entrylosereward();
  ...
  ::google::protobuf::int32 m_entrylosereward_;
...
// optional int32 m_entryLoseReward = 8;
inline bool E_Pk3v3Constant::has_m_entrylosereward() const {
  return (_has_bits_[0] & 0x00000080u) != 0;
}
inline void E_Pk3v3Constant::set_has_m_entrylosereward() {
  _has_bits_[0] |= 0x00000080u;
}
inline void E_Pk3v3Constant::clear_has_m_entrylosereward() {
  _has_bits_[0] &= ~0x00000080u;
}
inline void E_Pk3v3Constant::clear_m_entrylosereward() {
  m_entrylosereward_ = 0;
  clear_has_m_entrylosereward();
}
inline ::google::protobuf::int32 E_Pk3v3Constant::m_entrylosereward() const {
  return m_entrylosereward_;
}
inline void E_Pk3v3Constant::set_m_entrylosereward(::google::protobuf::int32 value) {
  set_has_m_entrylosereward();
  m_entrylosereward_ = value;
}
