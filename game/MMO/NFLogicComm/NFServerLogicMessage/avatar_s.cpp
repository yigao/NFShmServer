...
void E_AvatarFragmentAttributeDesc_s::read_from_pbmsg(const ::proto_ff::E_AvatarFragmentAttributeDesc & msg) {
	//dont't use memset, the class maybe has virtual //memset(this, 0, sizeof(struct E_AvatarFragmentAttributeDesc_s));
	m_type = msg.m_type();
	m_value = msg.m_value();
}
...
void E_AvatarFragment_s::read_from_pbmsg(const ::proto_ff::E_AvatarFragment & msg) {
	//dont't use memset, the class maybe has virtual //memset(this, 0, sizeof(struct E_AvatarFragment_s));
...
void Sheet_AvatarFragment_s::read_from_pbmsg(const ::proto_ff::Sheet_AvatarFragment & msg) {
	//dont't use memset, the class maybe has virtual //memset(this, 0, sizeof(struct Sheet_AvatarFragment_s));
...
void E_AvatarValueAttributeDesc_s::read_from_pbmsg(const ::proto_ff::E_AvatarValueAttributeDesc & msg) {
	//dont't use memset, the class maybe has virtual //memset(this, 0, sizeof(struct E_AvatarValueAttributeDesc_s));
	m_type = msg.m_type();
	m_value = msg.m_value();
}
...
void E_AvatarValue_s::read_from_pbmsg(const ::proto_ff::E_AvatarValue & msg) {
	//dont't use memset, the class maybe has virtual //memset(this, 0, sizeof(struct E_AvatarValue_s));
	m_id = msg.m_id();
	m_type = msg.m_type();
	m_lv = msg.m_lv();
	m_cost = msg.m_cost();
...
void Sheet_AvatarValue_s::read_from_pbmsg(const ::proto_ff::Sheet_AvatarValue & msg) {
	//dont't use memset, the class maybe has virtual //memset(this, 0, sizeof(struct Sheet_AvatarValue_s));
...
void E_AvatarDisplayMaterialDesc_s::read_from_pbmsg(const ::proto_ff::E_AvatarDisplayMaterialDesc & msg) {
	//dont't use memset, the class maybe has virtual //memset(this, 0, sizeof(struct E_AvatarDisplayMaterialDesc_s));
	m_id = msg.m_id();
	m_exp = msg.m_exp();
}
...
void E_AvatarDisplay_s::read_from_pbmsg(const ::proto_ff::E_AvatarDisplay & msg) {
	//dont't use memset, the class maybe has virtual //memset(this, 0, sizeof(struct E_AvatarDisplay_s));
	m_id = msg.m_id();
...
void Sheet_AvatarDisplay_s::read_from_pbmsg(const ::proto_ff::Sheet_AvatarDisplay & msg) {
	//dont't use memset, the class maybe has virtual //memset(this, 0, sizeof(struct Sheet_AvatarDisplay_s));
...
void E_AvatarChangeAttributeDesc_s::read_from_pbmsg(const ::proto_ff::E_AvatarChangeAttributeDesc & msg) {
	//dont't use memset, the class maybe has virtual //memset(this, 0, sizeof(struct E_AvatarChangeAttributeDesc_s));
...
void E_AvatarChangeMaterialDesc_s::read_from_pbmsg(const ::proto_ff::E_AvatarChangeMaterialDesc & msg) {
	//dont't use memset, the class maybe has virtual //memset(this, 0, sizeof(struct E_AvatarChangeMaterialDesc_s));
	m_id = msg.m_id();
	m_exp = msg.m_exp();
}
...
void Sheet_AvatarChange_s::read_from_pbmsg(const ::proto_ff::Sheet_AvatarChange & msg) {
	//dont't use memset, the class maybe has virtual //memset(this, 0, sizeof(struct Sheet_AvatarChange_s));
...
void E_AvatarChangetab_s::read_from_pbmsg(const ::proto_ff::E_AvatarChangetab & msg) {
	//dont't use memset, the class maybe has virtual //memset(this, 0, sizeof(struct E_AvatarChangetab_s));
	m_tabid = msg.m_tabid();
}
...
void Sheet_AvatarChangetab_s::read_from_pbmsg(const ::proto_ff::Sheet_AvatarChangetab & msg) {
	//dont't use memset, the class maybe has virtual //memset(this, 0, sizeof(struct Sheet_AvatarChangetab_s));
...
void E_AvatarBattleslot_s::write_to_pbmsg(::proto_ff::E_AvatarBattleslot & msg) const {
	msg.set_m_id((int32_t)m_id);
	msg.set_m_type((int32_t)m_type);
	msg.set_m_arg((const char*)m_arg.data());
}

void E_AvatarBattleslot_s::read_from_pbmsg(const ::proto_ff::E_AvatarBattleslot & msg) {
	//dont't use memset, the class maybe has virtual //memset(this, 0, sizeof(struct E_AvatarBattleslot_s));
	m_id = msg.m_id();
	m_type = msg.m_type();
	m_arg = msg.m_arg();
}
...
void Sheet_AvatarBattleslot_s::read_from_pbmsg(const ::proto_ff::Sheet_AvatarBattleslot & msg) {
	//dont't use memset, the class maybe has virtual //memset(this, 0, sizeof(struct Sheet_AvatarBattleslot_s));
...
void E_AvatarAdvanceUpattributeDesc_s::read_from_pbmsg(const ::proto_ff::E_AvatarAdvanceUpattributeDesc & msg) {
	//dont't use memset, the class maybe has virtual //memset(this, 0, sizeof(struct E_AvatarAdvanceUpattributeDesc_s));
	m_type = msg.m_type();
	m_value = msg.m_value();
}
...
void E_AvatarAdvance_s::read_from_pbmsg(const ::proto_ff::E_AvatarAdvance & msg) {
	//dont't use memset, the class maybe has virtual //memset(this, 0, sizeof(struct E_AvatarAdvance_s));
	m_id = msg.m_id();
...
void Sheet_AvatarAdvance_s::read_from_pbmsg(const ::proto_ff::Sheet_AvatarAdvance & msg) {
	//dont't use memset, the class maybe has virtual //memset(this, 0, sizeof(struct Sheet_AvatarAdvance_s));
...
void E_AvatarSkill_s::read_from_pbmsg(const ::proto_ff::E_AvatarSkill & msg) {
	//dont't use memset, the class maybe has virtual //memset(this, 0, sizeof(struct E_AvatarSkill_s));
	m_id = msg.m_id();
...
void Sheet_AvatarSkill_s::read_from_pbmsg(const ::proto_ff::Sheet_AvatarSkill & msg) {
	//dont't use memset, the class maybe has virtual //memset(this, 0, sizeof(struct Sheet_AvatarSkill_s));
...
void E_AvatarEquipsuitAttributeDesc_s::read_from_pbmsg(const ::proto_ff::E_AvatarEquipsuitAttributeDesc & msg) {
	//dont't use memset, the class maybe has virtual //memset(this, 0, sizeof(struct E_AvatarEquipsuitAttributeDesc_s));
	m_type = msg.m_type();
	m_value = msg.m_value();
}
...
void E_AvatarEquipsuit_s::read_from_pbmsg(const ::proto_ff::E_AvatarEquipsuit & msg) {
	//dont't use memset, the class maybe has virtual //memset(this, 0, sizeof(struct E_AvatarEquipsuit_s));
	m_id = msg.m_id();
...
void Sheet_AvatarEquipsuit_s::read_from_pbmsg(const ::proto_ff::Sheet_AvatarEquipsuit & msg) {
	//dont't use memset, the class maybe has virtual //memset(this, 0, sizeof(struct Sheet_AvatarEquipsuit_s));
