...
void E_HeadportraitHeadAttributeDesc_s::read_from_pbmsg(const ::proto_ff::E_HeadportraitHeadAttributeDesc & msg) {
	//dont't use memset, the class maybe has virtual //memset(this, 0, sizeof(struct E_HeadportraitHeadAttributeDesc_s));
	m_type = msg.m_type();
	m_value = msg.m_value();
}
...
void E_HeadportraitHeadActiveattributeDesc_s::read_from_pbmsg(const ::proto_ff::E_HeadportraitHeadActiveattributeDesc & msg) {
	//dont't use memset, the class maybe has virtual //memset(this, 0, sizeof(struct E_HeadportraitHeadActiveattributeDesc_s));
	m_type = msg.m_type();
	m_value = msg.m_value();
}
...
void E_HeadportraitHead_s::read_from_pbmsg(const ::proto_ff::E_HeadportraitHead & msg) {
	//dont't use memset, the class maybe has virtual //memset(this, 0, sizeof(struct E_HeadportraitHead_s));
	m_id = msg.m_id();
	m_name = msg.m_name();
	m_type = msg.m_type();
