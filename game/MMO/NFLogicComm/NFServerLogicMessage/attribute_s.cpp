...
void E_AttributeAttribute_s::read_from_pbmsg(const ::proto_ff::E_AttributeAttribute & msg) {
	//dont't use memset, the class maybe has virtual //memset(this, 0, sizeof(struct E_AttributeAttribute_s));
	m_id = msg.m_id();
...
void E_AttributeSuppress_s::read_from_pbmsg(const ::proto_ff::E_AttributeSuppress & msg) {
	//dont't use memset, the class maybe has virtual //memset(this, 0, sizeof(struct E_AttributeSuppress_s));
...
void E_AttributePowersup_s::read_from_pbmsg(const ::proto_ff::E_AttributePowersup & msg) {
	//dont't use memset, the class maybe has virtual //memset(this, 0, sizeof(struct E_AttributePowersup_s));
