...
#define DEFINE_SHEET_OCCUPATIONOCCUPATION_E_OCCUPATIONOCCUPATION_LIST_MAX_NUM 8
...
#define DEFINE_SHEET_OCCUPATIONATTRIBUTE_E_OCCUPATIONATTRIBUTE_LIST_MAX_NUM 32
