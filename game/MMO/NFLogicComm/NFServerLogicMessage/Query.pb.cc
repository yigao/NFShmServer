...
void protobuf_AssignDesc_Query_2eproto() {
  ...
  static const int QueryCharacterDetailInfo_offsets_[15] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(QueryCharacterDetailInfo, attr_lst_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(QueryCharacterDetailInfo, marry_name_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(QueryCharacterDetailInfo, zid_id_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(QueryCharacterDetailInfo, best_slots_),
  };
...
void protobuf_AddDesc_Query_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\013Query.proto\022\010proto_ff\032\tCom.proto\032\017ComD"
    "efine.proto\"\362\002\n\030QueryCharacterDetailInfo"
    ...
    "Name\030\006 \001(\014\022\021\n\tunionDuty\030\007 \001(\r\022)\n\006facade\030"
    "\010 \001(\0132\031.proto_ff.RoleFacadeProto\022#\n\006equi"
    "ps\030\t \003(\0132\023.proto_ff.EquipInfo\022\020\n\010vipLeve"
    "l\030\013 \001(\r\022\021\n\tpartnerId\030\014 \001(\004\022\"\n\010attr_lst\030\r"
    " \003(\0132\020.proto_ff.Attr64\022\022\n\nmarry_name\030\016 \001"
    "(\014\022\016\n\006zid_id\030\017 \001(\r\022,\n\nbest_slots\030\020 \003(\0132\030"
    ".proto_ff.BestEQSlotInfo\"R\n\016FuncFightPro"
    "to\022$\n\nfunc_fight\030\001 \003(\0132\020.proto_ff.Attr64"
    "\022\r\n\005fight\030\002 \001(\003\022\013\n\003cid\030\003 \001(\004\"&\n\024CWCharac"
    "terDetailReq\022\016\n\006charID\030\001 \001(\004\"W\n\024WCCharac"
    "terDetailRsp\022\013\n\003ret\030\001 \001(\r\0222\n\006detail\030\002 \001("
    "\0132\".proto_ff.QueryCharacterDetailInfo\"2\n"
    "\022CWCharacterMiniReq\022\016\n\006charID\030\001 \001(\004\022\014\n\004n"
    "ame\030\002 \001(\t\"V\n\022WCCharacterMiniRsp\022\013\n\003ret\030\001"
    " \001(\r\0223\n\rcharacterInfo\030\002 \001(\0132\034.proto_ff.R"
    "olePlayerMiniInfo\"*\n\025QueryCharFuncFightR"
    "eq\022\021\n\tquery_cid\030\001 \001(\004\"P\n\025QueryCharFuncFi"
    "ghtRsp\022\017\n\007retcode\030\001 \001(\005\022&\n\004info\030\002 \001(\0132\030."
    "proto_ff.FuncFightProto\";\n\033QueryLoadMirr"
    "orDataCallBack\022\r\n\005srcID\030\001 \002(\004\022\r\n\005dstID\030\002"
    " \002(\004\"4\n\024WGCharacterDetailReq\022\r\n\005srcID\030\001 "
    "\001(\004\022\r\n\005dstID\030\002 \001(\004\"h\n\024GWCharacterDetailR"
    "sp\022\r\n\005srcID\030\001 \001(\004\022\r\n\005dstID\030\002 \001(\004\0222\n\006deta"
    "il\030\003 \001(\0132\".proto_ff.QueryCharacterDetail"
    "Info\"B\n\"QueryCharacterDetailCrossServerR"
    "eq\022\r\n\005srcID\030\001 \002(\004\022\r\n\005dstID\030\002 \002(\004\"v\n\"Quer"
    "yCharacterDetailCrossServerRsp\022\r\n\005srcID\030"
    "\001 \001(\004\022\r\n\005dstID\030\002 \001(\004\0222\n\006detail\030\003 \001(\0132\".p"
    "roto_ff.QueryCharacterDetailInfo\"@\n Quer"
    "yCharacterMiniCrossServerReq\022\r\n\005srcID\030\001 "
    "\002(\004\022\r\n\005dstID\030\002 \002(\004\"p\n QueryCharacterMini"
    "CrossServerRsp\022\r\n\005srcID\030\001 \001(\004\022\r\n\005dstID\030\002"
    " \001(\004\022.\n\010miniInfo\030\003 \001(\0132\034.proto_ff.RolePl"
    "ayerMiniInfo\":\n\032QueryCharFuncFightCrossR"
    "eq\022\r\n\005srcID\030\001 \002(\004\022\r\n\005dstID\030\002 \002(\004\"s\n\032Quer"
    "yCharFuncFightCrossRsp\022\017\n\007retcode\030\001 \001(\005\022"
    "\r\n\005srcID\030\002 \001(\004\022\r\n\005dstID\030\003 \001(\004\022&\n\004info\030\004 "
    "\001(\0132\030.proto_ff.FuncFightProto", 1669);
...
const int QueryCharacterDetailInfo::kAttrLstFieldNumber;
const int QueryCharacterDetailInfo::kMarryNameFieldNumber;
const int QueryCharacterDetailInfo::kZidIdFieldNumber;
const int QueryCharacterDetailInfo::kBestSlotsFieldNumber;
#endif  // !_MSC_VER
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 12: {
        ...
        if (input->ExpectTag(106)) goto parse_attr_lst;
        break;
      }
      ...
      case 13: {
        ...
        if (input->ExpectTag(106)) goto parse_attr_lst;
        if (input->ExpectTag(114)) goto parse_marry_name;
        break;
      }
      ...
      case 14: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
         ...
         parse_marry_name:
          DO_(::google::protobuf::internal::WireFormatLite::ReadBytes(
                input, this->mutable_marry_name()));
        } else {
          goto handle_uninterpreted;
        }
        if (input->ExpectTag(120)) goto parse_zid_id;
        break;
      }
      ...
      case 15: {
        ...
        if (input->ExpectTag(130)) goto parse_best_slots;
        break;
      }
...
void QueryCharacterDetailInfo::SerializeWithCachedSizes(
  ...
  for (int i = 0; i < this->attr_lst_size(); i++) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      13, this->attr_lst(i), output);
  }

  // optional bytes marry_name = 14;
  if (has_marry_name()) {
    ::google::protobuf::internal::WireFormatLite::WriteBytes(
      14, this->marry_name(), output);
  }

  // optional uint32 zid_id = 15;
  if (has_zid_id()) {
    ::google::protobuf::internal::WireFormatLite::WriteUInt32(15, this->zid_id(), output);
  }

  // repeated .proto_ff.BestEQSlotInfo best_slots = 16;
  for (int i = 0; i < this->best_slots_size(); i++) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      16, this->best_slots(i), output);
  }
...
::google::protobuf::uint8* QueryCharacterDetailInfo::SerializeWithCachedSizesToArray(
  ...
  if (has_marry_name()) {
    target =
      ::google::protobuf::internal::WireFormatLite::WriteBytesToArray(
        14, this->marry_name(), target);
  }

  // optional uint32 zid_id = 15;
  if (has_zid_id()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteUInt32ToArray(15, this->zid_id(), target);
  }
...
int QueryCharacterDetailInfo::ByteSize() const {
  ...
  // repeated .proto_ff.BestEQSlotInfo best_slots = 16;
  total_size += 2 * this->best_slots_size();
  for (int i = 0; i < this->best_slots_size(); i++) {
    total_size +=
      ::google::protobuf::internal::WireFormatLite::MessageSizeNoVirtual(
        this->best_slots(i));
...
void QueryCharacterDetailInfo::MergeFrom(const QueryCharacterDetailInfo& from) {
  ...
  best_slots_.MergeFrom(from.best_slots_);
  ...
  if (from._has_bits_[9 / 32] & (0xffu << (9 % 32))) {
    ...
    if (from.has_marry_name()) {
      set_marry_name(from.marry_name());
    }
    if (from.has_zid_id()) {
      set_zid_id(from.zid_id());
    }
  }
...
bool QueryCharacterDetailInfo::IsInitialized() const {
  ...
  for (int i = 0; i < best_slots_size(); i++) {
    if (!this->best_slots(i).IsInitialized()) return false;
  }
  return true;
}
...
void QueryCharacterDetailInfo::Swap(QueryCharacterDetailInfo* other) {
  if (other != this) {
    ...
    std::swap(marry_name_, other->marry_name_);
    std::swap(zid_id_, other->zid_id_);
    best_slots_.Swap(&other->best_slots_);
