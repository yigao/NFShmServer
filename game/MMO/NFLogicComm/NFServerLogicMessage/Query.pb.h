...
class QueryCharacterDetailInfo : public ::google::protobuf::Message {
 public:
  ...
  // repeated .proto_ff.EquipInfo equips = 9;
  inline int equips_size() const;
  inline void clear_equips();
  static const int kEquipsFieldNumber = 9;
  inline const ::proto_ff::EquipInfo& equips(int index) const;
  inline ::proto_ff::EquipInfo* mutable_equips(int index);
  inline ::proto_ff::EquipInfo* add_equips();
  ...
  // repeated .proto_ff.Attr64 attr_lst = 13;
  inline int attr_lst_size() const;
  inline void clear_attr_lst();
  static const int kAttrLstFieldNumber = 13;
  ...
  // optional bytes marry_name = 14;
  inline bool has_marry_name() const;
  inline void clear_marry_name();
  static const int kMarryNameFieldNumber = 14;
  inline const ::std::string& marry_name() const;
  inline void set_marry_name(const ::std::string& value);
  inline void set_marry_name(const char* value);
  inline void set_marry_name(const void* value, size_t size);
  inline ::std::string* mutable_marry_name();
  inline ::std::string* release_marry_name();
  inline void set_allocated_marry_name(::std::string* marry_name);

  // optional uint32 zid_id = 15;
  inline bool has_zid_id() const;
  inline void clear_zid_id();
  static const int kZidIdFieldNumber = 15;
  inline ::google::protobuf::uint32 zid_id() const;
  inline void set_zid_id(::google::protobuf::uint32 value);

  // repeated .proto_ff.BestEQSlotInfo best_slots = 16;
  inline int best_slots_size() const;
  inline void clear_best_slots();
  static const int kBestSlotsFieldNumber = 16;
  inline const ::proto_ff::BestEQSlotInfo& best_slots(int index) const;
  inline ::proto_ff::BestEQSlotInfo* mutable_best_slots(int index);
  inline ::proto_ff::BestEQSlotInfo* add_best_slots();
 ...
 private:
  ...
  inline void set_has_marry_name();
  inline void clear_has_marry_name();
  inline void set_has_zid_id();
  inline void clear_has_zid_id();
  ...
  ::google::protobuf::RepeatedPtrField< ::proto_ff::EquipInfo > equips_;
  ::google::protobuf::uint64 partnerid_;
  ::google::protobuf::RepeatedPtrField< ::proto_ff::Attr64 > attr_lst_;
  ::std::string* marry_name_;
  ::google::protobuf::RepeatedPtrField< ::proto_ff::BestEQSlotInfo > best_slots_;
  ::google::protobuf::uint32 zid_id_;
...
inline const ::proto_ff::EquipInfo& QueryCharacterDetailInfo::equips(int index) const {
  return equips_.Get(index);
}
inline ::proto_ff::EquipInfo* QueryCharacterDetailInfo::mutable_equips(int index) {
  return equips_.Mutable(index);
}
inline ::proto_ff::EquipInfo* QueryCharacterDetailInfo::add_equips() {
  return equips_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::proto_ff::EquipInfo >&
...
// repeated .proto_ff.Attr64 attr_lst = 13;
inline int QueryCharacterDetailInfo::attr_lst_size() const {
  return attr_lst_.size();
}
inline void QueryCharacterDetailInfo::clear_attr_lst() {
  attr_lst_.Clear();
}
inline const ::proto_ff::Attr64& QueryCharacterDetailInfo::attr_lst(int index) const {
  return attr_lst_.Get(index);
}
inline ::proto_ff::Attr64* QueryCharacterDetailInfo::mutable_attr_lst(int index) {
  return attr_lst_.Mutable(index);
}
inline ::proto_ff::Attr64* QueryCharacterDetailInfo::add_attr_lst() {
  return attr_lst_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::proto_ff::Attr64 >&
QueryCharacterDetailInfo::attr_lst() const {
  return attr_lst_;
}
inline ::google::protobuf::RepeatedPtrField< ::proto_ff::Attr64 >*
QueryCharacterDetailInfo::mutable_attr_lst() {
  return &attr_lst_;
}

// optional bytes marry_name = 14;
inline bool QueryCharacterDetailInfo::has_marry_name() const {
  return (_has_bits_[0] & 0x00001000u) != 0;
}
inline void QueryCharacterDetailInfo::set_has_marry_name() {
  _has_bits_[0] |= 0x00001000u;
}
inline void QueryCharacterDetailInfo::clear_has_marry_name() {
  _has_bits_[0] &= ~0x00001000u;
}
inline void QueryCharacterDetailInfo::clear_marry_name() {
  if (marry_name_ != &::google::protobuf::internal::kEmptyString) {
    marry_name_->clear();
  }
  clear_has_marry_name();
}
inline const ::std::string& QueryCharacterDetailInfo::marry_name() const {
  return *marry_name_;
}
inline void QueryCharacterDetailInfo::set_marry_name(const ::std::string& value) {
  set_has_marry_name();
  if (marry_name_ == &::google::protobuf::internal::kEmptyString) {
    marry_name_ = new ::std::string;
  }
  marry_name_->assign(value);
}
inline void QueryCharacterDetailInfo::set_marry_name(const char* value) {
  set_has_marry_name();
  if (marry_name_ == &::google::protobuf::internal::kEmptyString) {
    marry_name_ = new ::std::string;
  }
...
inline void QueryCharacterDetailInfo::set_marry_name(const void* value, size_t size) {
  set_has_marry_name();
  if (marry_name_ == &::google::protobuf::internal::kEmptyString) {
    marry_name_ = new ::std::string;
  }
  marry_name_->assign(reinterpret_cast<const char*>(value), size);
}
inline ::std::string* QueryCharacterDetailInfo::mutable_marry_name() {
  set_has_marry_name();
  if (marry_name_ == &::google::protobuf::internal::kEmptyString) {
    marry_name_ = new ::std::string;
  }
...
inline ::std::string* QueryCharacterDetailInfo::release_marry_name() {
  clear_has_marry_name();
  if (marry_name_ == &::google::protobuf::internal::kEmptyString) {
    return NULL;
  } else {
    ::std::string* temp = marry_name_;
    marry_name_ = const_cast< ::std::string*>(&::google::protobuf::internal::kEmptyString);
    return temp;
  }
}
inline void QueryCharacterDetailInfo::set_allocated_marry_name(::std::string* marry_name) {
  if (marry_name_ != &::google::protobuf::internal::kEmptyString) {
    delete marry_name_;
  }
  if (marry_name) {
    set_has_marry_name();
    marry_name_ = marry_name;
  } else {
    clear_has_marry_name();
    marry_name_ = const_cast< ::std::string*>(&::google::protobuf::internal::kEmptyString);
  }
...
// optional uint32 zid_id = 15;
inline bool QueryCharacterDetailInfo::has_zid_id() const {
  return (_has_bits_[0] & 0x00002000u) != 0;
}
inline void QueryCharacterDetailInfo::set_has_zid_id() {
  _has_bits_[0] |= 0x00002000u;
}
inline void QueryCharacterDetailInfo::clear_has_zid_id() {
  _has_bits_[0] &= ~0x00002000u;
}
inline void QueryCharacterDetailInfo::clear_zid_id() {
  zid_id_ = 0u;
  clear_has_zid_id();
}
inline ::google::protobuf::uint32 QueryCharacterDetailInfo::zid_id() const {
  return zid_id_;
}
inline void QueryCharacterDetailInfo::set_zid_id(::google::protobuf::uint32 value) {
  set_has_zid_id();
  zid_id_ = value;
}

// repeated .proto_ff.BestEQSlotInfo best_slots = 16;
inline int QueryCharacterDetailInfo::best_slots_size() const {
  return best_slots_.size();
}
inline void QueryCharacterDetailInfo::clear_best_slots() {
  best_slots_.Clear();
}
inline const ::proto_ff::BestEQSlotInfo& QueryCharacterDetailInfo::best_slots(int index) const {
  return best_slots_.Get(index);
}
inline ::proto_ff::BestEQSlotInfo* QueryCharacterDetailInfo::mutable_best_slots(int index) {
  return best_slots_.Mutable(index);
}
inline ::proto_ff::BestEQSlotInfo* QueryCharacterDetailInfo::add_best_slots() {
  return best_slots_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::proto_ff::BestEQSlotInfo >&
QueryCharacterDetailInfo::best_slots() const {
  return best_slots_;
}
inline ::google::protobuf::RepeatedPtrField< ::proto_ff::BestEQSlotInfo >*
QueryCharacterDetailInfo::mutable_best_slots() {
  return &best_slots_;
}
