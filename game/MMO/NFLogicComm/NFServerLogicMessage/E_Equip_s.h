...
#define DEFINE_E_EQUIPATTRIBUTE_M_BEASTSTARLIB_MAX_NUM 2
...
#define DEFINE_SHEET_EQUIPSTRONG_E_EQUIPSTRONG_LIST_MAX_NUM 512
...
namespace proto_ff_s {
	...
	struct E_EquipAttribute_s : public NFDescStoreSeqOP {
		...
		NFShmVector<NFShmString<64>, DEFINE_E_EQUIPATTRIBUTE_M_BEASTSTARLIB_MAX_NUM> m_beaststarlib;//神兽蓝星技能属性库
