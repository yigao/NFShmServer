...
void protobuf_AssignDesc_BestEQ_2eproto() {
  ...
  static const int NotifyBestEQData_offsets_[2] = {
  ...
  NotifyBestEQTask_descriptor_ = file->message_type(2);
  ...
  BestEQRecvTaskReq_descriptor_ = file->message_type(3);
  ...
  BestEQRecvTaskRsp_descriptor_ = file->message_type(4);
  ...
  BestEQDecomposeReq_descriptor_ = file->message_type(5);
  static const int BestEQDecomposeReq_offsets_[2] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(BestEQDecomposeReq, bagtype_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(BestEQDecomposeReq, pos_),
  };
  ...
  BestEQDecomposeRsp_descriptor_ = file->message_type(6);
  static const int BestEQDecomposeRsp_offsets_[3] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(BestEQDecomposeRsp, ret_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(BestEQDecomposeRsp, bagtype_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(BestEQDecomposeRsp, pos_),
  };
  ...
  BestEQReturnPreViewReq_descriptor_ = file->message_type(7);
  static const int BestEQReturnPreViewReq_offsets_[2] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(BestEQReturnPreViewReq, bagtype_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(BestEQReturnPreViewReq, pos_),
  };
  ...
  BestEQReturnPreViewRsp_descriptor_ = file->message_type(8);
  static const int BestEQReturnPreViewRsp_offsets_[3] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(BestEQReturnPreViewRsp, ret_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(BestEQReturnPreViewRsp, bagtype_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(BestEQReturnPreViewRsp, pos_),
  };
  ...
  BestEQReturnReq_descriptor_ = file->message_type(9);
  static const int BestEQReturnReq_offsets_[2] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(BestEQReturnReq, bagtype_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(BestEQReturnReq, pos_),
  };
  ...
  BestEQReturnRsp_descriptor_ = file->message_type(10);
  static const int BestEQReturnRsp_offsets_[3] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(BestEQReturnRsp, ret_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(BestEQReturnRsp, bagtype_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(BestEQReturnRsp, pos_),
  };
  ...
  BestEQDressReq_descriptor_ = file->message_type(11);
  static const int BestEQDressReq_offsets_[2] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(BestEQDressReq, bagtype_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(BestEQDressReq, pos_),
  };
  ...
  BestEQDressRsp_descriptor_ = file->message_type(12);
  static const int BestEQDressRsp_offsets_[3] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(BestEQDressRsp, ret_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(BestEQDressRsp, bagtype_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(BestEQDressRsp, pos_),
  };
  ...
  BestEQPourReq_descriptor_ = file->message_type(13);
  ...
  BestEQPourRsp_descriptor_ = file->message_type(14);
  ...
  BestEQBreakReq_descriptor_ = file->message_type(15);
  ...
  BestEQBreakRsp_descriptor_ = file->message_type(16);
  ...
  BestEQAwakenReq_descriptor_ = file->message_type(17);
  ...
  BestEQAwakenRsp_descriptor_ = file->message_type(18);
...
void protobuf_AddDesc_BestEQ_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\014BestEQ.proto\022\010proto_ff\032\tCom.proto\032\017Com"
    "Define.proto\"`\n\020NotifyBestEQData\022\'\n\005slot"
    "s\030\001 \003(\0132\030.proto_ff.BestEQSlotInfo\022#\n\005tas"
    "ks\030\002 \003(\0132\024.proto_ff.BestEQTask\":\n\020Notify"
    "BestEQSlot\022&\n\004slot\030\001 \001(\0132\030.proto_ff.Best"
    "EQSlotInfo\"7\n\020NotifyBestEQTask\022#\n\005tasks\030"
    "\001 \003(\0132\024.proto_ff.BestEQTask\"\037\n\021BestEQRec"
...
bool NotifyBestEQSlot::IsInitialized() const {
  ...
  if (has_slot()) {
    if (!this->slot().IsInitialized()) return false;
  }
  return true;
}
...
#ifndef _MSC_VER
const int BestEQDecomposeReq::kBagtypeFieldNumber;
const int BestEQDecomposeReq::kPosFieldNumber;
#endif  // !_MSC_VER
...
const int BestEQDecomposeRsp::kBagtypeFieldNumber;
const int BestEQDecomposeRsp::kPosFieldNumber;
#endif  // !_MSC_VER
...
#ifndef _MSC_VER
const int BestEQReturnPreViewReq::kBagtypeFieldNumber;
const int BestEQReturnPreViewReq::kPosFieldNumber;
#endif  // !_MSC_VER
...
const int BestEQReturnPreViewRsp::kBagtypeFieldNumber;
const int BestEQReturnPreViewRsp::kPosFieldNumber;
#endif  // !_MSC_VER
...
#ifndef _MSC_VER
const int BestEQReturnReq::kBagtypeFieldNumber;
const int BestEQReturnReq::kPosFieldNumber;
#endif  // !_MSC_VER
...
const int BestEQReturnRsp::kBagtypeFieldNumber;
const int BestEQReturnRsp::kPosFieldNumber;
#endif  // !_MSC_VER
...
#ifndef _MSC_VER
const int BestEQDressReq::kBagtypeFieldNumber;
const int BestEQDressReq::kPosFieldNumber;
#endif  // !_MSC_VER
...
const int BestEQDressRsp::kBagtypeFieldNumber;
const int BestEQDressRsp::kPosFieldNumber;
#endif  // !_MSC_VER
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 2: {
        ...
        if (input->ExpectTag(24)) goto parse_costpos;
        break;
      }
        ...
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
         ...
         parse_costpos:
          DO_((::google::protobuf::internal::WireFormatLite::ReadRepeatedPrimitive<
                   ::google::protobuf::int32, ::google::protobuf::internal::WireFormatLite::TYPE_INT32>(
                 1, 24, input, this->mutable_costpos())));
...
::google::protobuf::uint8* BestEQStrongReq::SerializeWithCachedSizesToArray(
  ...
  for (int i = 0; i < this->costpos_size(); i++) {
    target = ::google::protobuf::internal::WireFormatLite::
      WriteInt32ToArray(3, this->costpos(i), target);
  }
