...
namespace proto_ff_s {
	...
	struct randomnamewomanfirst_s : public NFDescStoreSeqOP {
		...
		virtual ~randomnamewomanfirst_s(){}
		int CreateInit();
		int ResumeInit();
		int32_t id;
		NFShmString<60> name;
	...
	struct randomnamewomansecond_s : public NFDescStoreSeqOP {
		...
		virtual ~randomnamewomansecond_s(){}
		int CreateInit();
		int ResumeInit();
		int32_t id;
		NFShmString<60> name;
	...
	struct randomnamewomanthird_s : public NFDescStoreSeqOP {
		...
		virtual ~randomnamewomanthird_s(){}
		int CreateInit();
		int ResumeInit();
		int32_t id;
		NFShmString<60> name;
