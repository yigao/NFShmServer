...
enum EPackageType {
  ...
  EPackageType_fengshen = 21,
  EPackageType_hunjing = 22,
  EPackageType_guwen = 23,
  EPackageType_godhood = 24,
  EPackageType_Limit = 25
};
...
enum EConst {
  ...
  EConst_DropBelongProtectSec = 117,
...
enum ERetCode {
  ...
  RET_FACTION_MAG_RECORD_NOT_UPGRADE = 1952,
  RET_FACTION_MAG_RECORD_UPGRADE_LACK_ITEM = 1953,
  ...
  RET_DEITY_GODHOOD_LV_FAIL = 2210,
  ...
  RET_FEST_LACK_RESET_LOTTERY_ITEM = 4490,
  ...
  RET_FEST_OPEN_DAY_LIMIT = 4512,
  RET_FEST_FUNC_UNLOCK_LIMIT = 4513,
  RET_FEST_DAY_MALL_NOT_EXIST = 4514,
  RET_FEST_MALL_NOT_OPEN = 4515,
  RET_FEST_MALL_NOT_EXIST = 4516,
  RET_FEST_MALL_ITEM_NOT_EXIST = 4517,
  RET_FEST_CAN_NOT_RESET_LOTTERY = 4518,
  ...
  RET_SOUL_SPIRIT_SAME = 5323,
  RET_SOUL_SPIRIT_SLOT_NOT_OPEN = 5324,
  RET_SOUL_SPIRIT_NOT_DRESS = 5325,
  RET_SOUL_SPIRIT_BREAK_MAX = 5326,
  RET_SOUL_SPIRIT_STRONG_MAX = 5327,
  RET_SOUL_SPIRIT_MAKE_MAX = 5328,
  RET_SOUL_MATIAL_LACK = 5329,
  RET_SOUL_BONE_NOT_DRESS = 5330,
  RET_SOUL_BONE_IS_WAKE = 5331,
  RET_SOUL_GUWEN_IS_DRESSED = 5332,
  RET_SOUL_LAST_SUIT_NOT_FULL = 5333,
...
enum CHAT_CHANNEL {
  ...
  CHAT_CHANNEL_RUMOR_NO_DHORSE = 16,
