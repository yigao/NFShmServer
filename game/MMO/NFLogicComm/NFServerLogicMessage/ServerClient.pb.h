...
class NotifyLogoutGame : public ::google::protobuf::Message {
 public:
  ...
  inline ::proto_ff::LOGOUT_TYPE flag() const;
  inline void set_flag(::proto_ff::LOGOUT_TYPE value);
...
inline ::proto_ff::LOGOUT_TYPE NotifyLogoutGame::flag() const {
  return static_cast< ::proto_ff::LOGOUT_TYPE >(flag_);
}
inline void NotifyLogoutGame::set_flag(::proto_ff::LOGOUT_TYPE value) {
