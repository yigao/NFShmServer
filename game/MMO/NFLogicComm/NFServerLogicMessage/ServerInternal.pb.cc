...
void protobuf_AssignDesc_ServerInternal_2eproto() {
  ...
  CenterRoleProto_descriptor_ = file->message_type(17);
  static const int CenterRoleProto_offsets_[1] = {
  };
...
void NotifyLogicLeaveGameRsp::InitAsDefaultInstance() {
  info_ = const_cast< ::proto_ff::RoleDBInfo*>(&::proto_ff::RoleDBInfo::default_instance());
}
...
void NotifyLogicLeaveGameRsp::MergeFrom(const NotifyLogicLeaveGameRsp& from) {
  ...
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    ...
    if (from.has_info()) {
      mutable_info()->::proto_ff::RoleDBInfo::MergeFrom(from.info());
    }
  }
  mutable_unknown_fields()->MergeFrom(from.unknown_fields());
}
