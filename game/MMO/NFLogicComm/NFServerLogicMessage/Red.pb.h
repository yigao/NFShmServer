...
class Red_CLTriggerRedRsp : public ::google::protobuf::Message {
 public:
  Red_CLTriggerRedRsp();
  virtual ~Red_CLTriggerRedRsp();

  Red_CLTriggerRedRsp(const Red_CLTriggerRedRsp& from);

  inline Red_CLTriggerRedRsp& operator=(const Red_CLTriggerRedRsp& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const Red_CLTriggerRedRsp& default_instance();

  void Swap(Red_CLTriggerRedRsp* other);

  // implements Message ----------------------------------------------

  Red_CLTriggerRedRsp* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const Red_CLTriggerRedRsp& from);
  void MergeFrom(const Red_CLTriggerRedRsp& from);
  void Clear();
  bool IsInitialized() const;
  ...
  // @@protoc_insertion_point(class_scope:proto_ff.Red_CLTriggerRedRsp)
 private:
  inline void set_has_cid();
  inline void clear_has_cid();
  ...
  void InitAsDefaultInstance();
  static Red_CLTriggerRedRsp* default_instance_;
};
// ===================================================================
...
// optional .proto_ff.RoleHeadPicProto head = 6;
inline bool RedFetchProto::has_head() const {
  return (_has_bits_[0] & 0x00000020u) != 0;
}
inline void RedFetchProto::set_has_head() {
  _has_bits_[0] |= 0x00000020u;
}
inline void RedFetchProto::clear_has_head() {
  _has_bits_[0] &= ~0x00000020u;
}
inline void RedFetchProto::clear_head() {
  if (head_ != NULL) head_->::proto_ff::RoleHeadPicProto::Clear();
  clear_has_head();
}
inline const ::proto_ff::RoleHeadPicProto& RedFetchProto::head() const {
  return head_ != NULL ? *head_ : *default_instance_->head_;
}
inline ::proto_ff::RoleHeadPicProto* RedFetchProto::mutable_head() {
  set_has_head();
  if (head_ == NULL) head_ = new ::proto_ff::RoleHeadPicProto;
  return head_;
}
inline ::proto_ff::RoleHeadPicProto* RedFetchProto::release_head() {
  clear_has_head();
  ::proto_ff::RoleHeadPicProto* temp = head_;
  head_ = NULL;
  return temp;
}
inline void RedFetchProto::set_allocated_head(::proto_ff::RoleHeadPicProto* head) {
  delete head_;
  head_ = head;
  if (head) {
    set_has_head();
...
// optional .proto_ff.RoleHeadPicProto head = 9;
inline bool RedDetailProto::has_head() const {
  return (_has_bits_[0] & 0x00000100u) != 0;
}
inline void RedDetailProto::set_has_head() {
  _has_bits_[0] |= 0x00000100u;
}
inline void RedDetailProto::clear_has_head() {
  _has_bits_[0] &= ~0x00000100u;
}
inline void RedDetailProto::clear_head() {
  if (head_ != NULL) head_->::proto_ff::RoleHeadPicProto::Clear();
  clear_has_head();
}
inline const ::proto_ff::RoleHeadPicProto& RedDetailProto::head() const {
  return head_ != NULL ? *head_ : *default_instance_->head_;
}
inline ::proto_ff::RoleHeadPicProto* RedDetailProto::mutable_head() {
  set_has_head();
  if (head_ == NULL) head_ = new ::proto_ff::RoleHeadPicProto;
  return head_;
}
inline ::proto_ff::RoleHeadPicProto* RedDetailProto::release_head() {
  clear_has_head();
  ::proto_ff::RoleHeadPicProto* temp = head_;
  head_ = NULL;
  return temp;
}
inline void RedDetailProto::set_allocated_head(::proto_ff::RoleHeadPicProto* head) {
  delete head_;
  head_ = head;
  if (head) {
    set_has_head();
...
// optional .proto_ff.RoleHeadPicProto head = 9;
inline bool RedSimpleProto::has_head() const {
  return (_has_bits_[0] & 0x00000100u) != 0;
}
inline void RedSimpleProto::set_has_head() {
  _has_bits_[0] |= 0x00000100u;
}
inline void RedSimpleProto::clear_has_head() {
  _has_bits_[0] &= ~0x00000100u;
}
inline void RedSimpleProto::clear_head() {
  if (head_ != NULL) head_->::proto_ff::RoleHeadPicProto::Clear();
  clear_has_head();
}
inline const ::proto_ff::RoleHeadPicProto& RedSimpleProto::head() const {
  return head_ != NULL ? *head_ : *default_instance_->head_;
}
inline ::proto_ff::RoleHeadPicProto* RedSimpleProto::mutable_head() {
  set_has_head();
  if (head_ == NULL) head_ = new ::proto_ff::RoleHeadPicProto;
  return head_;
}
inline ::proto_ff::RoleHeadPicProto* RedSimpleProto::release_head() {
  clear_has_head();
  ::proto_ff::RoleHeadPicProto* temp = head_;
  head_ = NULL;
  return temp;
}
inline void RedSimpleProto::set_allocated_head(::proto_ff::RoleHeadPicProto* head) {
  delete head_;
  head_ = head;
  if (head) {
    set_has_head();
...
// optional int32 type = 4;
inline bool Red_CLFetchRsp::has_type() const {
  return (_has_bits_[0] & 0x00000008u) != 0;
}
inline void Red_CLFetchRsp::set_has_type() {
  _has_bits_[0] |= 0x00000008u;
}
inline void Red_CLFetchRsp::clear_has_type() {
  _has_bits_[0] &= ~0x00000008u;
}
inline void Red_CLFetchRsp::clear_type() {
  type_ = 0;
  clear_has_type();
}
inline ::google::protobuf::int32 Red_CLFetchRsp::type() const {
  return type_;
}
inline void Red_CLFetchRsp::set_type(::google::protobuf::int32 value) {
  set_has_type();
  type_ = value;
}

// optional int32 cfgid = 5;
inline bool Red_CLFetchRsp::has_cfgid() const {
  return (_has_bits_[0] & 0x00000010u) != 0;
}
inline void Red_CLFetchRsp::set_has_cfgid() {
  _has_bits_[0] |= 0x00000010u;
}
inline void Red_CLFetchRsp::clear_has_cfgid() {
  _has_bits_[0] &= ~0x00000010u;
}
inline void Red_CLFetchRsp::clear_cfgid() {
  cfgid_ = 0;
  clear_has_cfgid();
}
inline ::google::protobuf::int32 Red_CLFetchRsp::cfgid() const {
  return cfgid_;
}
inline void Red_CLFetchRsp::set_cfgid(::google::protobuf::int32 value) {
  set_has_cfgid();
  cfgid_ = value;
}
...
// optional uint64 cid = 1;
inline bool Red_CLTriggerRedRsp::has_cid() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void Red_CLTriggerRedRsp::set_has_cid() {
  _has_bits_[0] |= 0x00000001u;
}
inline void Red_CLTriggerRedRsp::clear_has_cid() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void Red_CLTriggerRedRsp::clear_cid() {
  cid_ = GOOGLE_ULONGLONG(0);
  clear_has_cid();
}
inline ::google::protobuf::uint64 Red_CLTriggerRedRsp::cid() const {
  return cid_;
}
inline void Red_CLTriggerRedRsp::set_cid(::google::protobuf::uint64 value) {
  set_has_cid();
  cid_ = value;
}

// repeated uint32 cfgid_lst = 2;
inline int Red_CLTriggerRedRsp::cfgid_lst_size() const {
  return cfgid_lst_.size();
}
inline void Red_CLTriggerRedRsp::clear_cfgid_lst() {
  cfgid_lst_.Clear();
}
inline ::google::protobuf::uint32 Red_CLTriggerRedRsp::cfgid_lst(int index) const {
  return cfgid_lst_.Get(index);
}
inline void Red_CLTriggerRedRsp::set_cfgid_lst(int index, ::google::protobuf::uint32 value) {
  cfgid_lst_.Set(index, value);
}
inline void Red_CLTriggerRedRsp::add_cfgid_lst(::google::protobuf::uint32 value) {
  cfgid_lst_.Add(value);
}
inline const ::google::protobuf::RepeatedField< ::google::protobuf::uint32 >&
Red_CLTriggerRedRsp::cfgid_lst() const {
  return cfgid_lst_;
}
inline ::google::protobuf::RepeatedField< ::google::protobuf::uint32 >*
Red_CLTriggerRedRsp::mutable_cfgid_lst() {
  return &cfgid_lst_;
}
