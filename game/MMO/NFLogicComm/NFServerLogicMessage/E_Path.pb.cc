...
void protobuf_AssignDesc_E_5fPath_2eproto() {
  protobuf_AddDesc_E_5fPath_2eproto();
...
inline void protobuf_AssignDescriptorsOnce() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AssignDescriptors_once_,
                 &protobuf_AssignDesc_E_5fPath_2eproto);
}
...
void protobuf_AddDesc_E_5fPath_2eproto() {
  ...
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "E_Path.proto", &protobuf_RegisterTypes);
  ...
  ::google::protobuf::internal::OnShutdown(&protobuf_ShutdownFile_E_5fPath_2eproto);
}

// Force AddDescriptors() to be called at static initialization time.
struct StaticDescriptorInitializer_E_5fPath_2eproto {
  StaticDescriptorInitializer_E_5fPath_2eproto() {
    protobuf_AddDesc_E_5fPath_2eproto();
  }
} static_descriptor_initializer_E_5fPath_2eproto_;
...
const E_PathPath& E_PathPath::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_E_5fPath_2eproto();
