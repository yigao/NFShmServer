...
public:
    ...
    //获取玩家视野数据中用到的属性ID
    const NFShmStaticList<int8_t, proto_ff::A_COMMON_END> &PlayerViewAttr();

    //获取怪物视野数据中用到的属性ID
    const NFShmStaticList<int8_t, proto_ff::A_COMMON_END> &MonViewAttr();

    //伙伴视野数据中用到的属性ID
    const NFShmStaticList<int8_t, proto_ff::A_COMMON_END> &PartnerViewAttr();
...
protected:
    ...
    //玩家视野数据中用到的 属性ID
    NFShmStaticList<int8_t, proto_ff::A_COMMON_END> m_setPlayerViewAttr;
    //怪物视野数据中用到的 属性ID
    NFShmStaticList<int8_t, proto_ff::A_COMMON_END> m_setMonsViewAttr;
    //伙伴视野数据中用到的 属性ID
    NFShmStaticList<int8_t, proto_ff::A_COMMON_END> m_setPartnerViewAttr;
