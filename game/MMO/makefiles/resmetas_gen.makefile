...
${PROTOCGEN_FILE_PATH}/soul_proto_finish:${PROTOCOL_COMM_XML} ${FIELD_OPTIONS_XML} ${RESDB_META_PATH}/E_Soul.proto
	mkdir -p ${PROTOCGEN_FILE_PATH}
	rm -rf ${PROTOCGEN_FILE_PATH}/soul_proto_finish
	${PROTOC} $^ -I${THIRD_PARTY_INC_PATH} -I${RESDB_META_PATH} -I${PROTOCOL_COMM_PATH} -I${PROTOCOL_SS_LOGIC_PATH} -I${PROTOCOL_KERNEL_PATH} --include_imports --descriptor_set_out=${PROTOCGEN_FILE_PATH}/soul.proto.ds --cpp_out=${PROTOCGEN_FILE_PATH}
	${NFEXCELPROCESS} --work="exceltostruct" --proto_ds=${PROTOCGEN_FILE_PATH}/soul.proto.ds --src=E_Soul.proto --dst=${PROTOCGEN_FILE_PATH}/;
	${FILE_COPY_EXE} --work="filecopy" --src="${PROTOCGEN_FILE_PATH}/E_Soul.pb.h ${PROTOCGEN_FILE_PATH}/E_Soul.pb.cc ${PROTOCGEN_FILE_PATH}/E_Soul_s.h ${PROTOCGEN_FILE_PATH}/E_Soul_s.cpp " --dst=${NEW_PROTOCGEN_FILE_PATH}/
	touch ${PROTOCGEN_FILE_PATH}/soul_proto_finish


${PROTOCGEN_FILE_PATH}/rune_proto_finish:${PROTOCOL_COMM_XML} ${FIELD_OPTIONS_XML} ${RESDB_META_PATH}/E_Rune.proto
	mkdir -p ${PROTOCGEN_FILE_PATH}
	rm -rf ${PROTOCGEN_FILE_PATH}/rune_proto_finish
	${PROTOC} $^ -I${THIRD_PARTY_INC_PATH} -I${RESDB_META_PATH} -I${PROTOCOL_COMM_PATH} -I${PROTOCOL_SS_LOGIC_PATH} -I${PROTOCOL_KERNEL_PATH} --include_imports --descriptor_set_out=${PROTOCGEN_FILE_PATH}/rune.proto.ds --cpp_out=${PROTOCGEN_FILE_PATH}
	${NFEXCELPROCESS} --work="exceltostruct" --proto_ds=${PROTOCGEN_FILE_PATH}/rune.proto.ds --src=E_Rune.proto --dst=${PROTOCGEN_FILE_PATH}/;
	${FILE_COPY_EXE} --work="filecopy" --src="${PROTOCGEN_FILE_PATH}/E_Rune.pb.h ${PROTOCGEN_FILE_PATH}/E_Rune.pb.cc ${PROTOCGEN_FILE_PATH}/E_Rune_s.h ${PROTOCGEN_FILE_PATH}/E_Rune_s.cpp " --dst=${NEW_PROTOCGEN_FILE_PATH}/
	touch ${PROTOCGEN_FILE_PATH}/rune_proto_finish


${PROTOCGEN_FILE_PATH}/nickgod_proto_finish:${PROTOCOL_COMM_XML} ${FIELD_OPTIONS_XML} ${RESDB_META_PATH}/E_Nickgod.proto
	mkdir -p ${PROTOCGEN_FILE_PATH}
	rm -rf ${PROTOCGEN_FILE_PATH}/nickgod_proto_finish
	${PROTOC} $^ -I${THIRD_PARTY_INC_PATH} -I${RESDB_META_PATH} -I${PROTOCOL_COMM_PATH} -I${PROTOCOL_SS_LOGIC_PATH} -I${PROTOCOL_KERNEL_PATH} --include_imports --descriptor_set_out=${PROTOCGEN_FILE_PATH}/nickgod.proto.ds --cpp_out=${PROTOCGEN_FILE_PATH}
	${NFEXCELPROCESS} --work="exceltostruct" --proto_ds=${PROTOCGEN_FILE_PATH}/nickgod.proto.ds --src=E_Nickgod.proto --dst=${PROTOCGEN_FILE_PATH}/;
	${FILE_COPY_EXE} --work="filecopy" --src="${PROTOCGEN_FILE_PATH}/E_Nickgod.pb.h ${PROTOCGEN_FILE_PATH}/E_Nickgod.pb.cc ${PROTOCGEN_FILE_PATH}/E_Nickgod_s.h ${PROTOCGEN_FILE_PATH}/E_Nickgod_s.cpp " --dst=${NEW_PROTOCGEN_FILE_PATH}/
	touch ${PROTOCGEN_FILE_PATH}/nickgod_proto_finish


${PROTOCGEN_FILE_PATH}/tianxiafirst_proto_finish:${PROTOCOL_COMM_XML} ${FIELD_OPTIONS_XML} ${RESDB_META_PATH}/E_Tianxiafirst.proto
	mkdir -p ${PROTOCGEN_FILE_PATH}
	rm -rf ${PROTOCGEN_FILE_PATH}/tianxiafirst_proto_finish
	${PROTOC} $^ -I${THIRD_PARTY_INC_PATH} -I${RESDB_META_PATH} -I${PROTOCOL_COMM_PATH} -I${PROTOCOL_SS_LOGIC_PATH} -I${PROTOCOL_KERNEL_PATH} --include_imports --descriptor_set_out=${PROTOCGEN_FILE_PATH}/tianxiafirst.proto.ds --cpp_out=${PROTOCGEN_FILE_PATH}
	${NFEXCELPROCESS} --work="exceltostruct" --proto_ds=${PROTOCGEN_FILE_PATH}/tianxiafirst.proto.ds --src=E_Tianxiafirst.proto --dst=${PROTOCGEN_FILE_PATH}/;
	${FILE_COPY_EXE} --work="filecopy" --src="${PROTOCGEN_FILE_PATH}/E_Tianxiafirst.pb.h ${PROTOCGEN_FILE_PATH}/E_Tianxiafirst.pb.cc ${PROTOCGEN_FILE_PATH}/E_Tianxiafirst_s.h ${PROTOCGEN_FILE_PATH}/E_Tianxiafirst_s.cpp " --dst=${NEW_PROTOCGEN_FILE_PATH}/
	touch ${PROTOCGEN_FILE_PATH}/tianxiafirst_proto_finish


${PROTOCGEN_FILE_PATH}/wordshout_proto_finish:${PROTOCOL_COMM_XML} ${FIELD_OPTIONS_XML} ${RESDB_META_PATH}/E_Wordshout.proto
	mkdir -p ${PROTOCGEN_FILE_PATH}
	rm -rf ${PROTOCGEN_FILE_PATH}/wordshout_proto_finish
	${PROTOC} $^ -I${THIRD_PARTY_INC_PATH} -I${RESDB_META_PATH} -I${PROTOCOL_COMM_PATH} -I${PROTOCOL_SS_LOGIC_PATH} -I${PROTOCOL_KERNEL_PATH} --include_imports --descriptor_set_out=${PROTOCGEN_FILE_PATH}/wordshout.proto.ds --cpp_out=${PROTOCGEN_FILE_PATH}
	${NFEXCELPROCESS} --work="exceltostruct" --proto_ds=${PROTOCGEN_FILE_PATH}/wordshout.proto.ds --src=E_Wordshout.proto --dst=${PROTOCGEN_FILE_PATH}/;
	${FILE_COPY_EXE} --work="filecopy" --src="${PROTOCGEN_FILE_PATH}/E_Wordshout.pb.h ${PROTOCGEN_FILE_PATH}/E_Wordshout.pb.cc ${PROTOCGEN_FILE_PATH}/E_Wordshout_s.h ${PROTOCGEN_FILE_PATH}/E_Wordshout_s.cpp " --dst=${NEW_PROTOCGEN_FILE_PATH}/
	touch ${PROTOCGEN_FILE_PATH}/wordshout_proto_finish


${PROTOCGEN_FILE_PATH}/login_proto_finish:${PROTOCOL_COMM_XML} ${FIELD_OPTIONS_XML} ${RESDB_META_PATH}/E_Login.proto
	mkdir -p ${PROTOCGEN_FILE_PATH}
	rm -rf ${PROTOCGEN_FILE_PATH}/login_proto_finish
	...
	${NFEXCELPROCESS} --work="exceltostruct" --proto_ds=${PROTOCGEN_FILE_PATH}/login.proto.ds --src=E_Login.proto --dst=${PROTOCGEN_FILE_PATH}/;
	${FILE_COPY_EXE} --work="filecopy" --src="${PROTOCGEN_FILE_PATH}/E_Login.pb.h ${PROTOCGEN_FILE_PATH}/E_Login.pb.cc ${PROTOCGEN_FILE_PATH}/E_Login_s.h ${PROTOCGEN_FILE_PATH}/E_Login_s.cpp " --dst=${NEW_PROTOCGEN_FILE_PATH}/
	touch ${PROTOCGEN_FILE_PATH}/login_proto_finish


${PROTOCGEN_FILE_PATH}/cloak_proto_finish:${PROTOCOL_COMM_XML} ${FIELD_OPTIONS_XML} ${RESDB_META_PATH}/E_Cloak.proto
	mkdir -p ${PROTOCGEN_FILE_PATH}
	rm -rf ${PROTOCGEN_FILE_PATH}/cloak_proto_finish
	${PROTOC} $^ -I${THIRD_PARTY_INC_PATH} -I${RESDB_META_PATH} -I${PROTOCOL_COMM_PATH} -I${PROTOCOL_SS_LOGIC_PATH} -I${PROTOCOL_KERNEL_PATH} --include_imports --descriptor_set_out=${PROTOCGEN_FILE_PATH}/cloak.proto.ds --cpp_out=${PROTOCGEN_FILE_PATH}
	${NFEXCELPROCESS} --work="exceltostruct" --proto_ds=${PROTOCGEN_FILE_PATH}/cloak.proto.ds --src=E_Cloak.proto --dst=${PROTOCGEN_FILE_PATH}/;
	${FILE_COPY_EXE} --work="filecopy" --src="${PROTOCGEN_FILE_PATH}/E_Cloak.pb.h ${PROTOCGEN_FILE_PATH}/E_Cloak.pb.cc ${PROTOCGEN_FILE_PATH}/E_Cloak_s.h ${PROTOCGEN_FILE_PATH}/E_Cloak_s.cpp " --dst=${NEW_PROTOCGEN_FILE_PATH}/
	touch ${PROTOCGEN_FILE_PATH}/cloak_proto_finish


${PROTOCGEN_FILE_PATH}/qunxiongzhulu_proto_finish:${PROTOCOL_COMM_XML} ${FIELD_OPTIONS_XML} ${RESDB_META_PATH}/E_Qunxiongzhulu.proto
	mkdir -p ${PROTOCGEN_FILE_PATH}
	rm -rf ${PROTOCGEN_FILE_PATH}/qunxiongzhulu_proto_finish
	${PROTOC} $^ -I${THIRD_PARTY_INC_PATH} -I${RESDB_META_PATH} -I${PROTOCOL_COMM_PATH} -I${PROTOCOL_SS_LOGIC_PATH} -I${PROTOCOL_KERNEL_PATH} --include_imports --descriptor_set_out=${PROTOCGEN_FILE_PATH}/qunxiongzhulu.proto.ds --cpp_out=${PROTOCGEN_FILE_PATH}
	${NFEXCELPROCESS} --work="exceltostruct" --proto_ds=${PROTOCGEN_FILE_PATH}/qunxiongzhulu.proto.ds --src=E_Qunxiongzhulu.proto --dst=${PROTOCGEN_FILE_PATH}/;
	${FILE_COPY_EXE} --work="filecopy" --src="${PROTOCGEN_FILE_PATH}/E_Qunxiongzhulu.pb.h ${PROTOCGEN_FILE_PATH}/E_Qunxiongzhulu.pb.cc ${PROTOCGEN_FILE_PATH}/E_Qunxiongzhulu_s.h ${PROTOCGEN_FILE_PATH}/E_Qunxiongzhulu_s.cpp " --dst=${NEW_PROTOCGEN_FILE_PATH}/
	touch ${PROTOCGEN_FILE_PATH}/qunxiongzhulu_proto_finish


${PROTOCGEN_FILE_PATH}/peakBattle_proto_finish:${PROTOCOL_COMM_XML} ${FIELD_OPTIONS_XML} ${RESDB_META_PATH}/E_Peakbattle.proto
	mkdir -p ${PROTOCGEN_FILE_PATH}
	rm -rf ${PROTOCGEN_FILE_PATH}/peakBattle_proto_finish
	${PROTOC} $^ -I${THIRD_PARTY_INC_PATH} -I${RESDB_META_PATH} -I${PROTOCOL_COMM_PATH} -I${PROTOCOL_SS_LOGIC_PATH} -I${PROTOCOL_KERNEL_PATH} --include_imports --descriptor_set_out=${PROTOCGEN_FILE_PATH}/peakBattle.proto.ds --cpp_out=${PROTOCGEN_FILE_PATH}
	${NFEXCELPROCESS} --work="exceltostruct" --proto_ds=${PROTOCGEN_FILE_PATH}/peakBattle.proto.ds --src=E_Peakbattle.proto --dst=${PROTOCGEN_FILE_PATH}/;
	${FILE_COPY_EXE} --work="filecopy" --src="${PROTOCGEN_FILE_PATH}/E_Peakbattle.pb.h ${PROTOCGEN_FILE_PATH}/E_Peakbattle.pb.cc ${PROTOCGEN_FILE_PATH}/E_Peakbattle_s.h ${PROTOCGEN_FILE_PATH}/E_Peakbattle_s.cpp " --dst=${NEW_PROTOCGEN_FILE_PATH}/
	touch ${PROTOCGEN_FILE_PATH}/peakBattle_proto_finish
