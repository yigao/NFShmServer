...
${PROTOCGEN_FILE_PATH}/rune_xlsx_finish:${RESDB_EXCELMMO_PATH}/rune.xlsx
	mkdir -p ${PROTOCGEN_FILE_PATH}
	rm -rf ${PROTOCGEN_FILE_PATH}/rune_xlsx_finish
	${NFEXCELPROCESS} --work="exceltoproto" --src=$^ --dst=${PROTOCGEN_FILE_PATH}/
	${FILE_COPY_EXE} --work="filecopy" --src="${PROTOCGEN_FILE_PATH}/E_Rune.proto ${PROTOCGEN_FILE_PATH}/rune_gen.makefile" --dst=${RESDB_META_PATH}/
	touch ${PROTOCGEN_FILE_PATH}/rune_xlsx_finish
...
${PROTOCGEN_FILE_PATH}/wordshout_xlsx_finish:${RESDB_EXCELMMO_PATH}/wordshout.xlsx
	mkdir -p ${PROTOCGEN_FILE_PATH}
	rm -rf ${PROTOCGEN_FILE_PATH}/wordshout_xlsx_finish
	${NFEXCELPROCESS} --work="exceltoproto" --src=$^ --dst=${PROTOCGEN_FILE_PATH}/
	${FILE_COPY_EXE} --work="filecopy" --src="${PROTOCGEN_FILE_PATH}/E_Wordshout.proto ${PROTOCGEN_FILE_PATH}/wordshout_gen.makefile" --dst=${RESDB_META_PATH}/
	touch ${PROTOCGEN_FILE_PATH}/wordshout_xlsx_finish


${PROTOCGEN_FILE_PATH}/login_xlsx_finish:${RESDB_EXCELMMO_PATH}/login.xlsx
	mkdir -p ${PROTOCGEN_FILE_PATH}
	rm -rf ${PROTOCGEN_FILE_PATH}/login_xlsx_finish
	${NFEXCELPROCESS} --work="exceltoproto" --src=$^ --dst=${PROTOCGEN_FILE_PATH}/
	${FILE_COPY_EXE} --work="filecopy" --src="${PROTOCGEN_FILE_PATH}/E_Login.proto ${PROTOCGEN_FILE_PATH}/login_gen.makefile" --dst=${RESDB_META_PATH}/
	touch ${PROTOCGEN_FILE_PATH}/login_xlsx_finish


${PROTOCGEN_FILE_PATH}/cloak_xlsx_finish:${RESDB_EXCELMMO_PATH}/cloak.xlsx
	mkdir -p ${PROTOCGEN_FILE_PATH}
	rm -rf ${PROTOCGEN_FILE_PATH}/cloak_xlsx_finish
	${NFEXCELPROCESS} --work="exceltoproto" --src=$^ --dst=${PROTOCGEN_FILE_PATH}/
	${FILE_COPY_EXE} --work="filecopy" --src="${PROTOCGEN_FILE_PATH}/E_Cloak.proto ${PROTOCGEN_FILE_PATH}/cloak_gen.makefile" --dst=${RESDB_META_PATH}/
	touch ${PROTOCGEN_FILE_PATH}/cloak_xlsx_finish


${PROTOCGEN_FILE_PATH}/qunxiongzhulu_xlsx_finish:${RESDB_EXCELMMO_PATH}/qunxiongzhulu.xlsx
	mkdir -p ${PROTOCGEN_FILE_PATH}
	rm -rf ${PROTOCGEN_FILE_PATH}/qunxiongzhulu_xlsx_finish
	${NFEXCELPROCESS} --work="exceltoproto" --src=$^ --dst=${PROTOCGEN_FILE_PATH}/
	${FILE_COPY_EXE} --work="filecopy" --src="${PROTOCGEN_FILE_PATH}/E_Qunxiongzhulu.proto ${PROTOCGEN_FILE_PATH}/qunxiongzhulu_gen.makefile" --dst=${RESDB_META_PATH}/
	touch ${PROTOCGEN_FILE_PATH}/qunxiongzhulu_xlsx_finish


${PROTOCGEN_FILE_PATH}/peakBattle_xlsx_finish:${RESDB_EXCELMMO_PATH}/peakBattle.xlsx
	mkdir -p ${PROTOCGEN_FILE_PATH}
	rm -rf ${PROTOCGEN_FILE_PATH}/peakBattle_xlsx_finish
	${NFEXCELPROCESS} --work="exceltoproto" --src=$^ --dst=${PROTOCGEN_FILE_PATH}/
	${FILE_COPY_EXE} --work="filecopy" --src="${PROTOCGEN_FILE_PATH}/E_Peakbattle.proto ${PROTOCGEN_FILE_PATH}/peakBattle_gen.makefile" --dst=${RESDB_META_PATH}/
	touch ${PROTOCGEN_FILE_PATH}/peakBattle_xlsx_finish
