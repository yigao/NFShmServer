...
${PROTOCGEN_FILE_PATH}/common_ds:${COMMON_LOGIC_DESC_XML} ${PROTOCOL_COMM_XML} ${PROTOCOL_KERNEL_XML}
	mkdir -p ${PROTOCGEN_FILE_PATH}
...
${PROTOCGEN_FILE_PATH}/game_ds:${RESDB_DESC_XML} ${PROTOCOL_SS_LOGIC_XML} ${PROTOCOL_CS_LOGIC_XML} ${COMMON_LOGIC_DESC_XML} ${PROTOCOL_COMM_XML} ${PROTOCOL_FIELD_XML} ${PROTOCOL_KERNEL_XML} ${PROTOCOL_SOTRE_XML}
	...
	${PROTOC} $^ -I${THIRD_PARTY_INC_PATH} -I${RESDB_META_PATH} -I${PROTOCOL_COMM_PATH} -I${PROTOCOL_SS_PATH} -I${PROTOCOL_STORESVR_PATH} -I${PROTOCOL_SS_LOGIC_PATH} -I${PROTOCOL_CS_LOGIC_PATH} -I${COMMON_LOGIC_META_PATH} -I${PROTOCOL_KERNEL_PATH} -I${COMMON_LOGIC_META_PATH}\
