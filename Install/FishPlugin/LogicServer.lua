...
LogicServer = {
   ...
   LogicServer_3 = {
      ServerName = "LogicServer_3",
      ServerType = NF_ST_LOGIC_SERVER,
      ServerId = NF_ST_WORLD_ID.."."..NF_ST_ZONE_ID.."."..NF_ST_LOGIC_SERVER..".3",			--对每一个服务器来说都是唯一的， 应用程序需要通过这个ServerId才能知道需要加载的配置是他
      LinkMode = NF_LINK_MODE,
      BusLength = NF_COMMON_BUS_LENGTH,     --20M共享内存
      IdleSleepUS = 1000,
      ServerIp = NF_INTER_SERVER_IP,
      ServerPort = NF_INTER_SERVER_PORT+NF_ST_LOGIC_SERVER*10+3,
      MaxConnectNum = NF_INTER_MAX_CONNECT,
      NetThreadNum = 1,
      WorkThreadNum = 1,
      Security = false,
