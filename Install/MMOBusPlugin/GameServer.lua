...
GameServer = {
	...
	GameServer_2 = {
		ServerName = "GameServer_2",
		ServerType = NF_ST_GAME_SERVER,
		ServerId = NF_ST_WORLD_ID.."."..NF_ST_ZONE_ID.."."..NF_ST_GAME_SERVER..".2",			--对每一个服务器来说都是唯一的， 应用程序需要通过这个ServerId才能知道需要加载的配置是他
		LinkMode = NF_LINK_MODE,
		BusLength = NF_COMMON_BUS_LENGTH,     --20M共享内存
		IdleSleepUS = 1000,
		ServerIp = NF_INTER_SERVER_IP,
		ServerPort = NF_INTER_SERVER_PORT+NF_ST_GAME_SERVER*10+2,
		MaxConnectNum = NF_INTER_MAX_CONNECT,
		NetThreadNum = 1,
		WorkThreadNum = 1,
		MaxOnlinePlayerNum = NF_MAX_ONLINE_PLAYER_COUNT,
	...
	GameServer_3 = {
		ServerName = "GameServer_3",
		ServerType = NF_ST_GAME_SERVER,
		ServerId = NF_ST_WORLD_ID.."."..NF_ST_ZONE_ID.."."..NF_ST_GAME_SERVER..".3",			--对每一个服务器来说都是唯一的， 应用程序需要通过这个ServerId才能知道需要加载的配置是他
		LinkMode = NF_LINK_MODE,
		BusLength = NF_COMMON_BUS_LENGTH,     --20M共享内存
		IdleSleepUS = 1000,
		ServerIp = NF_INTER_SERVER_IP,
		ServerPort = NF_INTER_SERVER_PORT+NF_ST_GAME_SERVER*10+3,
		MaxConnectNum = NF_INTER_MAX_CONNECT,
		NetThreadNum = 1,
		WorkThreadNum = 1,
		MaxOnlinePlayerNum = NF_MAX_ONLINE_PLAYER_COUNT,
