...
{
    return (NFShmTimer *) NFShmTimer::GetObjectByID(m_pObjPluginManager, objectId);
    return (NFShmTimer *) FindModule<NFISharedMemModule>()->GetObj(EOT_TYPE_TIMER_OBJ, objectId);\
