...
public:
	...
	virtual NF_SHARE_PTR<NFServerData> GetFirstDbServer(NF_SERVER_TYPES eSendType, const std::string& dbName) override;
	virtual NF_SHARE_PTR<NFServerData> GeRandomDbServer(NF_SERVER_TYPES eSendType, const std::string& dbName) override;
	virtual NF_SHARE_PTR<NFServerData> GetSuitDbServer(NF_SERVER_TYPES eSendType, const std::string& dbName, uint64_t value) override;
	virtual NF_SHARE_PTR<NFServerData> GetSuitDbServer(NF_SERVER_TYPES eSendType, const std::string& dbName, const std::string& value) override;
