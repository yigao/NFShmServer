...
GAME_BUILD_PATH=${GAME_SRC_PATH}/Build/NFLogicComm/makefile

MAKEFILE_PATH=${GAME_SRC_PATH}/src/MMO/NFLogicComm/makefiles
...
RESDB_EXCEL_PATH=${GAME_SRC_PATH}/src/MMO/NFLogicComm/Excel
...
PROTOCOL_SVR_PATH=${GAME_SRC_PATH}/src/MMO/NFLogicComm/Message
...
PROTOCGEN_CPP= ${PROTOCOL_SS_LOGIC_CPP}

PROTOCGEN_H=${PROTOCOL_SS_LOGIC_H}

ALL_PROTOCGEN_FILE=${PROTOCOL_SS_LOGIC_CPP} ${PROTOCOL_SS_LOGIC_H}
ALL_PROTOC_DESCRIPTOR_FILE=
ALL_PROTOCGEN_PY=

NEW_PROTOCGEN_FILE_PATH=${GAME_SRC_PATH}/src/MMO/NFLogicComm/NFServerLogicMessage
