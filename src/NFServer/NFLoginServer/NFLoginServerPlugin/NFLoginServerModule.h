...
public:
    //////////////////////////////////////////////////////////LogicServer服务器//////////////////////////////////////////////////////////////////
    /**
     * @brief LoginServer服务器连接事件，可以是网络/bus的连接事件
     * @param nEvent
     * @param unLinkId
     * @return
     */
    ...
    /**
     * @brief 处理LoginServer未注册的消息
     * @param unLinkId
     * @param packet
     * @return
     */
    int OnHandleLoginServerOtherMessage(uint64_t unLinkId, NFDataPackage& packet);

    /**
     * @brief 处理LoginServer服务器的连接掉线
     * @param unLinkId
     * @return
     */
    int OnHandleLoginServerDisconnect(uint64_t unLinkId);
    //////////////////////////////////////////////////////////LogicServer服务器//////////////////////////////////////////////////////////////////
    //////////////////////////////////////////////////////////NFMasterServer服务器//////////////////////////////////////////////////////////////////
    /**
     * @brief 链接Master服务器
