...
public:
    //////////////////////////////////////////////////////////SnsServer服务器//////////////////////////////////////////////////////////////////
    /**
     * @brief SnsServer服务器连接事件，可以是网络/bus的连接事件
     * @param nEvent
     * @param unLinkId
     * @return
     */
    int OnSnsServerSocketEvent(eMsgType nEvent, uint64_t unLinkId);

    /**
     * @brief 处理SnsServer未注册的消息
     * @param unLinkId
     * @param packet
     * @return
     */
    int OnHandleSnsServerOtherMessage(uint64_t unLinkId, NFDataPackage& packet);

    /**
     * @brief 处理SnsServer服务器的连接掉线
     * @param unLinkId
     * @return
     */
    int OnHandleSnsServerDisconnect(uint64_t unLinkId);
    //////////////////////////////////////////////////////////SnsServer服务器//////////////////////////////////////////////////////////////////
