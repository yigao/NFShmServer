...
void protobuf_AddDesc_proto_5fkernel_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "nt_time\030\004 \001(\tB\n\220\301\024\200\001\310\202\024\200\001\022\017\n\007user_id\030\005 \001"
    "(\004\022\035\n\tuser_name\030\006 \001(\tB\n\220\301\024\200\001\310\202\024\200\001\"a\n\017NFE"
    "ventNoneData\022\016\n\006param1\030\001 \001(\003\022\016\n\006param2\030\002"
    " \001(\003\022\016\n\006param3\030\003 \001(\003\022\016\n\006param4\030\004 \001(\003\022\016\n\006"
    "param5\030\005 \001(\003\"<\n\027Proto_ServerDumpInfoNtf\022"
    "\021\n\tdump_info\030\001 \001(\t\022\016\n\006bus_id\030\002 \001(\r*\246\016\n\020P"
    "roto_Kernel_CMD\022\036\n\032NF_GTM_KILL_ALL_SERVE"
    "R_NTF\020\003\022\036\n\032NF_STS_KILL_ALL_SERVER_NTF\020\004\022"
    "\035\n\031NF_STS_SEND_DUMP_INFO_NTF\020,\022$\n NF_Mas"
    "terTMonitor_RELOAD_CMD_REQ\020P\022%\n!NF_Maste"
    "rTMonitor_RESTART_CMD_REQ\020Q\022#\n\037NF_Master"
    "TMonitor_START_CMD_REQ\020R\022\"\n\036NF_MasterTMo"
    "nitor_STOP_CMD_REQ\020S\022&\n\"NF_MasterTMonito"
    "r_STOP_ALL_CMD_REQ\020T\022(\n$NF_MasterTMonito"
    "r_RELOAD_ALL_CMD_REQ\020U\022)\n%NF_MasterTMoni"
    "tor_RESTART_ALL_CMD_REQ\020V\022\'\n#NF_MasterTM"
    "onitor_START_ALL_CMD_REQ\020W\022$\n NF_Monitor"
    "TMaster_RELOAD_CMD_RSP\020Z\022%\n!NF_MonitorTM"
    "aster_RESTART_CMD_RSP\020[\022#\n\037NF_MonitorTMa"
    "ster_START_CMD_RSP\020\\\022\"\n\036NF_MonitorTMaste"
    "r_STOP_CMD_RSP\020]\022&\n\"NF_MonitorTMaster_ST"
    "OP_ALL_CMD_RSP\020^\022(\n$NF_MonitorTMaster_RE"
    "LOAD_ALL_CMD_RSP\020_\022)\n%NF_MonitorTMaster_"
    "RESTART_ALL_CMD_RSP\020`\022\'\n#NF_MonitorTMast"
    "er_START_ALL_CMD_RSP\020a\022 \n\034NF_SERVER_TO_S"
    "ERVER_REGISTER\020d\022$\n NF_SERVER_TO_SERVER_"
    "REGISTER_RSP\020e\022*\n&NF_MASTER_SERVER_SEND_"
    "OTHERS_TO_SERVER\020f\022%\n!NF_SERVER_TO_MASTE"
    "R_SERVER_REPORT\020g\022\'\n#NF_ROUTER_CMD_INTER"
    "NAL_C2R_REGISTER\020h\022\'\n#NF_ROUTER_CMD_INTE"
    "RNAL_R2C_REGISTER\020i\022(\n$NF_ROUTER_CMD_INT"
    "ERNAL_C2R_HEARTBEAT\020j\022(\n$NF_ROUTER_CMD_I"
    "NTERNAL_R2C_HEARTBEAT\020k\022\036\n\032NF_ROUTER_CMD"
    "_DISPATCH_MOD\020l\022%\n!NF_ROUTER_CMD_DISPATC"
    "H_ROUNDROBIN\020m\022$\n NF_ROUTER_CMD_DISPATCH"
    "_BROADCAST\020n\022/\n+NF_ROUTER_CMD_DISPATCH_B"
    "ROADCAST_AND_MASTER\020o\022+\n\'NF_ROUTER_CMD_D"
    "ISPATCH_BORADCAST_MASTER\020p\022*\n&NF_ROUTER_"
    "CMD_DISPATCH_BORADCAST_SLAVE\020q\022!\n\035NF_ROU"
    "TER_CMD_DISPATCH_DIRECT\020r\022-\n)NF_ROUTER_C"
    "MD_INTERNAL_R2C_DISPATCHFAILED\020s\0220\n,NF_R"
    "OUTER_CMD_INTERNAL_C2R_REG_RAASSOCAPPSVS"
    "\020t\022\037\n\033NF_SERVER_TO_SERVER_RPC_CMD\020w\022!\n\035N"
    "F_SERVER_TO_SERVER_TRANS_CMD\020x\022$\n NF_SER"
    "VER_TO_STORE_SERVER_DB_CMD\020y\022$\n NF_STORE"
    "_SERVER_TO_SERVER_DB_CMD\020z\022%\n!NF_WORLD_R"
    "OUTER_CMD_TO_SUIT_LOGIC\020{\022#\n\037NF_SNS_ROUT"
    "ER_CMD_TO_SUIT_LOGIC\020|\022\"\n\036NF_STS_BROAD_P"
    "LAYER_MSG_NOTIFY\020}\022%\n!NF_SEVER_TO_WEB_SE"
    "RVER_RSP_NOTIFY\020~\022\'\n#NF_SERVER_BROAD_EVE"
    "NT_TO_SERVER_CMD\020\177\022/\n*NF_SERVER_REDIRECT"
    "_MSG_TO_PROXY_SERVER_CMD\020\200\001*b\n\020NFROUTER_"
    "ERRCODE\022\030\n\024NF_ROUTER_ERRCODE_OK\020\000\0224\n0NF_"
    "ROUTER_ERRCODE_DISPATCHFAILD_DESTSVR_NOT"
    "EXIST\020\001*\311\005\n\023STORESVR_CS_COMMAND\022\031\n\025E_STO"
    "RESVR_C2S_SELECT\020\000\022\031\n\025E_STORESVR_S2C_SEL"
    "ECT\020\001\022\034\n\030E_STORESVR_C2S_SELECTOBJ\020\002\022\034\n\030E"
    "_STORESVR_S2C_SELECTOBJ\020\003\022\031\n\025E_STORESVR_"
    "C2S_INSERT\020\004\022\031\n\025E_STORESVR_S2C_INSERT\020\005\022"
    "\031\n\025E_STORESVR_C2S_DELETE\020\006\022\031\n\025E_STORESVR"
    "_S2C_DELETE\020\007\022\034\n\030E_STORESVR_C2S_DELETEOB"
    "J\020\010\022\034\n\030E_STORESVR_S2C_DELETEOBJ\020\t\022\031\n\025E_S"
    "TORESVR_C2S_MODIFY\020\n\022\031\n\025E_STORESVR_S2C_M"
    "ODIFY\020\013\022\034\n\030E_STORESVR_C2S_MODIFYOBJ\020\014\022\034\n"
    "\030E_STORESVR_S2C_MODIFYOBJ\020\r\022\031\n\025E_STORESV"
    "R_C2S_MODINS\020\016\022\031\n\025E_STORESVR_S2C_MODINS\020"
    "\017\022\034\n\030E_STORESVR_C2S_MODINSOBJ\020\020\022\034\n\030E_STO"
    "RESVR_S2C_MODINSOBJ\020\021\022\034\n\030E_STORESVR_C2S_"
    "DESCSTORE\020\022\022\034\n\030E_STORESVR_S2C_DESCSTORE\020"
    "\023\022\032\n\026E_STORESVR_C2S_EXECUTE\020\024\022\032\n\026E_STORE"
    "SVR_S2C_EXECUTE\020\025\022\037\n\033E_STORESVR_C2S_EXEC"
    "UTE_MORE\020\026\022\037\n\033E_STORESVR_S2C_EXECUTE_MOR"
    "E\020\027*\245\006\n\020STORESVR_ERRCODE\022\031\n\025E_STORESVR_E"
    "RRCODE_OK\020\000\022\033\n\027E_STORESVR_ERRCODE_BUSY\020\001"
    "\022\035\n\031E_STORESVR_ERRCODE_EINVAL\020\002\022,\n(E_STO"
    "RESVR_ERRCODE_PARSEFROMSTRINGFAILED\020\003\022/\n"
    "+E_STORESVR_ERRCODE_DBNAME_OR_MODKEY_INV"
    "ALID\020\004\022%\n!E_STORESVR_ERRCODE_TBNAME_INVA"
    "LID\020\005\022#\n\037E_STORESVR_ERRCODE_SELECT_EMPTY"
    "\020\006\0227\n3E_STORESVR_ERRCODE_SELECT_FILLMESS"
    "AGEBYRESULTFAILED\020\007\0222\n.E_STORESVR_ERRCOD"
    "E_CANNOTCREATERECORDMSGOBJECT\020\010\022,\n(E_STO"
    "RESVR_ERRCODE_CANNOTFINDSQLTEMPALTE\020\t\0220\n"
    ",E_STORESVR_ERRCODE_SETPREPARESTATEMENTF"
    "AILED\020\n\022#\n\037E_STORESVR_ERRCODE_INSERTFAIL"
    "ED\020\013\022#\n\037E_STORESVR_ERRCODE_DELETEFAILED\020"
    "\014\022-\n)E_STORESVR_ERRCODE_DELETERECORDISNO"
    "TEXIST\020\r\022-\n)E_STORESVR_ERRCODE_UPDATEREC"
    "ORDISNOTEXIST\020\016\022*\n&E_STORESVR_ERRCODE_UP"
    "DATENOROWAFFECTED\020\017\022#\n\037E_STORESVR_ERRCOD"
    "E_UPDATEFAILED\020\020\022)\n%E_STORESVR_ERRCODE_U"
    "PDATEINSERTFAILED\020\021\022\036\n\032E_STORESVR_ERRCOD"
    "E_UNKNOWN\020\022*\223\001\n\016PacketDispType\022\024\n\020E_DISP"
    "_TYPE_NONE\020\000\022\036\n\032E_DISP_TYPE_BY_TRANSACTI"
    "ON\020\001\022\031\n\025E_DISP_TYPE_BY_ROLEID\020\002\022\030\n\024E_DIS"
    "P_TYPE_BY_MSGID\020\003\022\026\n\022E_DISP_TYPE_BY_RPC\020"
    "\004*I\n\014EServerState\022\014\n\010EST_INIT\020\000\022\016\n\nEST_N"
    "ARMAL\020\001\022\014\n\010EST_BUSY\020\002\022\r\n\tEST_CRASH\020\003*\221\030\n"
    "\026Proto_Kernel_ErrorCode\022&\n\031ERR_CODE_SVR_"
    "SYSTEM_ERROR\020\377\377\377\377\377\377\377\377\377\001\022\023\n\017ERR_CODE_SVR_"
    "OK\020\000\022\"\n\025ERR_CODE_MSG_RPC_BASE\020\234\377\377\377\377\377\377\377\377\001"
    "\022\"\n\025ERR_RPC_INVALID_PARAM\020\233\377\377\377\377\377\377\377\377\001\022\"\n\025"
    "ERR_RPC_ENCODE_FAILED\020\232\377\377\377\377\377\377\377\377\001\022\"\n\025ERR_"
    "RPC_DECODE_FAILED\020\231\377\377\377\377\377\377\377\377\001\022\'\n\032ERR_RPC_"
    "RECV_EXCEPTION_MSG\020\230\377\377\377\377\377\377\377\377\001\022!\n\024ERR_RPC"
    "_UNKNOWN_TYPE\020\227\377\377\377\377\377\377\377\377\001\022,\n\037ERR_RPC_UNSU"
    "PPORT_FUNCTION_NAME\020\226\377\377\377\377\377\377\377\377\001\022&\n\031ERR_RP"
    "C_SESSION_NOT_FOUND\020\225\377\377\377\377\377\377\377\377\001\022 \n\023ERR_RP"
    "C_SEND_FAILED\020\224\377\377\377\377\377\377\377\377\001\022$\n\027ERR_RPC_REQU"
    "EST_TIMEOUT\020\223\377\377\377\377\377\377\377\377\001\022*\n\035ERR_RPC_FUNCTI"
    "ON_NAME_EXISTED\020\222\377\377\377\377\377\377\377\377\001\022!\n\024ERR_RPC_SY"
    "STEM_ERROR\020\221\377\377\377\377\377\377\377\377\001\022$\n\027ERR_RPC_PROCESS"
    "_TIMEOUT\020\220\377\377\377\377\377\377\377\377\001\022+\n\036ERR_RPC_MSG_FUNCT"
    "ION_UNEXISTED\020\217\377\377\377\377\377\377\377\377\001\022)\n\034ERR_RPC_SYST"
    "EM_OVERLOAD_BASE\020\216\377\377\377\377\377\377\377\377\001\022$\n\027ERR_RPC_M"
    "ESSAGE_EXPIRED\020\215\377\377\377\377\377\377\377\377\001\022\"\n\025ERR_RPC_TAS"
    "K_OVERLOAD\020\214\377\377\377\377\377\377\377\377\001\022\034\n\017ERR_RPC_CO_USED"
    "\020\213\377\377\377\377\377\377\377\377\001\022\033\n\027ERR_CODE_ZOOKEEPER_BASE\020\000"
    ...
    "IMER_BASE\020\250\373\377\377\377\377\377\377\377\001\022\037\n\022ERR_CODE_PIPE_BA"
    "SE\020\304\372\377\377\377\377\377\377\377\001\022$\n\027ERR_CODE_COROUTINE_BASE"
    "\020\340\371\377\377\377\377\377\377\377\001\022&\n\031ERR_CODE_CO_INVALID_PARAM"
    "\020\337\371\377\377\377\377\377\377\377\001\022)\n\034ERR_CODE_CO_NOT_IN_COROUT"
    "INE\020\336\371\377\377\377\377\377\377\377\001\022$\n\027ERR_CODE_CO_NOT_RUNNIN"
    "G\020\335\371\377\377\377\377\377\377\377\001\022+\n\036ERR_CODE_CO_START_TIMER_"
    "FAILED\020\334\371\377\377\377\377\377\377\377\001\022 \n\023ERR_CODE_CO_TIMEOUT"
    "\020\333\371\377\377\377\377\377\377\377\001\0223\n&ERR_CODE_CO_CANNOT_RESUME"
    "_IN_COROUTINE\020\332\371\377\377\377\377\377\377\377\001\022*\n\035ERR_CODE_CO_"
    "COROUTINE_UNEXIST\020\331\371\377\377\377\377\377\377\377\001\022/\n\"ERR_CODE"
    "_CO_COROUTINE_STATUS_ERROR\020\327\371\377\377\377\377\377\377\377\001\022\"\n"
    "\025ERR_CODE_CHANNEL_BASE\020\374\370\377\377\377\377\377\377\377\001\022(\n\033ERR"
    "_CODE_SVR_SYSTEM_TIMEOUT\020\360\261\377\377\377\377\377\377\377\001\022/\n\"E"
    "RR_CODE_SVR_SYSTEM_DATABASE_ERROR\020\357\261\377\377\377\377"
    "\377\377\377\001\032\002\020\001*r\n\016NFEventSrcType\022\026\n\022NF_EVENT_N"
    "ONE_TYPE\020\000\022\030\n\024NF_EVENT_SERVER_TYPE\020\001\022\024\n\020"
    "NF_EVENT_GM_TYPE\020\002\022\030\n\024NF_EVENT_PLAYER_TY"
    "PE\020\003*\371\004\n\rNFEventIdType\022\036\n\032NF_EVENT_SERVE"
    "R_TYPE_BEGIN\020\001\022\'\n#NF_EVENT_SERVER_CONNEC"
    "T_TASK_FINISH\020\002\022#\n\037NF_EVENT_SERVER_LOAD_"
    "DESC_STORE\020\003\022$\n NF_EVENT_SERVER_OBJ_LOAD"
    "_FROM_DB\020\004\022%\n!NF_EVENT_SERVER_APP_FINISH"
    "_INITED\020\005\022\036\n\032NF_EVENT_SERVER_DEAD_EVENT\020"
    "\006\022\035\n\031NF_EVENT_SERVER_REG_EVENT\020\007\022#\n\037NF_E"
    "VENT_GAME_SERVER_DUMP_EVENT\020\010\022$\n NF_EVEN"
    "T_LOGIC_SERVER_DUMP_EVENT\020\t\022\034\n\030NF_EVENT_"
    "SERVER_TYPE_END\020c\022\032\n\026NF_EVENT_GM_TYPE_BE"
    "GIN\020d\022\031\n\024NF_EVENT_GM_TYPE_END\020\307\001\022\037\n\032NF_E"
    "VENT_PLAYER_TYPE_BEGIN\020\310\001\022\"\n\035NF_EVENT_PL"
    "AYER_LOGIN_SUCCESS\020\311\001\022!\n\034NF_EVENT_PLAYER"
    "_LOGIN_FAILED\020\312\001\022&\n!NF_EVENT_PLAYER_RECO"
    "NNECT_SUCCESS\020\313\001\022\037\n\032NF_EVENT_PLAYER_DISC"
    "ONNECT\020\314\001\022\035\n\030NF_EVENT_PLAYER_TYPE_END\020\253\002", 10040);
