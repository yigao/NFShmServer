...
public:
    ...
    virtual int DeleteTimer(int timeObjId)
    {
        ...
        return m_shmObj->DeleteTimer(timeObjId);
    }
    ...
    virtual int DeleteAllTimer()
    {
        CHECK_NULL(m_shmObj);
        m_timerIdMap.clear();
        return m_shmObj->DeleteAllTimer();
    }
    ...
    virtual int SetTimer(int hour, int minutes, int second, int microSec)
    {
        ...
        int timerId = m_shmObj->SetTimer(hour, minutes, second, microSec, this);
    ...
    virtual int SetCalender(int hour, int minutes, int second)
    {
        CHECK_NULL(m_shmObj);
        CHECK_EXPR(m_timerIdMap.size() < m_timerIdMap.max_size(), -1, "m_timerIdMap space not enough");
        int timerId = m_shmObj->SetCalender(hour, minutes, second, this);
        if (timerId != INVALID_ID)
        {
            m_timerIdMap.insert(timerId);
        }
    ...
    virtual int SetCalender(uint64_t timestamp)
    {
        CHECK_NULL(m_shmObj);
        CHECK_EXPR(m_timerIdMap.size() < m_timerIdMap.max_size(), -1, "m_timerIdMap space not enough");
        int timerId = m_shmObj->SetCalender(timestamp, this);
        if (timerId != INVALID_ID)
        {
            m_timerIdMap.insert(timerId);
        }
    ...
    virtual int SetTimer(int interval, int callcount, int hour, int minutes, int second, int microSec)
    {
        CHECK_NULL(m_shmObj);
        CHECK_EXPR(m_timerIdMap.size() < m_timerIdMap.max_size(), -1, "m_timerIdMap space not enough");
        int timerId = m_shmObj->SetTimer(interval, callcount, hour, minutes, second, microSec, this);
        if (timerId != INVALID_ID)
        {
            m_timerIdMap.insert(timerId);
        }
    ...
    virtual  int SetDayTime(int callcount, int hour, int minutes, int second, int microSec)
    {
        CHECK_NULL(m_shmObj);
        CHECK_EXPR(m_timerIdMap.size() < m_timerIdMap.max_size(), -1, "m_timerIdMap space not enough");
        int timerId = m_shmObj->SetDayTime(callcount, hour, minutes, second, microSec, this);
        if (timerId != INVALID_ID)
        {
            m_timerIdMap.insert(timerId);
        }
    ...
    virtual  int SetDayCalender(int callcount, int hour, int minutes, int second)
    {
        CHECK_NULL(m_shmObj);
        CHECK_EXPR(m_timerIdMap.size() < m_timerIdMap.max_size(), -1, "m_timerIdMap space not enough");
        int timerId = m_shmObj->SetDayCalender(callcount, hour, minutes, second, this);
        if (timerId != INVALID_ID)
        {
            m_timerIdMap.insert(timerId);
        }
    ...
    virtual int SetWeekTime(int callcount, int hour, int minutes, int second, int microSec)
    {
        CHECK_NULL(m_shmObj);
        CHECK_EXPR(m_timerIdMap.size() < m_timerIdMap.max_size(), -1, "m_timerIdMap space not enough");
        int timerId = m_shmObj->SetWeekTime(callcount, hour, minutes, second, microSec, this);
        if (timerId != INVALID_ID)
        {
            m_timerIdMap.insert(timerId);
        }
    ...
    virtual int SetWeekCalender(int callcount, int weekDay, int hour, int minutes, int second)
    {
        CHECK_NULL(m_shmObj);
        CHECK_EXPR(m_timerIdMap.size() < m_timerIdMap.max_size(), -1, "m_timerIdMap space not enough");
        int timerId = m_shmObj->SetWeekCalender(callcount, weekDay, hour, minutes, second, this);
        if (timerId != INVALID_ID)
        {
            m_timerIdMap.insert(timerId);
        }
    ...
    virtual int SetMonthTime(int callcount, int hour, int minutes, int second, int microSec)
    {
        CHECK_NULL(m_shmObj);
        CHECK_EXPR(m_timerIdMap.size() < m_timerIdMap.max_size(), -1, "m_timerIdMap space not enough");
        int timerId = m_shmObj->SetMonthTime(callcount, hour, minutes, second, microSec, this);
        if (timerId != INVALID_ID)
        {
            m_timerIdMap.insert(timerId);
        }
    ...
    virtual int SetMonthCalender(int callcount, int day, int hour, int minutes, int second)
    {
        CHECK_NULL(m_shmObj);
        CHECK_EXPR(m_timerIdMap.size() < m_timerIdMap.max_size(), -1, "m_timerIdMap space not enough");
        int timerId = m_shmObj->SetMonthCalender(callcount, day, hour, minutes, second, this);
        if (timerId != INVALID_ID)
        {
            m_timerIdMap.insert(timerId);
        }
