...
${PROTOCOL_SS_H} ${PROTOCOL_SS_CPP} ${PROTOCOL_SS_DESCRIPTOR} :${PROTOCOL_SS_XML} ${PROTOCOL_COMM_XML} ${PROTOCOL_FIELD_XML}
	...
	${FILE_COPY_EXE} --src="${PROTOCOL_SS_DESCRIPTOR} " --dst=${GAME_LUA_PB_PATH}/
