...
DEFINE_BIND_RPC_SERVICE(proto_ff::NF_STORESVR_C2S_MODINS, storesvr_sqldata::storesvr_modins, storesvr_sqldata::storesvr_modins_res)
DEFINE_BIND_RPC_SERVICE(proto_ff::NF_STORESVR_C2S_MODINSOBJ, storesvr_sqldata::storesvr_modinsobj, storesvr_sqldata::storesvr_modinsobj_res)
