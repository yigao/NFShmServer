...
int NFGameSession::SendErrToClient(uint32_t nMsgId, proto_ff::Proto_CS_ErrorCode errCode)
{
	...
	FindModule<NFIMessageModule>()->SendMsgToProxyServer(NF_ST_GAME_SERVER, m_proxyId, proto_ff::E_CS_ERROR, rspMsg, m_playerId);
...
int NFGameSession::SendMsgToClient(uint32_t nMsgId, const google::protobuf::Message &xData) {
	...
	FindModule<NFIMessageModule>()->SendMsgToProxyServer(NF_ST_GAME_SERVER, m_proxyId, nMsgId, xData, m_playerId);
	return 0;
}
...
int NFGameSession::SendMsgToClient(uint16_t nMainMsgId, uint16_t nSubMsgId, const google::protobuf::Message &xData)
{
	...
	FindModule<NFIMessageModule>()->SendMsgToProxyServer(NF_ST_GAME_SERVER, m_proxyId, nMainMsgId, nSubMsgId, xData, m_playerId);
	return 0;
}
...
{
	FindModule<NFIMessageModule>()->SendMsgToLogicServer(NF_ST_GAME_SERVER, m_logicId,
		nMsgId, xData);
	return 0;
}
...
{
	FindModule<NFIMessageModule>()->SendMsgToSnsServer(NF_ST_GAME_SERVER, nMsgId, xData);
	return 0;
}
...
{
	FindModule<NFIMessageModule>()->SendTransToWorldServer(NF_ST_GAME_SERVER,
...
{
	FindModule<NFIMessageModule>()->SendTransToLogicServer(NF_ST_GAME_SERVER, m_logicId,
		nMsgId, xData, req_trans_id, rsp_trans_id);
	return 0;
}
...
int NFGameSession::SendTransToSns(uint32_t nMsgId, const google::protobuf::Message &xData, uint32_t req_trans_id, uint32_t rsp_trans_id)
{
	...
	FindModule<NFIMessageModule>()->SendTransToSnsServer(NF_ST_GAME_SERVER,
		nMsgId, xData, req_trans_id, rsp_trans_id);
