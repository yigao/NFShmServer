...
#////////////////////////////////////////////////////////////////
	...
	desc_file.write("\n")
	desc_file.write("\tif ((table." + excel_name.lower() + sheet_name.lower() + "_list_size() < 0) || (table." + excel_name.lower() + sheet_name.lower() + "_list_size() > (int)(m_astDesc.GetMaxSize())))\n")
	desc_file.write("\t{\n")
	...
	desc_file.write("\t}\n")
	desc_file.write("\n")
	desc_file.write("\tm_astDesc.SetSize(table." + excel_name.lower() + sheet_name.lower() + "_list_size());\n")
	desc_file.write("\tm_astDescIndex.SetSize(m_astDescIndex.GetMaxSize());\n")
	desc_file.write("\tfor(int i = 0; i < (int)m_astDescIndex.GetSize(); i++)\n")
	desc_file.write("\t{\n")
	...
	desc_file.write("\t\t\telse\n")
	desc_file.write("\t\t\t{\n")
	desc_file.write("\t\t\t\tm_astDescIndex[hashKey] = i;\n")
	desc_file.write("\t\t\t}\n")
	desc_file.write("\t\t}\n")
	desc_file.write("\t\telse\n")
	desc_file.write("\t\t{\n")
...
#////////////////////////////////////////////////////////////////
	...
	desc_file.write("\t\t{\n")
	desc_file.write("\t\t\tCHECK_EXPR_ASSERT(index < m_astDesc.GetSize(), NULL, \"the index:{} of the id:{} exist error, than the m_astDesc max index:{}\", index, id, m_astDesc.GetSize());\n")
	desc_file.write("\t\t\treturn &m_astDesc[index];\n")
	desc_file.write("\t\t}\n")
	desc_file.write("\t}\n")
	desc_file.write("\n")
	desc_file.write("\tauto pIndex = m_astDescMap.Find(id);\n")
	desc_file.write("\tif (pIndex)\n")
	desc_file.write("\t{\n")
	desc_file.write("\t\tint index = *pIndex;\n")
	desc_file.write("\t\tCHECK_EXPR_ASSERT(index >= 0 && index < m_astDesc.GetSize(), NULL, \"the index:{} of the id:{} exist error, than the m_astDesc max index:{}\", index, id, m_astDesc.GetSize());\n")
	desc_file.write("\t\treturn &m_astDesc[index];\n")
	desc_file.write("\t}\n")
	desc_file.write("\n")
